...
#define NS_DECL_NON_VIRTUAL_NSIASYNCINPUTSTREAM \
  NS_METHOD CloseWithStatus(nsresult aStatus); \
  NS_METHOD AsyncWait(nsIInputStreamCallback *aCallback, uint32_t aFlags, uint32_t aRequestedCount, nsIEventTarget *aEventTarget); \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsAsyncInputStream, nsIAsyncInputStream)
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsInputStreamCallback, nsIInputStreamCallback)
