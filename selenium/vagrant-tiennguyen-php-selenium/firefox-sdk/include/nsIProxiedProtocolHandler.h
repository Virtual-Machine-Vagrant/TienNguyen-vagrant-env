...
#define NS_DECL_NON_VIRTUAL_NSIPROXIEDPROTOCOLHANDLER \
  NS_METHOD NewProxiedChannel2(nsIURI *uri, nsIProxyInfo *proxyInfo, uint32_t proxyResolveFlags, nsIURI *proxyURI, nsILoadInfo *aLoadInfo, nsIChannel * *_retval); \
  NS_METHOD NewProxiedChannel(nsIURI *uri, nsIProxyInfo *proxyInfo, uint32_t proxyResolveFlags, nsIURI *proxyURI, nsIChannel * *_retval); 
