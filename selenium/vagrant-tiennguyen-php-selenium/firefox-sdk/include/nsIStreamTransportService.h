...
#define NS_DECL_NON_VIRTUAL_NSISTREAMTRANSPORTSERVICE \
  NS_METHOD CreateInputTransport(nsIInputStream *aStream, int64_t aStartOffset, int64_t aReadLimit, bool aCloseWhenDone, nsITransport * *_retval); \
  NS_METHOD CreateOutputTransport(nsIOutputStream *aStream, int64_t aStartOffset, int64_t aWriteLimit, bool aCloseWhenDone, nsITransport * *_retval); 
