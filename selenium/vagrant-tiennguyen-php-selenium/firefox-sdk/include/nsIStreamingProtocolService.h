...
#define NS_DECL_NSISTREAMINGPROTOCOLCONTROLLERSERVICE \
  NS_IMETHOD Create(nsIChannel *channel, nsIStreamingProtocolController * *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSISTREAMINGPROTOCOLCONTROLLERSERVICE \
  NS_METHOD Create(nsIChannel *channel, nsIStreamingProtocolController * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISTREAMINGPROTOCOLCONTROLLERSERVICE(_to) \
  NS_IMETHOD Create(nsIChannel *channel, nsIStreamingProtocolController * *_retval) override { return _to Create(channel, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISTREAMINGPROTOCOLCONTROLLERSERVICE(_to) \
  NS_IMETHOD Create(nsIChannel *channel, nsIStreamingProtocolController * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Create(channel, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsStreamingProtocolControllerService, nsIStreamingProtocolControllerService)
