...
#define NS_DECL_NON_VIRTUAL_NSIX509CERTLIST \
  NS_METHOD AddCert(nsIX509Cert *cert); \
  NS_METHOD DeleteCert(nsIX509Cert *cert); \
  NS_METHOD GetEnumerator(nsISimpleEnumerator * *_retval); \
  NS_METHOD_(void *) GetRawCertList(void); \
  NS_METHOD Equals(nsIX509CertList *other, bool *_retval); 
