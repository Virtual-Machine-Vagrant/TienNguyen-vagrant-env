...
#define NS_DECL_NON_VIRTUAL_NSIWINDOWMEDIATORLISTENER \
  NS_METHOD OnWindowTitleChange(nsIXULWindow *window, const char16_t * newTitle); \
  NS_METHOD OnOpenWindow(nsIXULWindow *window); \
  NS_METHOD OnCloseWindow(nsIXULWindow *window); 
