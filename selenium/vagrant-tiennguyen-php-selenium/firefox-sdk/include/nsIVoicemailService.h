...
#define NS_DECL_NON_VIRTUAL_NSIVOICEMAILLISTENER \
  NS_METHOD NotifyStatusChanged(nsIVoicemailProvider *provider); \
  NS_METHOD NotifyInfoChanged(nsIVoicemailProvider *provider); 
...
/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIVOICEMAILSERVICE \
  NS_METHOD GetNumItems(uint32_t *aNumItems); \
  NS_METHOD GetItemByServiceId(uint32_t serviceId, nsIVoicemailProvider * *_retval); \
  NS_METHOD GetDefaultItem(nsIVoicemailProvider * *_retval); \
  NS_METHOD RegisterListener(nsIVoicemailListener *listener); \
  NS_METHOD UnregisterListener(nsIVoicemailListener *listener); 
...
/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIVOICEMAILPROVIDER \
  ...
  NS_METHOD GetHasMessages(bool *aHasMessages); \
  NS_METHOD GetMessageCount(int32_t *aMessageCount); \
  NS_METHOD GetReturnNumber(nsAString & aReturnNumber); \
  NS_METHOD GetReturnMessage(nsAString & aReturnMessage); 
