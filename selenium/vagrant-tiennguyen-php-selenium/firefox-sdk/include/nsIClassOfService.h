...
#define NS_DECL_NON_VIRTUAL_NSICLASSOFSERVICE \
  NS_METHOD GetClassFlags(uint32_t *aClassFlags); \
  NS_METHOD SetClassFlags(uint32_t aClassFlags); \
  NS_METHOD ClearClassFlags(uint32_t flags); \
  NS_METHOD AddClassFlags(uint32_t flags); \
