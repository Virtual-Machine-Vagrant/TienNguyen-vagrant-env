...
#define NS_DECL_NSIDOWNLOADHISTORY \
  NS_IMETHOD AddDownload(nsIURI *aSource, nsIURI *aReferrer, PRTime aStartTime, nsIURI *aDestination) override; \
  NS_IMETHOD RemoveAllDownloads(void) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOWNLOADHISTORY \
  NS_METHOD AddDownload(nsIURI *aSource, nsIURI *aReferrer, PRTime aStartTime, nsIURI *aDestination); \
  NS_METHOD RemoveAllDownloads(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOWNLOADHISTORY(_to) \
  NS_IMETHOD AddDownload(nsIURI *aSource, nsIURI *aReferrer, PRTime aStartTime, nsIURI *aDestination) override { return _to AddDownload(aSource, aReferrer, aStartTime, aDestination); } \
  NS_IMETHOD RemoveAllDownloads(void) override { return _to RemoveAllDownloads(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOWNLOADHISTORY(_to) \
  NS_IMETHOD AddDownload(nsIURI *aSource, nsIURI *aReferrer, PRTime aStartTime, nsIURI *aDestination) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AddDownload(aSource, aReferrer, aStartTime, aDestination); } \
  NS_IMETHOD RemoveAllDownloads(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveAllDownloads(); } 
