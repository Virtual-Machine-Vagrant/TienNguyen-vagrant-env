/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM ../../../dist/idl/nsIDOMDesktopNotification.idl
 */
...
#define NS_DECL_NSIAPPNOTIFICATIONSERVICE \
  NS_IMETHOD ShowAppNotification(const nsAString & imageUrl, const nsAString & title, const nsAString & text, nsIObserver *alertListener, JS::HandleValue details) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIAPPNOTIFICATIONSERVICE \
  NS_METHOD ShowAppNotification(const nsAString & imageUrl, const nsAString & title, const nsAString & text, nsIObserver *alertListener, JS::HandleValue details); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIAPPNOTIFICATIONSERVICE(_to) \
  NS_IMETHOD ShowAppNotification(const nsAString & imageUrl, const nsAString & title, const nsAString & text, nsIObserver *alertListener, JS::HandleValue details) override { return _to ShowAppNotification(imageUrl, title, text, alertListener, details); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIAPPNOTIFICATIONSERVICE(_to) \
  NS_IMETHOD ShowAppNotification(const nsAString & imageUrl, const nsAString & title, const nsAString & text, nsIObserver *alertListener, JS::HandleValue details) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ShowAppNotification(imageUrl, title, text, alertListener, details); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsAppNotificationService, nsIAppNotificationService)
