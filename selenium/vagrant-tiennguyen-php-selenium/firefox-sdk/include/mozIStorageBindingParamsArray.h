...
#define NS_DECL_NON_VIRTUAL_MOZISTORAGEBINDINGPARAMSARRAY \
  NS_METHOD NewBindingParams(mozIStorageBindingParams * *_retval); \
  NS_METHOD AddParams(mozIStorageBindingParams *aParameters); \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(_MYCLASS_, mozIStorageBindingParamsArray)
