...
class NS_NO_VTABLE nsITreeView : public nsISupports {
 public:
  ...
  NS_IMETHOD PerformAction(const char16_t * action) = 0;

  /* void performActionOnRow (in wstring action, in long row); */
  NS_IMETHOD PerformActionOnRow(const char16_t * action, int32_t row) = 0;

  /* void performActionOnCell (in wstring action, in long row, in nsITreeColumn col); */
  NS_IMETHOD PerformActionOnCell(const char16_t * action, int32_t row, nsITreeColumn *col) = 0;
...
#define NS_DECL_NSITREEVIEW \
  ...
  NS_IMETHOD GetCellProperties(int32_t row, nsITreeColumn *col, nsAString & _retval) override; \
  NS_IMETHOD GetColumnProperties(nsITreeColumn *col, nsAString & _retval) override; \
  ...
  NS_IMETHOD Drop(int32_t row, int32_t orientation, nsIDOMDataTransfer *dataTransfer) override; \
  ...
  NS_IMETHOD GetImageSrc(int32_t row, nsITreeColumn *col, nsAString & _retval) override; \
  NS_IMETHOD GetProgressMode(int32_t row, nsITreeColumn *col, int32_t *_retval) override; \
  NS_IMETHOD GetCellValue(int32_t row, nsITreeColumn *col, nsAString & _retval) override; \
  NS_IMETHOD GetCellText(int32_t row, nsITreeColumn *col, nsAString & _retval) override; \
  NS_IMETHOD SetTree(nsITreeBoxObject *tree) override; \
  NS_IMETHOD ToggleOpenState(int32_t index) override; \
  NS_IMETHOD CycleHeader(nsITreeColumn *col) override; \
  NS_IMETHOD SelectionChanged(void) override; \
  NS_IMETHOD CycleCell(int32_t row, nsITreeColumn *col) override; \
  NS_IMETHOD IsEditable(int32_t row, nsITreeColumn *col, bool *_retval) override; \
  NS_IMETHOD IsSelectable(int32_t row, nsITreeColumn *col, bool *_retval) override; \
  NS_IMETHOD SetCellValue(int32_t row, nsITreeColumn *col, const nsAString & value) override; \
  NS_IMETHOD SetCellText(int32_t row, nsITreeColumn *col, const nsAString & value) override; \
  NS_IMETHOD PerformAction(const char16_t * action) override; \
  NS_IMETHOD PerformActionOnRow(const char16_t * action, int32_t row) override; \
  NS_IMETHOD PerformActionOnCell(const char16_t * action, int32_t row, nsITreeColumn *col) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSITREEVIEW \
  NS_METHOD GetRowCount(int32_t *aRowCount); \
  NS_METHOD GetSelection(nsITreeSelection * *aSelection); \
  NS_METHOD SetSelection(nsITreeSelection *aSelection); \
  NS_METHOD GetRowProperties(int32_t index, nsAString & _retval); \
  NS_METHOD GetCellProperties(int32_t row, nsITreeColumn *col, nsAString & _retval); \
  NS_METHOD GetColumnProperties(nsITreeColumn *col, nsAString & _retval); \
  NS_METHOD IsContainer(int32_t index, bool *_retval); \
  NS_METHOD IsContainerOpen(int32_t index, bool *_retval); \
  NS_METHOD IsContainerEmpty(int32_t index, bool *_retval); \
  NS_METHOD IsSeparator(int32_t index, bool *_retval); \
  NS_METHOD IsSorted(bool *_retval); \
  NS_METHOD CanDrop(int32_t index, int32_t orientation, nsIDOMDataTransfer *dataTransfer, bool *_retval); \
  NS_METHOD Drop(int32_t row, int32_t orientation, nsIDOMDataTransfer *dataTransfer); \
  NS_METHOD GetParentIndex(int32_t rowIndex, int32_t *_retval); \
  NS_METHOD HasNextSibling(int32_t rowIndex, int32_t afterIndex, bool *_retval); \
  NS_METHOD GetLevel(int32_t index, int32_t *_retval); \
  NS_METHOD GetImageSrc(int32_t row, nsITreeColumn *col, nsAString & _retval); \
  NS_METHOD GetProgressMode(int32_t row, nsITreeColumn *col, int32_t *_retval); \
  NS_METHOD GetCellValue(int32_t row, nsITreeColumn *col, nsAString & _retval); \
  NS_METHOD GetCellText(int32_t row, nsITreeColumn *col, nsAString & _retval); \
  NS_METHOD SetTree(nsITreeBoxObject *tree); \
  NS_METHOD ToggleOpenState(int32_t index); \
  NS_METHOD CycleHeader(nsITreeColumn *col); \
  NS_METHOD SelectionChanged(void); \
  NS_METHOD CycleCell(int32_t row, nsITreeColumn *col); \
  NS_METHOD IsEditable(int32_t row, nsITreeColumn *col, bool *_retval); \
  NS_METHOD IsSelectable(int32_t row, nsITreeColumn *col, bool *_retval); \
  NS_METHOD SetCellValue(int32_t row, nsITreeColumn *col, const nsAString & value); \
  NS_METHOD SetCellText(int32_t row, nsITreeColumn *col, const nsAString & value); \
  NS_METHOD PerformAction(const char16_t * action); \
  NS_METHOD PerformActionOnRow(const char16_t * action, int32_t row); \
  NS_METHOD PerformActionOnCell(const char16_t * action, int32_t row, nsITreeColumn *col); 
...
#define NS_FORWARD_NSITREEVIEW(_to) \
  ...
  NS_IMETHOD GetCellProperties(int32_t row, nsITreeColumn *col, nsAString & _retval) override { return _to GetCellProperties(row, col, _retval); } \
  NS_IMETHOD GetColumnProperties(nsITreeColumn *col, nsAString & _retval) override { return _to GetColumnProperties(col, _retval); } \
  ...
  NS_IMETHOD Drop(int32_t row, int32_t orientation, nsIDOMDataTransfer *dataTransfer) override { return _to Drop(row, orientation, dataTransfer); } \
  ...
  NS_IMETHOD GetImageSrc(int32_t row, nsITreeColumn *col, nsAString & _retval) override { return _to GetImageSrc(row, col, _retval); } \
  NS_IMETHOD GetProgressMode(int32_t row, nsITreeColumn *col, int32_t *_retval) override { return _to GetProgressMode(row, col, _retval); } \
  NS_IMETHOD GetCellValue(int32_t row, nsITreeColumn *col, nsAString & _retval) override { return _to GetCellValue(row, col, _retval); } \
  NS_IMETHOD GetCellText(int32_t row, nsITreeColumn *col, nsAString & _retval) override { return _to GetCellText(row, col, _retval); } \
  NS_IMETHOD SetTree(nsITreeBoxObject *tree) override { return _to SetTree(tree); } \
  NS_IMETHOD ToggleOpenState(int32_t index) override { return _to ToggleOpenState(index); } \
  NS_IMETHOD CycleHeader(nsITreeColumn *col) override { return _to CycleHeader(col); } \
  NS_IMETHOD SelectionChanged(void) override { return _to SelectionChanged(); } \
  NS_IMETHOD CycleCell(int32_t row, nsITreeColumn *col) override { return _to CycleCell(row, col); } \
  NS_IMETHOD IsEditable(int32_t row, nsITreeColumn *col, bool *_retval) override { return _to IsEditable(row, col, _retval); } \
  NS_IMETHOD IsSelectable(int32_t row, nsITreeColumn *col, bool *_retval) override { return _to IsSelectable(row, col, _retval); } \
  NS_IMETHOD SetCellValue(int32_t row, nsITreeColumn *col, const nsAString & value) override { return _to SetCellValue(row, col, value); } \
  NS_IMETHOD SetCellText(int32_t row, nsITreeColumn *col, const nsAString & value) override { return _to SetCellText(row, col, value); } \
  NS_IMETHOD PerformAction(const char16_t * action) override { return _to PerformAction(action); } \
  NS_IMETHOD PerformActionOnRow(const char16_t * action, int32_t row) override { return _to PerformActionOnRow(action, row); } \
  NS_IMETHOD PerformActionOnCell(const char16_t * action, int32_t row, nsITreeColumn *col) override { return _to PerformActionOnCell(action, row, col); } 
...
#define NS_FORWARD_SAFE_NSITREEVIEW(_to) \
  ...
  NS_IMETHOD GetCellProperties(int32_t row, nsITreeColumn *col, nsAString & _retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCellProperties(row, col, _retval); } \
  NS_IMETHOD GetColumnProperties(nsITreeColumn *col, nsAString & _retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetColumnProperties(col, _retval); } \
  ...
  NS_IMETHOD Drop(int32_t row, int32_t orientation, nsIDOMDataTransfer *dataTransfer) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Drop(row, orientation, dataTransfer); } \
  ...
  NS_IMETHOD GetImageSrc(int32_t row, nsITreeColumn *col, nsAString & _retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetImageSrc(row, col, _retval); } \
  NS_IMETHOD GetProgressMode(int32_t row, nsITreeColumn *col, int32_t *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetProgressMode(row, col, _retval); } \
  NS_IMETHOD GetCellValue(int32_t row, nsITreeColumn *col, nsAString & _retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCellValue(row, col, _retval); } \
  NS_IMETHOD GetCellText(int32_t row, nsITreeColumn *col, nsAString & _retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCellText(row, col, _retval); } \
  NS_IMETHOD SetTree(nsITreeBoxObject *tree) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTree(tree); } \
  NS_IMETHOD ToggleOpenState(int32_t index) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ToggleOpenState(index); } \
  NS_IMETHOD CycleHeader(nsITreeColumn *col) override { return !_to ? NS_ERROR_NULL_POINTER : _to->CycleHeader(col); } \
  NS_IMETHOD SelectionChanged(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SelectionChanged(); } \
  NS_IMETHOD CycleCell(int32_t row, nsITreeColumn *col) override { return !_to ? NS_ERROR_NULL_POINTER : _to->CycleCell(row, col); } \
  NS_IMETHOD IsEditable(int32_t row, nsITreeColumn *col, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->IsEditable(row, col, _retval); } \
  NS_IMETHOD IsSelectable(int32_t row, nsITreeColumn *col, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->IsSelectable(row, col, _retval); } \
  NS_IMETHOD SetCellValue(int32_t row, nsITreeColumn *col, const nsAString & value) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCellValue(row, col, value); } \
  NS_IMETHOD SetCellText(int32_t row, nsITreeColumn *col, const nsAString & value) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCellText(row, col, value); } \
  NS_IMETHOD PerformAction(const char16_t * action) override { return !_to ? NS_ERROR_NULL_POINTER : _to->PerformAction(action); } \
  NS_IMETHOD PerformActionOnRow(const char16_t * action, int32_t row) override { return !_to ? NS_ERROR_NULL_POINTER : _to->PerformActionOnRow(action, row); } \
  NS_IMETHOD PerformActionOnCell(const char16_t * action, int32_t row, nsITreeColumn *col) override { return !_to ? NS_ERROR_NULL_POINTER : _to->PerformActionOnCell(action, row, col); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsTreeView, nsITreeView)
...
/* void performAction (in wstring action); */
NS_IMETHODIMP nsTreeView::PerformAction(const char16_t * action)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void performActionOnRow (in wstring action, in long row); */
NS_IMETHODIMP nsTreeView::PerformActionOnRow(const char16_t * action, int32_t row)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void performActionOnCell (in wstring action, in long row, in nsITreeColumn col); */
NS_IMETHODIMP nsTreeView::PerformActionOnCell(const char16_t * action, int32_t row, nsITreeColumn *col)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSINATIVETREEVIEW \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsNativeTreeView, nsINativeTreeView)
