...
#define NS_DECL_NON_VIRTUAL_NSIDOMCSSCONDITIONRULE \
  NS_METHOD GetConditionText(nsAString & aConditionText); \
  NS_METHOD SetConditionText(const nsAString & aConditionText); 
