...
#define NS_DECL_NON_VIRTUAL_NSIAPPLICATIONCACHECHANNEL \
  NS_METHOD GetLoadedFromApplicationCache(bool *aLoadedFromApplicationCache); \
  NS_METHOD GetInheritApplicationCache(bool *aInheritApplicationCache); \
  NS_METHOD SetInheritApplicationCache(bool aInheritApplicationCache); \
  NS_METHOD GetChooseApplicationCache(bool *aChooseApplicationCache); \
  NS_METHOD SetChooseApplicationCache(bool aChooseApplicationCache); \
  NS_METHOD MarkOfflineCacheEntryAsForeign(void); \
  NS_METHOD GetApplicationCacheForWrite(nsIApplicationCache * *aApplicationCacheForWrite); \
  NS_METHOD SetApplicationCacheForWrite(nsIApplicationCache *aApplicationCacheForWrite); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsApplicationCacheChannel, nsIApplicationCacheChannel)
