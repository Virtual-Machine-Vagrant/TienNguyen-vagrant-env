...
#define NS_DECL_NON_VIRTUAL_NSICACHEENTRYOPENCALLBACK \
  NS_METHOD OnCacheEntryCheck(nsICacheEntry *aEntry, nsIApplicationCache *aApplicationCache, uint32_t *_retval); \
  NS_METHOD OnCacheEntryAvailable(nsICacheEntry *aEntry, bool aNew, nsIApplicationCache *aApplicationCache, nsresult aResult); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsCacheEntryOpenCallback, nsICacheEntryOpenCallback)
