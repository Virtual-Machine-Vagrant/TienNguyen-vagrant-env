...
#define NS_DECL_NSIREFRESHURI \
  NS_IMETHOD RefreshURI(nsIURI *aURI, int32_t aMillis, bool aRepeat, bool aMetaRefresh) override; \
  NS_IMETHOD ForceRefreshURI(nsIURI *aURI, int32_t aMillis, bool aMetaRefresh) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIREFRESHURI \
  NS_METHOD RefreshURI(nsIURI *aURI, int32_t aMillis, bool aRepeat, bool aMetaRefresh); \
  NS_METHOD ForceRefreshURI(nsIURI *aURI, int32_t aMillis, bool aMetaRefresh); \
...
#define NS_FORWARD_NSIREFRESHURI(_to) \
  NS_IMETHOD RefreshURI(nsIURI *aURI, int32_t aMillis, bool aRepeat, bool aMetaRefresh) override { return _to RefreshURI(aURI, aMillis, aRepeat, aMetaRefresh); } \
  NS_IMETHOD ForceRefreshURI(nsIURI *aURI, int32_t aMillis, bool aMetaRefresh) override { return _to ForceRefreshURI(aURI, aMillis, aMetaRefresh); } \
...
#define NS_FORWARD_SAFE_NSIREFRESHURI(_to) \
  NS_IMETHOD RefreshURI(nsIURI *aURI, int32_t aMillis, bool aRepeat, bool aMetaRefresh) override { return !_to ? NS_ERROR_NULL_POINTER : _to->RefreshURI(aURI, aMillis, aRepeat, aMetaRefresh); } \
  NS_IMETHOD ForceRefreshURI(nsIURI *aURI, int32_t aMillis, bool aMetaRefresh) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ForceRefreshURI(aURI, aMillis, aMetaRefresh); } \
