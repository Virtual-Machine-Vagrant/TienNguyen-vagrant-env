...
#define NS_DECL_NSPIPROMPTSERVICE \
  NS_IMETHOD DoDialog(nsIDOMWindow *aParent, nsIDialogParamBlock *aParamBlock, const char * aChromeURL) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSPIPROMPTSERVICE \
  NS_METHOD DoDialog(nsIDOMWindow *aParent, nsIDialogParamBlock *aParamBlock, const char * aChromeURL); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSPIPROMPTSERVICE(_to) \
  NS_IMETHOD DoDialog(nsIDOMWindow *aParent, nsIDialogParamBlock *aParamBlock, const char * aChromeURL) override { return _to DoDialog(aParent, aParamBlock, aChromeURL); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSPIPROMPTSERVICE(_to) \
  NS_IMETHOD DoDialog(nsIDOMWindow *aParent, nsIDialogParamBlock *aParamBlock, const char * aChromeURL) override { return !_to ? NS_ERROR_NULL_POINTER : _to->DoDialog(aParent, aParamBlock, aChromeURL); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(_MYCLASS_, nsPIPromptService)
