...
#define NS_DECL_NON_VIRTUAL_NSIOUTPUTITERATOR \
  NS_METHOD PutElement(nsISupports *anElementToPut); \
  NS_METHOD StepForward(void); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsOutputIterator, nsIOutputIterator)
...
#define NS_DECL_NON_VIRTUAL_NSIINPUTITERATOR \
  NS_METHOD GetElement(nsISupports * *_retval); \
  NS_METHOD StepForward(void); \
  NS_METHOD IsEqualTo(nsISupports *anotherIterator, bool *_retval); \
  NS_METHOD Clone(nsISupports * *_retval); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsInputIterator, nsIInputIterator)
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsForwardIterator, nsIForwardIterator)
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsBidirectionalIterator, nsIBidirectionalIterator)
...
#define NS_DECL_NON_VIRTUAL_NSIRANDOMACCESSITERATOR \
  NS_METHOD GetElement(nsISupports * *_retval); \
  NS_METHOD GetElementAt(int32_t anOffset, nsISupports * *_retval); \
  NS_METHOD PutElement(nsISupports *anElementToPut); \
  NS_METHOD PutElementAt(int32_t anOffset, nsISupports *anElementToPut); \
  NS_METHOD StepForward(void); \
  NS_METHOD StepForwardBy(int32_t anOffset); \
  NS_METHOD StepBackward(void); \
  NS_METHOD StepBackwardBy(int32_t anOffset); \
  NS_METHOD IsEqualTo(nsISupports *anotherIterator, bool *_retval); \
  NS_METHOD Clone(nsISupports * *_retval); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsRandomAccessIterator, nsIRandomAccessIterator)
