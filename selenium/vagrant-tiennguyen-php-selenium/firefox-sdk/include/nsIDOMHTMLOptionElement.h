...
#define NS_DECL_NSIDOMHTMLOPTIONELEMENT \
  ...
  NS_IMETHOD GetDefaultSelected(bool *aDefaultSelected) override; \
  NS_IMETHOD SetDefaultSelected(bool aDefaultSelected) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIDOMHTMLOPTIONELEMENT \
  NS_METHOD GetDisabled(bool *aDisabled); \
  NS_METHOD SetDisabled(bool aDisabled); \
  NS_METHOD GetForm(nsIDOMHTMLFormElement * *aForm); \
  NS_METHOD GetLabel(nsAString & aLabel); \
  NS_METHOD SetLabel(const nsAString & aLabel); \
  NS_METHOD GetDefaultSelected(bool *aDefaultSelected); \
  NS_METHOD SetDefaultSelected(bool aDefaultSelected); \
...
#define NS_FORWARD_NSIDOMHTMLOPTIONELEMENT(_to) \
  ...
  NS_IMETHOD GetDefaultSelected(bool *aDefaultSelected) override { return _to GetDefaultSelected(aDefaultSelected); } \
  NS_IMETHOD SetDefaultSelected(bool aDefaultSelected) override { return _to SetDefaultSelected(aDefaultSelected); } \
...
#define NS_FORWARD_SAFE_NSIDOMHTMLOPTIONELEMENT(_to) \
  ...
  NS_IMETHOD GetDefaultSelected(bool *aDefaultSelected) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDefaultSelected(aDefaultSelected); } \
  NS_IMETHOD SetDefaultSelected(bool aDefaultSelected) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetDefaultSelected(aDefaultSelected); } \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMHTMLOptionElement, nsIDOMHTMLOptionElement)
