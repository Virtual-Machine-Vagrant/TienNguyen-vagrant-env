...
#define NS_DECL_NON_VIRTUAL_NSICLIPBOARDCOMMANDS \
  NS_METHOD CanCutSelection(bool *_retval); \
  NS_METHOD CanCopySelection(bool *_retval); \
  NS_METHOD CanCopyLinkLocation(bool *_retval); \
  NS_METHOD CanCopyImageLocation(bool *_retval); \
  NS_METHOD CanCopyImageContents(bool *_retval); \
  NS_METHOD CanPaste(bool *_retval); \
  NS_METHOD CutSelection(void); \
  NS_METHOD CopySelection(void); \
  NS_METHOD CopyLinkLocation(void); \
  NS_METHOD CopyImageLocation(void); \
  NS_METHOD CopyImageContents(void); \
  NS_METHOD Paste(void); \
  NS_METHOD SelectAll(void); \
  NS_METHOD SelectNone(void); 
