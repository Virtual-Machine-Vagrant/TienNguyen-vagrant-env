...
#define NS_DECL_NSIWEBBROWSERCHROME2 \
  NS_IMETHOD SetStatusWithContext(uint32_t statusType, const nsAString & statusText, nsISupports *statusContext) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIWEBBROWSERCHROME2 \
  NS_METHOD SetStatusWithContext(uint32_t statusType, const nsAString & statusText, nsISupports *statusContext); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWEBBROWSERCHROME2(_to) \
  NS_IMETHOD SetStatusWithContext(uint32_t statusType, const nsAString & statusText, nsISupports *statusContext) override { return _to SetStatusWithContext(statusType, statusText, statusContext); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWEBBROWSERCHROME2(_to) \
  NS_IMETHOD SetStatusWithContext(uint32_t statusType, const nsAString & statusText, nsISupports *statusContext) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetStatusWithContext(statusType, statusText, statusContext); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsWebBrowserChrome2, nsIWebBrowserChrome2)
