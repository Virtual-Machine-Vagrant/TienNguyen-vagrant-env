/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM ../../../dist/idl/nsIPermissionPromptService.idl
 */
...
#define NS_DECL_NSIPERMISSIONPROMPTSERVICE \
  NS_IMETHOD GetPermission(nsIContentPermissionRequest *aRequest) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIPERMISSIONPROMPTSERVICE \
  NS_METHOD GetPermission(nsIContentPermissionRequest *aRequest); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPERMISSIONPROMPTSERVICE(_to) \
  NS_IMETHOD GetPermission(nsIContentPermissionRequest *aRequest) override { return _to GetPermission(aRequest); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPERMISSIONPROMPTSERVICE(_to) \
  NS_IMETHOD GetPermission(nsIContentPermissionRequest *aRequest) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPermission(aRequest); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsPermissionPromptService, nsIPermissionPromptService)
