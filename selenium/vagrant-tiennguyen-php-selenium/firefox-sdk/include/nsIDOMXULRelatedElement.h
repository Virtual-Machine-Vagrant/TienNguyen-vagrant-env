...
#define NS_DECL_NSIDOMXULRELATEDELEMENT \
  NS_IMETHOD GetRelatedElement(nsIDOMNode *aElement, nsIDOMNode * *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMXULRELATEDELEMENT \
  NS_METHOD GetRelatedElement(nsIDOMNode *aElement, nsIDOMNode * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMXULRELATEDELEMENT(_to) \
  NS_IMETHOD GetRelatedElement(nsIDOMNode *aElement, nsIDOMNode * *_retval) override { return _to GetRelatedElement(aElement, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMXULRELATEDELEMENT(_to) \
  NS_IMETHOD GetRelatedElement(nsIDOMNode *aElement, nsIDOMNode * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRelatedElement(aElement, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMXULRelatedElement, nsIDOMXULRelatedElement)
