...
#define NS_DECL_NON_VIRTUAL_NSIDOMHTMLSELECTELEMENT \
  ...
  NS_METHOD GetOptions(nsIDOMHTMLOptionsCollection * *aOptions); \
  ...
  NS_METHOD Add(nsIDOMHTMLElement *element, nsIVariant *before); \
  NS_METHOD Remove(int32_t index); \
  NS_METHOD GetSelectedOptions(nsIDOMHTMLCollection * *aSelectedOptions); \
