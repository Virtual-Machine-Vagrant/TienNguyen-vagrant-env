...
class NS_NO_VTABLE nsIAppShellService : public nsISupports {
 public:
  ...
  NS_IMETHOD CreateWindowlessBrowser(bool aIsChrome, nsIWindowlessBrowser * *_retval) = 0;
  ...
  NS_IMETHOD GetHiddenDOMWindow(mozIDOMWindowProxy * *aHiddenDOMWindow) = 0;
  ...
  NS_IMETHOD GetHiddenPrivateDOMWindow(mozIDOMWindowProxy * *aHiddenPrivateDOMWindow) = 0;

  /* [noscript] void getHiddenWindowAndJSContext (out mozIDOMWindowProxy aHiddenDOMWindow, out JSContext aJSContext); */
  NS_IMETHOD GetHiddenWindowAndJSContext(mozIDOMWindowProxy * *aHiddenDOMWindow, JSContext **aJSContext) = 0;
...
#define NS_DECL_NSIAPPSHELLSERVICE \
  ...
  NS_IMETHOD CreateWindowlessBrowser(bool aIsChrome, nsIWindowlessBrowser * *_retval) override; \
  ...
  NS_IMETHOD GetHiddenPrivateDOMWindow(mozIDOMWindowProxy * *aHiddenPrivateDOMWindow) override; \
  NS_IMETHOD GetHiddenWindowAndJSContext(mozIDOMWindowProxy * *aHiddenDOMWindow, JSContext **aJSContext) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIAPPSHELLSERVICE \
  NS_METHOD CreateTopLevelWindow(nsIXULWindow *aParent, nsIURI *aUrl, uint32_t aChromeMask, int32_t aInitialWidth, int32_t aInitialHeight, nsITabParent *aOpeningTab, nsIXULWindow * *_retval); \
  NS_METHOD CreateWindowlessBrowser(bool aIsChrome, nsIWindowlessBrowser * *_retval); \
  NS_METHOD CreateHiddenWindow(void); \
  NS_METHOD DestroyHiddenWindow(void); \
  NS_METHOD SetScreenId(uint32_t aScreenId); \
  NS_METHOD GetHiddenWindow(nsIXULWindow * *aHiddenWindow); \
  NS_METHOD GetHiddenDOMWindow(mozIDOMWindowProxy * *aHiddenDOMWindow); \
  NS_METHOD GetHiddenPrivateWindow(nsIXULWindow * *aHiddenPrivateWindow); \
  NS_METHOD GetHiddenPrivateDOMWindow(mozIDOMWindowProxy * *aHiddenPrivateDOMWindow); \
  NS_METHOD GetHiddenWindowAndJSContext(mozIDOMWindowProxy * *aHiddenDOMWindow, JSContext **aJSContext); \
  NS_METHOD GetApplicationProvidedHiddenWindow(bool *aApplicationProvidedHiddenWindow); \
  NS_METHOD RegisterTopLevelWindow(nsIXULWindow *aWindow); \
  NS_METHOD UnregisterTopLevelWindow(nsIXULWindow *aWindow); \
  NS_METHOD GetHasHiddenPrivateWindow(bool *aHasHiddenPrivateWindow); \
  NS_METHOD StartEventLoopLagTracking(bool *_retval); \
  NS_METHOD StopEventLoopLagTracking(void); 
...
#define NS_FORWARD_NSIAPPSHELLSERVICE(_to) \
  ...
  NS_IMETHOD CreateWindowlessBrowser(bool aIsChrome, nsIWindowlessBrowser * *_retval) override { return _to CreateWindowlessBrowser(aIsChrome, _retval); } \
  ...
  NS_IMETHOD GetHiddenPrivateDOMWindow(mozIDOMWindowProxy * *aHiddenPrivateDOMWindow) override { return _to GetHiddenPrivateDOMWindow(aHiddenPrivateDOMWindow); } \
  NS_IMETHOD GetHiddenWindowAndJSContext(mozIDOMWindowProxy * *aHiddenDOMWindow, JSContext **aJSContext) override { return _to GetHiddenWindowAndJSContext(aHiddenDOMWindow, aJSContext); } \
...
#define NS_FORWARD_SAFE_NSIAPPSHELLSERVICE(_to) \
  ...
  NS_IMETHOD CreateWindowlessBrowser(bool aIsChrome, nsIWindowlessBrowser * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateWindowlessBrowser(aIsChrome, _retval); } \
  ...
  NS_IMETHOD GetHiddenPrivateDOMWindow(mozIDOMWindowProxy * *aHiddenPrivateDOMWindow) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHiddenPrivateDOMWindow(aHiddenPrivateDOMWindow); } \
  NS_IMETHOD GetHiddenWindowAndJSContext(mozIDOMWindowProxy * *aHiddenDOMWindow, JSContext **aJSContext) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHiddenWindowAndJSContext(aHiddenDOMWindow, aJSContext); } \
...
/* nsIWindowlessBrowser createWindowlessBrowser ([optional] in bool aIsChrome); */
NS_IMETHODIMP nsAppShellService::CreateWindowlessBrowser(bool aIsChrome, nsIWindowlessBrowser * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* readonly attribute mozIDOMWindowProxy hiddenDOMWindow; */
NS_IMETHODIMP nsAppShellService::GetHiddenDOMWindow(mozIDOMWindowProxy * *aHiddenDOMWindow)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* readonly attribute mozIDOMWindowProxy hiddenPrivateDOMWindow; */
NS_IMETHODIMP nsAppShellService::GetHiddenPrivateDOMWindow(mozIDOMWindowProxy * *aHiddenPrivateDOMWindow)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [noscript] void getHiddenWindowAndJSContext (out mozIDOMWindowProxy aHiddenDOMWindow, out JSContext aJSContext); */
NS_IMETHODIMP nsAppShellService::GetHiddenWindowAndJSContext(mozIDOMWindowProxy * *aHiddenDOMWindow, JSContext **aJSContext)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
