...
#define NS_DECL_NON_VIRTUAL_NSINATIVEFILEWATCHERERRORCALLBACK \
  NS_METHOD Complete(nsresult xpcomError, int32_t osError); 
...
#define NS_DECL_NON_VIRTUAL_NSINATIVEFILEWATCHERCALLBACK \
  NS_METHOD Changed(const nsAString & resourcePath, int32_t flags); 
...
#define NS_DECL_NON_VIRTUAL_NSINATIVEFILEWATCHERSUCCESSCALLBACK \
  NS_METHOD Complete(const nsAString & resourcePath); 
...
#define NS_DECL_NON_VIRTUAL_NSINATIVEFILEWATCHERSERVICE \
  NS_METHOD AddPath(const nsAString & pathToWatch, nsINativeFileWatcherCallback *onChange, nsINativeFileWatcherErrorCallback *onError, nsINativeFileWatcherSuccessCallback *onSuccess); \
  NS_METHOD RemovePath(const nsAString & pathToUnwatch, nsINativeFileWatcherCallback *onChange, nsINativeFileWatcherErrorCallback *onError, nsINativeFileWatcherSuccessCallback *onSuccess); 
