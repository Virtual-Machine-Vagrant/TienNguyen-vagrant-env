...
#define NS_DECL_NON_VIRTUAL_NSIDOMSVGELEMENT \
  NS_METHOD GetOwnerSVGElement(nsIDOMSVGElement * *aOwnerSVGElement); \
  NS_METHOD GetViewportElement(nsIDOMSVGElement * *aViewportElement); \
  NS_METHOD GetSVGClassName(nsISupports * *aClassName); \
