...
#define NS_DECL_NON_VIRTUAL_NSIIDLESERVICEINTERNAL \
  NS_METHOD ResetIdleTimeOut(uint32_t idleDeltaInMS); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsIdleServiceInternal, nsIIdleServiceInternal)
