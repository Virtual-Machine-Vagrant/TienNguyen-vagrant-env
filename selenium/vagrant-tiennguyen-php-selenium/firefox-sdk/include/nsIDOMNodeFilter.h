...
#define NS_DECL_NSIDOMNODEFILTER \
  NS_IMETHOD AcceptNode(nsIDOMNode *n, int16_t *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMNODEFILTER \
  NS_METHOD AcceptNode(nsIDOMNode *n, int16_t *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMNODEFILTER(_to) \
  NS_IMETHOD AcceptNode(nsIDOMNode *n, int16_t *_retval) override { return _to AcceptNode(n, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMNODEFILTER(_to) \
  NS_IMETHOD AcceptNode(nsIDOMNode *n, int16_t *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AcceptNode(n, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMNodeFilter, nsIDOMNodeFilter)
