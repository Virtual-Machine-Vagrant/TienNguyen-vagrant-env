...
#define NS_DECL_NSIDOMFONTFACELIST \
  NS_IMETHOD Item(uint32_t index, nsIDOMFontFace * *_retval) override; \
  NS_IMETHOD GetLength(uint32_t *aLength) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMFONTFACELIST \
  NS_METHOD Item(uint32_t index, nsIDOMFontFace * *_retval); \
  NS_METHOD GetLength(uint32_t *aLength); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMFONTFACELIST(_to) \
  NS_IMETHOD Item(uint32_t index, nsIDOMFontFace * *_retval) override { return _to Item(index, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMFONTFACELIST(_to) \
  NS_IMETHOD Item(uint32_t index, nsIDOMFontFace * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Item(index, _retval); } \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMFontFaceList, nsIDOMFontFaceList)
