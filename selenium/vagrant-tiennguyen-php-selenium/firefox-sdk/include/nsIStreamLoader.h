...
#define NS_DECL_NON_VIRTUAL_NSISTREAMLOADEROBSERVER \
  NS_METHOD OnStreamComplete(nsIStreamLoader *loader, nsISupports *ctxt, nsresult status, uint32_t resultLength, const uint8_t *result); 
...
#define NS_DECL_NON_VIRTUAL_NSISTREAMLOADER \
  NS_METHOD Init(nsIStreamLoaderObserver *aStreamObserver, nsIRequestObserver *aRequestObserver); \
