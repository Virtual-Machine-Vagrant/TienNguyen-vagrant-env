...
#define NS_DECL_NSICLIPBOARDDRAGDROPHOOKLIST \
  NS_IMETHOD AddClipboardDragDropHooks(nsIClipboardDragDropHooks *aHooks) override; \
  NS_IMETHOD RemoveClipboardDragDropHooks(nsIClipboardDragDropHooks *aHooks) override; \
  NS_IMETHOD GetHookEnumerator(nsISimpleEnumerator * *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSICLIPBOARDDRAGDROPHOOKLIST \
  NS_METHOD AddClipboardDragDropHooks(nsIClipboardDragDropHooks *aHooks); \
  NS_METHOD RemoveClipboardDragDropHooks(nsIClipboardDragDropHooks *aHooks); \
  NS_METHOD GetHookEnumerator(nsISimpleEnumerator * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICLIPBOARDDRAGDROPHOOKLIST(_to) \
  NS_IMETHOD AddClipboardDragDropHooks(nsIClipboardDragDropHooks *aHooks) override { return _to AddClipboardDragDropHooks(aHooks); } \
  NS_IMETHOD RemoveClipboardDragDropHooks(nsIClipboardDragDropHooks *aHooks) override { return _to RemoveClipboardDragDropHooks(aHooks); } \
  NS_IMETHOD GetHookEnumerator(nsISimpleEnumerator * *_retval) override { return _to GetHookEnumerator(_retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICLIPBOARDDRAGDROPHOOKLIST(_to) \
  NS_IMETHOD AddClipboardDragDropHooks(nsIClipboardDragDropHooks *aHooks) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AddClipboardDragDropHooks(aHooks); } \
  NS_IMETHOD RemoveClipboardDragDropHooks(nsIClipboardDragDropHooks *aHooks) override { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveClipboardDragDropHooks(aHooks); } \
  NS_IMETHOD GetHookEnumerator(nsISimpleEnumerator * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHookEnumerator(_retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsClipboardDragDropHookList, nsIClipboardDragDropHookList)
