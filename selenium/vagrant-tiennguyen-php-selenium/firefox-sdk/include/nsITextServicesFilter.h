...
#define NS_DECL_NSITEXTSERVICESFILTER \
  NS_IMETHOD Skip(nsIDOMNode *aNode, bool *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSITEXTSERVICESFILTER \
  NS_METHOD Skip(nsIDOMNode *aNode, bool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITEXTSERVICESFILTER(_to) \
  NS_IMETHOD Skip(nsIDOMNode *aNode, bool *_retval) override { return _to Skip(aNode, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITEXTSERVICESFILTER(_to) \
  NS_IMETHOD Skip(nsIDOMNode *aNode, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Skip(aNode, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsTextServicesFilter, nsITextServicesFilter)
