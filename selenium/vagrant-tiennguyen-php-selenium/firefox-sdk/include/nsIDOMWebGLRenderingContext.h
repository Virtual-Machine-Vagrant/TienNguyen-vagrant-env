...
#define NS_DECL_NSIDOMWEBGLRENDERINGCONTEXT \
  NS_IMETHOD MozGetUnderlyingParamString(uint32_t pname, nsAString & _retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMWEBGLRENDERINGCONTEXT \
  NS_METHOD MozGetUnderlyingParamString(uint32_t pname, nsAString & _retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMWEBGLRENDERINGCONTEXT(_to) \
  NS_IMETHOD MozGetUnderlyingParamString(uint32_t pname, nsAString & _retval) override { return _to MozGetUnderlyingParamString(pname, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMWEBGLRENDERINGCONTEXT(_to) \
  NS_IMETHOD MozGetUnderlyingParamString(uint32_t pname, nsAString & _retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->MozGetUnderlyingParamString(pname, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMWebGLRenderingContext, nsIDOMWebGLRenderingContext)
