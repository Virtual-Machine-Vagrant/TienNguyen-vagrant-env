...
#define NS_DECL_NON_VIRTUAL_NSILOGINMANAGER \
  NS_METHOD GetInitializationPromise(JS::MutableHandleValue aInitializationPromise); \
  ...
  NS_METHOD AutoCompleteSearchAsync(const nsAString & aSearchString, nsIAutoCompleteResult *aPreviousResult, nsIDOMHTMLInputElement *aElement, nsIFormAutoCompleteObserver *aListener); \
