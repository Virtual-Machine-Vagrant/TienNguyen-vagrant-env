...
#define NS_DECL_NON_VIRTUAL_NSICSSUNPREFIXINGSERVICE \
  NS_METHOD GenerateUnprefixedDeclaration(const nsAString & aPropName, const nsAString & aRightHalfOfDecl, nsAString & aUnprefixedDecl, bool *_retval); \
  NS_METHOD GenerateUnprefixedGradientValue(const nsAString & aPrefixedFuncName, const nsAString & aPrefixedFuncBody, nsAString & aUnprefixedFuncName, nsAString & aUnprefixedFuncBody, bool *_retval); 
