...
#define NS_DECL_NON_VIRTUAL_NSIDOMHTMLBODYELEMENT \
  NS_METHOD GetALink(nsAString & aALink); \
  NS_METHOD SetALink(const nsAString & aALink); \
  NS_METHOD GetBackground(nsAString & aBackground); \
  NS_METHOD SetBackground(const nsAString & aBackground); \
  NS_METHOD GetBgColor(nsAString & aBgColor); \
  NS_METHOD SetBgColor(const nsAString & aBgColor); \
  NS_METHOD GetLink(nsAString & aLink); \
  NS_METHOD SetLink(const nsAString & aLink); \
  NS_METHOD GetText(nsAString & aText); \
  NS_METHOD SetText(const nsAString & aText); \
  NS_METHOD GetVLink(nsAString & aVLink); \
  NS_METHOD SetVLink(const nsAString & aVLink); 
