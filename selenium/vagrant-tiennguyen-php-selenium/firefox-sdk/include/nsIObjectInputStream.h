...
#define NS_DECL_NON_VIRTUAL_NSIOBJECTINPUTSTREAM \
  NS_METHOD ReadObject(bool aIsStrongRef, nsISupports * *_retval); \
  NS_METHOD_(nsresult) ReadID(nsID *aID); \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsObjectInputStream, nsIObjectInputStream)
