/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM ../../../dist/idl/nsIProfileSaveEvent.idl
 */
...
#define NS_DECL_NSIPROFILESAVEEVENT \
  NS_IMETHOD AddSubProfile(const char * aMarker) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIPROFILESAVEEVENT \
  NS_METHOD AddSubProfile(const char * aMarker); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPROFILESAVEEVENT(_to) \
  NS_IMETHOD AddSubProfile(const char * aMarker) override { return _to AddSubProfile(aMarker); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPROFILESAVEEVENT(_to) \
  NS_IMETHOD AddSubProfile(const char * aMarker) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AddSubProfile(aMarker); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsProfileSaveEvent, nsIProfileSaveEvent)
