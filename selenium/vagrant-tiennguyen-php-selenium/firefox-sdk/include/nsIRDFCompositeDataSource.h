...
#define NS_DECL_NON_VIRTUAL_NSIRDFCOMPOSITEDATASOURCE \
  NS_METHOD GetAllowNegativeAssertions(bool *aAllowNegativeAssertions); \
  NS_METHOD SetAllowNegativeAssertions(bool aAllowNegativeAssertions); \
  NS_METHOD GetCoalesceDuplicateArcs(bool *aCoalesceDuplicateArcs); \
  NS_METHOD SetCoalesceDuplicateArcs(bool aCoalesceDuplicateArcs); \
  NS_METHOD AddDataSource(nsIRDFDataSource *aDataSource); \
  NS_METHOD RemoveDataSource(nsIRDFDataSource *aDataSource); \
  NS_METHOD GetDataSources(nsISimpleEnumerator * *_retval); 
