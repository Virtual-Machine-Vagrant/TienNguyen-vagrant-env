...
#define NS_IXPCONNECT_IID_STR "f339ea52-10ce-4103-b1f2-fd9659040e3c"

#define NS_IXPCONNECT_IID \
  {0xf339ea52, 0x10ce, 0x4103, \
    { 0xb1, 0xf2, 0xfd, 0x96, 0x59, 0x04, 0x0e, 0x3c }}
...
#define NS_DECL_NON_VIRTUAL_NSIXPCONNECT \
  ...
  NS_METHOD_(nsISupports *) GetNativeOfWrapper(JSContext *aJSContext, JSObject *aJSObj); \
  JSContext * GetCurrentJSContext(void); \
  JSContext * GetSafeJSContext(void); \
  ...
  NS_METHOD SetReportAllJSExceptions(bool reportAllJSExceptions); \
