...
#define NS_DECL_NON_VIRTUAL_NSIASYNCSTREAMCOPIER \
  NS_METHOD Init(nsIInputStream *aSource, nsIOutputStream *aSink, nsIEventTarget *aTarget, bool aSourceBuffered, bool aSinkBuffered, uint32_t aChunkSize, bool aCloseSource, bool aCloseSink); \
  NS_METHOD AsyncCopy(nsIRequestObserver *aObserver, nsISupports *aObserverContext); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsAsyncStreamCopier, nsIAsyncStreamCopier)
