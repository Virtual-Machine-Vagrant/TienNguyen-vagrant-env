...
#define NS_DECL_NON_VIRTUAL_NSIDOMHTMLHRELEMENT \
  NS_METHOD GetAlign(nsAString & aAlign); \
  NS_METHOD SetAlign(const nsAString & aAlign); \
  NS_METHOD GetNoShade(bool *aNoShade); \
  NS_METHOD SetNoShade(bool aNoShade); \
  NS_METHOD GetSize(nsAString & aSize); \
  NS_METHOD SetSize(const nsAString & aSize); \
  NS_METHOD GetWidth(nsAString & aWidth); \
  NS_METHOD SetWidth(const nsAString & aWidth); \
  NS_METHOD GetColor(nsAString & aColor); \
  NS_METHOD SetColor(const nsAString & aColor); 
