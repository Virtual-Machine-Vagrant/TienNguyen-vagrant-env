...
#define NS_DECL_NON_VIRTUAL_NSIX509CERTVALIDITY \
  NS_METHOD GetNotBefore(PRTime *aNotBefore); \
  NS_METHOD GetNotBeforeLocalTime(nsAString & aNotBeforeLocalTime); \
  NS_METHOD GetNotBeforeLocalDay(nsAString & aNotBeforeLocalDay); \
  NS_METHOD GetNotBeforeGMT(nsAString & aNotBeforeGMT); \
  NS_METHOD GetNotAfter(PRTime *aNotAfter); \
  NS_METHOD GetNotAfterLocalTime(nsAString & aNotAfterLocalTime); \
  NS_METHOD GetNotAfterLocalDay(nsAString & aNotAfterLocalDay); \
  NS_METHOD GetNotAfterGMT(nsAString & aNotAfterGMT); 
