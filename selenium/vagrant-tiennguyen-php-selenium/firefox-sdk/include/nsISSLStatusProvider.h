...
#define NS_DECL_NSISSLSTATUSPROVIDER \
  NS_IMETHOD GetSSLStatus(nsISSLStatus * *aSSLStatus) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSISSLSTATUSPROVIDER \
  NS_METHOD GetSSLStatus(nsISSLStatus * *aSSLStatus); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISSLSTATUSPROVIDER(_to) \
  NS_IMETHOD GetSSLStatus(nsISSLStatus * *aSSLStatus) override { return _to GetSSLStatus(aSSLStatus); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISSLSTATUSPROVIDER(_to) \
  NS_IMETHOD GetSSLStatus(nsISSLStatus * *aSSLStatus) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSSLStatus(aSSLStatus); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsSSLStatusProvider, nsISSLStatusProvider)
