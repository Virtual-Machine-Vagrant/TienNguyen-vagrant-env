...
#define NS_DECL_NON_VIRTUAL_NSICONTENTPERMISSIONTYPE \
  ...
  NS_METHOD GetAccess(nsACString & aAccess); \
  NS_METHOD GetOptions(nsIArray * *aOptions); 
...
/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSICONTENTPERMISSIONREQUESTCALLBACK \
  NS_METHOD NotifyVisibility(bool isVisible); 
...
/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSICONTENTPERMISSIONREQUESTER \
  NS_METHOD GetVisibility(nsIContentPermissionRequestCallback *callback); \
  NS_METHOD GetOnVisibilityChange(nsIContentPermissionRequestCallback * *aOnVisibilityChange); \
  NS_METHOD SetOnVisibilityChange(nsIContentPermissionRequestCallback *aOnVisibilityChange); 
...
#define NS_DECL_NON_VIRTUAL_NSICONTENTPERMISSIONREQUEST \
  NS_METHOD GetTypes(nsIArray * *aTypes); \
  ...
  NS_METHOD GetRequester(nsIContentPermissionRequester * *aRequester); \
  NS_METHOD Cancel(void); \
  NS_METHOD Allow(JS::HandleValue choices); 
...
/* readonly attribute mozIDOMWindow window; */
NS_IMETHODIMP nsContentPermissionRequest::GetWindow(mozIDOMWindow * *aWindow)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
#define NS_DECL_NON_VIRTUAL_NSICONTENTPERMISSIONPROMPT \
  NS_METHOD Prompt(nsIContentPermissionRequest *request); 
