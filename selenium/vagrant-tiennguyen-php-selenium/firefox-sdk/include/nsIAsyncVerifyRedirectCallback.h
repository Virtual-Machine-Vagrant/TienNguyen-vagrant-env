...
#define NS_DECL_NON_VIRTUAL_NSIASYNCVERIFYREDIRECTCALLBACK \
  NS_METHOD OnRedirectVerifyCallback(nsresult result); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIASYNCVERIFYREDIRECTCALLBACK(_to) \
  NS_IMETHOD OnRedirectVerifyCallback(nsresult result) override { return _to OnRedirectVerifyCallback(result); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIASYNCVERIFYREDIRECTCALLBACK(_to) \
  NS_IMETHOD OnRedirectVerifyCallback(nsresult result) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnRedirectVerifyCallback(result); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsAsyncVerifyRedirectCallback, nsIAsyncVerifyRedirectCallback)
