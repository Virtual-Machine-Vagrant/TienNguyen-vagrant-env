...
#define NS_DECL_NON_VIRTUAL_NSINSSERRORSSERVICE \
  NS_METHOD IsNSSErrorCode(int32_t aNSPRCode, bool *_retval); \
  NS_METHOD GetXPCOMFromNSSError(int32_t aNSPRCode, nsresult *_retval); \
  NS_METHOD GetErrorMessage(nsresult aXPCOMErrorCode, nsAString & _retval); \
  NS_METHOD GetErrorClass(nsresult aXPCOMErrorCode, uint32_t *_retval); \
