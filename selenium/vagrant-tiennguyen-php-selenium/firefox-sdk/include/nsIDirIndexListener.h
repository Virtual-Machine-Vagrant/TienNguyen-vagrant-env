...
#define NS_DECL_NON_VIRTUAL_NSIDIRINDEXLISTENER \
  NS_METHOD OnIndexAvailable(nsIRequest *aRequest, nsISupports *aCtxt, nsIDirIndex *aIndex); \
  NS_METHOD OnInformationAvailable(nsIRequest *aRequest, nsISupports *aCtxt, const nsAString & aInfo); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDirIndexListener, nsIDirIndexListener)
...
#define NS_DECL_NON_VIRTUAL_NSIDIRINDEXPARSER \
  NS_METHOD GetListener(nsIDirIndexListener * *aListener); \
  NS_METHOD SetListener(nsIDirIndexListener *aListener); \
  NS_METHOD GetComment(char * *aComment); \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDirIndexParser, nsIDirIndexParser)
