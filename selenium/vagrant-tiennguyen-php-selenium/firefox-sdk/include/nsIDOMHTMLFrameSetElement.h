...
#define NS_DECL_NON_VIRTUAL_NSIDOMHTMLFRAMESETELEMENT \
  NS_METHOD GetCols(nsAString & aCols); \
  NS_METHOD SetCols(const nsAString & aCols); \
  NS_METHOD GetRows(nsAString & aRows); \
  NS_METHOD SetRows(const nsAString & aRows); 
