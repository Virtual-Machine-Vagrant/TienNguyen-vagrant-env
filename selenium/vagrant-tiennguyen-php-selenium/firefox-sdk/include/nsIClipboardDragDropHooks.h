...
#define NS_DECL_NSICLIPBOARDDRAGDROPHOOKS \
  NS_IMETHOD AllowStartDrag(nsIDOMEvent *event, bool *_retval) override; \
  NS_IMETHOD AllowDrop(nsIDOMEvent *event, nsIDragSession *session, bool *_retval) override; \
  NS_IMETHOD OnCopyOrDrag(nsIDOMEvent *aEvent, nsITransferable *trans, bool *_retval) override; \
  NS_IMETHOD OnPasteOrDrop(nsIDOMEvent *event, nsITransferable *trans, bool *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSICLIPBOARDDRAGDROPHOOKS \
  NS_METHOD AllowStartDrag(nsIDOMEvent *event, bool *_retval); \
  NS_METHOD AllowDrop(nsIDOMEvent *event, nsIDragSession *session, bool *_retval); \
  NS_METHOD OnCopyOrDrag(nsIDOMEvent *aEvent, nsITransferable *trans, bool *_retval); \
  NS_METHOD OnPasteOrDrop(nsIDOMEvent *event, nsITransferable *trans, bool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICLIPBOARDDRAGDROPHOOKS(_to) \
  NS_IMETHOD AllowStartDrag(nsIDOMEvent *event, bool *_retval) override { return _to AllowStartDrag(event, _retval); } \
  NS_IMETHOD AllowDrop(nsIDOMEvent *event, nsIDragSession *session, bool *_retval) override { return _to AllowDrop(event, session, _retval); } \
  NS_IMETHOD OnCopyOrDrag(nsIDOMEvent *aEvent, nsITransferable *trans, bool *_retval) override { return _to OnCopyOrDrag(aEvent, trans, _retval); } \
  NS_IMETHOD OnPasteOrDrop(nsIDOMEvent *event, nsITransferable *trans, bool *_retval) override { return _to OnPasteOrDrop(event, trans, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICLIPBOARDDRAGDROPHOOKS(_to) \
  NS_IMETHOD AllowStartDrag(nsIDOMEvent *event, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AllowStartDrag(event, _retval); } \
  NS_IMETHOD AllowDrop(nsIDOMEvent *event, nsIDragSession *session, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AllowDrop(event, session, _retval); } \
  NS_IMETHOD OnCopyOrDrag(nsIDOMEvent *aEvent, nsITransferable *trans, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnCopyOrDrag(aEvent, trans, _retval); } \
  NS_IMETHOD OnPasteOrDrop(nsIDOMEvent *event, nsITransferable *trans, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnPasteOrDrop(event, trans, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsClipboardDragDropHooks, nsIClipboardDragDropHooks)
