...
#define NS_DECL_NSISAXERRORHANDLER \
  NS_IMETHOD Error(nsISAXLocator *locator, const nsAString & error) override; \
  NS_IMETHOD FatalError(nsISAXLocator *locator, const nsAString & error) override; \
  NS_IMETHOD IgnorableWarning(nsISAXLocator *locator, const nsAString & error) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSISAXERRORHANDLER \
  NS_METHOD Error(nsISAXLocator *locator, const nsAString & error); \
  NS_METHOD FatalError(nsISAXLocator *locator, const nsAString & error); \
  NS_METHOD IgnorableWarning(nsISAXLocator *locator, const nsAString & error); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISAXERRORHANDLER(_to) \
  NS_IMETHOD Error(nsISAXLocator *locator, const nsAString & error) override { return _to Error(locator, error); } \
  NS_IMETHOD FatalError(nsISAXLocator *locator, const nsAString & error) override { return _to FatalError(locator, error); } \
  NS_IMETHOD IgnorableWarning(nsISAXLocator *locator, const nsAString & error) override { return _to IgnorableWarning(locator, error); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISAXERRORHANDLER(_to) \
  NS_IMETHOD Error(nsISAXLocator *locator, const nsAString & error) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Error(locator, error); } \
  NS_IMETHOD FatalError(nsISAXLocator *locator, const nsAString & error) override { return !_to ? NS_ERROR_NULL_POINTER : _to->FatalError(locator, error); } \
  NS_IMETHOD IgnorableWarning(nsISAXLocator *locator, const nsAString & error) override { return !_to ? NS_ERROR_NULL_POINTER : _to->IgnorableWarning(locator, error); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsSAXErrorHandler, nsISAXErrorHandler)
