...
#define NS_DECL_NON_VIRTUAL_NSIXULOVERLAYPROVIDER \
  NS_METHOD GetXULOverlays(nsIURI *aURI, nsISimpleEnumerator * *_retval); \
  NS_METHOD GetStyleOverlays(nsIURI *aURI, nsISimpleEnumerator * *_retval); 
