...
#define NS_DECL_NSITOOLTIPTEXTPROVIDER \
  NS_IMETHOD GetNodeText(nsIDOMNode *aNode, char16_t * *aText, bool *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSITOOLTIPTEXTPROVIDER \
  NS_METHOD GetNodeText(nsIDOMNode *aNode, char16_t * *aText, bool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITOOLTIPTEXTPROVIDER(_to) \
  NS_IMETHOD GetNodeText(nsIDOMNode *aNode, char16_t * *aText, bool *_retval) override { return _to GetNodeText(aNode, aText, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITOOLTIPTEXTPROVIDER(_to) \
  NS_IMETHOD GetNodeText(nsIDOMNode *aNode, char16_t * *aText, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNodeText(aNode, aText, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsTooltipTextProvider, nsITooltipTextProvider)
