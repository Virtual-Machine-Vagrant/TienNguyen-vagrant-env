...
#define NS_DECL_NSIRDFDELEGATEFACTORY \
  NS_IMETHOD CreateDelegate(nsIRDFResource *aOuter, const char * aKey, const nsIID & aIID, void **aResult) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIRDFDELEGATEFACTORY \
  NS_METHOD CreateDelegate(nsIRDFResource *aOuter, const char * aKey, const nsIID & aIID, void **aResult); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIRDFDELEGATEFACTORY(_to) \
  NS_IMETHOD CreateDelegate(nsIRDFResource *aOuter, const char * aKey, const nsIID & aIID, void **aResult) override { return _to CreateDelegate(aOuter, aKey, aIID, aResult); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIRDFDELEGATEFACTORY(_to) \
  NS_IMETHOD CreateDelegate(nsIRDFResource *aOuter, const char * aKey, const nsIID & aIID, void **aResult) override { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateDelegate(aOuter, aKey, aIID, aResult); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsRDFDelegateFactory, nsIRDFDelegateFactory)
