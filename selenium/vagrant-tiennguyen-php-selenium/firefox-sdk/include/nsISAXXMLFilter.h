...
#define NS_DECL_NSISAXXMLFILTER \
  NS_IMETHOD GetParent(nsISAXXMLReader * *aParent) override; \
  NS_IMETHOD SetParent(nsISAXXMLReader *aParent) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSISAXXMLFILTER \
  NS_METHOD GetParent(nsISAXXMLReader * *aParent); \
  NS_METHOD SetParent(nsISAXXMLReader *aParent); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISAXXMLFILTER(_to) \
  NS_IMETHOD GetParent(nsISAXXMLReader * *aParent) override { return _to GetParent(aParent); } \
  NS_IMETHOD SetParent(nsISAXXMLReader *aParent) override { return _to SetParent(aParent); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISAXXMLFILTER(_to) \
  NS_IMETHOD GetParent(nsISAXXMLReader * *aParent) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetParent(aParent); } \
  NS_IMETHOD SetParent(nsISAXXMLReader *aParent) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetParent(aParent); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsSAXXMLFilter, nsISAXXMLFilter)
