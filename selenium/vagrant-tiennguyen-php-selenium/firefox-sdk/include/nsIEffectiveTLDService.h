...
#define NS_DECL_NON_VIRTUAL_NSIEFFECTIVETLDSERVICE \
  NS_METHOD GetPublicSuffix(nsIURI *aURI, nsACString & _retval); \
  NS_METHOD GetBaseDomain(nsIURI *aURI, uint32_t aAdditionalParts, nsACString & _retval); \
  NS_METHOD GetPublicSuffixFromHost(const nsACString & aHost, nsACString & _retval); \
  NS_METHOD GetBaseDomainFromHost(const nsACString & aHost, uint32_t aAdditionalParts, nsACString & _retval); \
  NS_METHOD GetNextSubDomain(const nsACString & aHost, nsACString & _retval); 
