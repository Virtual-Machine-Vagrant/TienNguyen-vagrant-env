...
#define NS_DECL_NON_VIRTUAL_NSIDOMHTMLMENUITEMELEMENT \
  ...
  NS_METHOD GetIcon(nsAString & aIcon); \
  NS_METHOD SetIcon(const nsAString & aIcon); \
  ...
  NS_METHOD GetRadiogroup(nsAString & aRadiogroup); \
  NS_METHOD SetRadiogroup(const nsAString & aRadiogroup); 
