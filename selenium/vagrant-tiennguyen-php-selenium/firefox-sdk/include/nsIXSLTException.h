/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM ../../../dist/idl/nsIXSLTException.idl
 */
...
#define NS_DECL_NSIXSLTEXCEPTION \
  NS_IMETHOD GetStyleNode(nsIDOMNode * *aStyleNode) override; \
  NS_IMETHOD GetSourceNode(nsIDOMNode * *aSourceNode) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIXSLTEXCEPTION \
  NS_METHOD GetStyleNode(nsIDOMNode * *aStyleNode); \
  NS_METHOD GetSourceNode(nsIDOMNode * *aSourceNode); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXSLTEXCEPTION(_to) \
  NS_IMETHOD GetStyleNode(nsIDOMNode * *aStyleNode) override { return _to GetStyleNode(aStyleNode); } \
...
#define NS_FORWARD_SAFE_NSIXSLTEXCEPTION(_to) \
  NS_IMETHOD GetStyleNode(nsIDOMNode * *aStyleNode) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStyleNode(aStyleNode); } \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsXSLTException, nsIXSLTException)
