...
#define NS_DECL_NON_VIRTUAL_NSIDOMXPATHEVALUATOR \
  NS_METHOD Evaluate(const nsAString & expression, nsIDOMNode *contextNode, nsIDOMNode *resolver, uint16_t type, nsISupports *result, nsISupports * *_retval); 
