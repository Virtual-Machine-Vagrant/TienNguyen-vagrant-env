...
#define NS_DECL_NSIUNICHARSTREAMLOADEROBSERVER \
  NS_IMETHOD OnDetermineCharset(nsIUnicharStreamLoader *aLoader, nsISupports *aContext, const nsACString & aSegment, nsACString & _retval) override; \
  NS_IMETHOD OnStreamComplete(nsIUnicharStreamLoader *aLoader, nsISupports *aContext, nsresult aStatus, const nsAString & aBuffer) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIUNICHARSTREAMLOADEROBSERVER \
  NS_METHOD OnDetermineCharset(nsIUnicharStreamLoader *aLoader, nsISupports *aContext, const nsACString & aSegment, nsACString & _retval); \
  NS_METHOD OnStreamComplete(nsIUnicharStreamLoader *aLoader, nsISupports *aContext, nsresult aStatus, const nsAString & aBuffer); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIUNICHARSTREAMLOADEROBSERVER(_to) \
  NS_IMETHOD OnDetermineCharset(nsIUnicharStreamLoader *aLoader, nsISupports *aContext, const nsACString & aSegment, nsACString & _retval) override { return _to OnDetermineCharset(aLoader, aContext, aSegment, _retval); } \
  NS_IMETHOD OnStreamComplete(nsIUnicharStreamLoader *aLoader, nsISupports *aContext, nsresult aStatus, const nsAString & aBuffer) override { return _to OnStreamComplete(aLoader, aContext, aStatus, aBuffer); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIUNICHARSTREAMLOADEROBSERVER(_to) \
  NS_IMETHOD OnDetermineCharset(nsIUnicharStreamLoader *aLoader, nsISupports *aContext, const nsACString & aSegment, nsACString & _retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnDetermineCharset(aLoader, aContext, aSegment, _retval); } \
  NS_IMETHOD OnStreamComplete(nsIUnicharStreamLoader *aLoader, nsISupports *aContext, nsresult aStatus, const nsAString & aBuffer) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnStreamComplete(aLoader, aContext, aStatus, aBuffer); } 
...
#define NS_DECL_NSIUNICHARSTREAMLOADER \
  NS_IMETHOD Init(nsIUnicharStreamLoaderObserver *aObserver) override; \
  NS_IMETHOD GetChannel(nsIChannel * *aChannel) override; \
  NS_IMETHOD GetCharset(nsACString & aCharset) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIUNICHARSTREAMLOADER \
  NS_METHOD Init(nsIUnicharStreamLoaderObserver *aObserver); \
...
#define NS_FORWARD_NSIUNICHARSTREAMLOADER(_to) \
  NS_IMETHOD Init(nsIUnicharStreamLoaderObserver *aObserver) override { return _to Init(aObserver); } \
...
#define NS_FORWARD_SAFE_NSIUNICHARSTREAMLOADER(_to) \
  NS_IMETHOD Init(nsIUnicharStreamLoaderObserver *aObserver) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(aObserver); } \
