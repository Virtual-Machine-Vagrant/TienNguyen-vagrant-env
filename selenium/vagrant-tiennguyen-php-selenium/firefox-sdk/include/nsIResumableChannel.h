...
#define NS_DECL_NON_VIRTUAL_NSIRESUMABLECHANNEL \
  NS_METHOD ResumeAt(uint64_t startPos, const nsACString & entityID); \
  NS_METHOD GetEntityID(nsACString & aEntityID); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsResumableChannel, nsIResumableChannel)
