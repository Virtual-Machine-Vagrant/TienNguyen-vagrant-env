...
#define NS_DECL_NON_VIRTUAL_NSIURLFORMATTER \
  NS_METHOD FormatURL(const nsAString & aFormat, nsAString & _retval); \
  NS_METHOD FormatURLPref(const nsAString & aPref, nsAString & _retval); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsURLFormatter, nsIURLFormatter)
