...
#define NS_DECL_NSIHTTPINDEX \
  NS_IMETHOD GetBaseURL(char * *aBaseURL) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIHTTPINDEX \
  NS_METHOD GetBaseURL(char * *aBaseURL); \
  NS_METHOD GetDataSource(nsIRDFDataSource * *aDataSource); \
  NS_METHOD GetEncoding(char * *aEncoding); \
  NS_METHOD SetEncoding(const char * aEncoding); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIHTTPINDEX(_to) \
  NS_IMETHOD GetBaseURL(char * *aBaseURL) override { return _to GetBaseURL(aBaseURL); } \
...
#define NS_FORWARD_SAFE_NSIHTTPINDEX(_to) \
  NS_IMETHOD GetBaseURL(char * *aBaseURL) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBaseURL(aBaseURL); } \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsHTTPIndex, nsIHTTPIndex)
