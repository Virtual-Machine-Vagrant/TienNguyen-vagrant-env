...
#define NS_DECL_NON_VIRTUAL_NSIDOMXULSELECTCONTROLITEMELEMENT \
  ...
  NS_METHOD GetCrop(nsAString & aCrop); \
  NS_METHOD SetCrop(const nsAString & aCrop); \
  NS_METHOD GetImage(nsAString & aImage); \
  NS_METHOD SetImage(const nsAString & aImage); \
