...
#define NS_DECL_NON_VIRTUAL_NSIWINDOWCREATOR2 \
  NS_METHOD CreateChromeWindow2(nsIWebBrowserChrome *parent, uint32_t chromeFlags, uint32_t contextFlags, nsIURI *uri, nsITabParent *aOpeningTab, bool *cancel, nsIWebBrowserChrome * *_retval); \
