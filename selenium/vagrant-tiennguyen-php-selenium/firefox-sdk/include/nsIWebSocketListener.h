...
#define NS_DECL_NSIWEBSOCKETLISTENER \
  ...
  NS_IMETHOD OnMessageAvailable(nsISupports *aContext, const nsACString & aMsg) override; \
  NS_IMETHOD OnBinaryMessageAvailable(nsISupports *aContext, const nsACString & aMsg) override; \
  NS_IMETHOD OnAcknowledge(nsISupports *aContext, uint32_t aSize) override; \
  NS_IMETHOD OnServerClose(nsISupports *aContext, uint16_t aCode, const nsACString & aReason) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIWEBSOCKETLISTENER \
  NS_METHOD OnStart(nsISupports *aContext); \
  NS_METHOD OnStop(nsISupports *aContext, nsresult aStatusCode); \
  NS_METHOD OnMessageAvailable(nsISupports *aContext, const nsACString & aMsg); \
  NS_METHOD OnBinaryMessageAvailable(nsISupports *aContext, const nsACString & aMsg); \
  NS_METHOD OnAcknowledge(nsISupports *aContext, uint32_t aSize); \
  NS_METHOD OnServerClose(nsISupports *aContext, uint16_t aCode, const nsACString & aReason); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWEBSOCKETLISTENER(_to) \
  NS_IMETHOD OnStart(nsISupports *aContext) override { return _to OnStart(aContext); } \
  NS_IMETHOD OnStop(nsISupports *aContext, nsresult aStatusCode) override { return _to OnStop(aContext, aStatusCode); } \
  NS_IMETHOD OnMessageAvailable(nsISupports *aContext, const nsACString & aMsg) override { return _to OnMessageAvailable(aContext, aMsg); } \
  NS_IMETHOD OnBinaryMessageAvailable(nsISupports *aContext, const nsACString & aMsg) override { return _to OnBinaryMessageAvailable(aContext, aMsg); } \
  NS_IMETHOD OnAcknowledge(nsISupports *aContext, uint32_t aSize) override { return _to OnAcknowledge(aContext, aSize); } \
  NS_IMETHOD OnServerClose(nsISupports *aContext, uint16_t aCode, const nsACString & aReason) override { return _to OnServerClose(aContext, aCode, aReason); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWEBSOCKETLISTENER(_to) \
  NS_IMETHOD OnStart(nsISupports *aContext) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnStart(aContext); } \
  NS_IMETHOD OnStop(nsISupports *aContext, nsresult aStatusCode) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnStop(aContext, aStatusCode); } \
  NS_IMETHOD OnMessageAvailable(nsISupports *aContext, const nsACString & aMsg) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnMessageAvailable(aContext, aMsg); } \
  NS_IMETHOD OnBinaryMessageAvailable(nsISupports *aContext, const nsACString & aMsg) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnBinaryMessageAvailable(aContext, aMsg); } \
  NS_IMETHOD OnAcknowledge(nsISupports *aContext, uint32_t aSize) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnAcknowledge(aContext, aSize); } \
  NS_IMETHOD OnServerClose(nsISupports *aContext, uint16_t aCode, const nsACString & aReason) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnServerClose(aContext, aCode, aReason); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsWebSocketListener, nsIWebSocketListener)
