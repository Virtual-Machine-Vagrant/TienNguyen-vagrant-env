...
#define NS_DECL_NON_VIRTUAL_NSIOBSERVER \
  NS_METHOD Observe(nsISupports *aSubject, const char * aTopic, const char16_t * aData); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsObserver, nsIObserver)
...
/* void observe (in nsISupports aSubject, in string aTopic, in wstring aData); */
NS_IMETHODIMP nsObserver::Observe(nsISupports *aSubject, const char * aTopic, const char16_t * aData)
{
