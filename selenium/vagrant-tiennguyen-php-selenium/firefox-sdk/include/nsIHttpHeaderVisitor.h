...
#define NS_DECL_NON_VIRTUAL_NSIHTTPHEADERVISITOR \
  NS_METHOD VisitHeader(const nsACString & aHeader, const nsACString & aValue); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIHTTPHEADERVISITOR(_to) \
  NS_IMETHOD VisitHeader(const nsACString & aHeader, const nsACString & aValue) override { return _to VisitHeader(aHeader, aValue); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIHTTPHEADERVISITOR(_to) \
  NS_IMETHOD VisitHeader(const nsACString & aHeader, const nsACString & aValue) override { return !_to ? NS_ERROR_NULL_POINTER : _to->VisitHeader(aHeader, aValue); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsHttpHeaderVisitor, nsIHttpHeaderVisitor)
