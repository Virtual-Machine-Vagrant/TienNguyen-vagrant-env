...
#define NS_DECL_NSIMIMEINPUTSTREAM \
  NS_IMETHOD GetAddContentLength(bool *aAddContentLength) override; \
  NS_IMETHOD SetAddContentLength(bool aAddContentLength) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIMIMEINPUTSTREAM \
  NS_METHOD GetAddContentLength(bool *aAddContentLength); \
  NS_METHOD SetAddContentLength(bool aAddContentLength); \
  NS_METHOD AddHeader(const char * name, const char * value); \
  NS_METHOD SetData(nsIInputStream *stream); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIMIMEINPUTSTREAM(_to) \
  NS_IMETHOD GetAddContentLength(bool *aAddContentLength) override { return _to GetAddContentLength(aAddContentLength); } \
  NS_IMETHOD SetAddContentLength(bool aAddContentLength) override { return _to SetAddContentLength(aAddContentLength); } \
...
#define NS_FORWARD_SAFE_NSIMIMEINPUTSTREAM(_to) \
  NS_IMETHOD GetAddContentLength(bool *aAddContentLength) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAddContentLength(aAddContentLength); } \
  NS_IMETHOD SetAddContentLength(bool aAddContentLength) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAddContentLength(aAddContentLength); } \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsMIMEInputStream, nsIMIMEInputStream)
