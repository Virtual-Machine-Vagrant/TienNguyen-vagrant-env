...
#define NS_DECL_NSIDOMDOMEXCEPTION \
  NS_IMETHOD GetCode(uint16_t *aCode) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMDOMEXCEPTION \
  NS_METHOD GetCode(uint16_t *aCode); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMDOMEXCEPTION(_to) \
  NS_IMETHOD GetCode(uint16_t *aCode) override { return _to GetCode(aCode); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMDOMEXCEPTION(_to) \
  NS_IMETHOD GetCode(uint16_t *aCode) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCode(aCode); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMDOMException, nsIDOMDOMException)
