...
#define NS_DECL_NSIWINDOWDATASOURCE \
  NS_IMETHOD GetWindowForResource(const char * inResource, nsIDOMWindow * *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIWINDOWDATASOURCE \
  NS_METHOD GetWindowForResource(const char * inResource, nsIDOMWindow * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWINDOWDATASOURCE(_to) \
  NS_IMETHOD GetWindowForResource(const char * inResource, nsIDOMWindow * *_retval) override { return _to GetWindowForResource(inResource, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWINDOWDATASOURCE(_to) \
  NS_IMETHOD GetWindowForResource(const char * inResource, nsIDOMWindow * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetWindowForResource(inResource, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsWindowDataSource, nsIWindowDataSource)
