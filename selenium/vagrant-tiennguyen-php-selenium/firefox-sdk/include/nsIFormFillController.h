...
#define NS_DECL_NSIFORMFILLCONTROLLER \
  NS_IMETHOD AttachToBrowser(nsIDocShell *docShell, nsIAutoCompletePopup *popup) override; \
  NS_IMETHOD DetachFromBrowser(nsIDocShell *docShell) override; \
  NS_IMETHOD MarkAsLoginManagerField(nsIDOMHTMLInputElement *aInput) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIFORMFILLCONTROLLER \
  NS_METHOD AttachToBrowser(nsIDocShell *docShell, nsIAutoCompletePopup *popup); \
  NS_METHOD DetachFromBrowser(nsIDocShell *docShell); \
  NS_METHOD MarkAsLoginManagerField(nsIDOMHTMLInputElement *aInput); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIFORMFILLCONTROLLER(_to) \
  NS_IMETHOD AttachToBrowser(nsIDocShell *docShell, nsIAutoCompletePopup *popup) override { return _to AttachToBrowser(docShell, popup); } \
  NS_IMETHOD DetachFromBrowser(nsIDocShell *docShell) override { return _to DetachFromBrowser(docShell); } \
  NS_IMETHOD MarkAsLoginManagerField(nsIDOMHTMLInputElement *aInput) override { return _to MarkAsLoginManagerField(aInput); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIFORMFILLCONTROLLER(_to) \
  NS_IMETHOD AttachToBrowser(nsIDocShell *docShell, nsIAutoCompletePopup *popup) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AttachToBrowser(docShell, popup); } \
  NS_IMETHOD DetachFromBrowser(nsIDocShell *docShell) override { return !_to ? NS_ERROR_NULL_POINTER : _to->DetachFromBrowser(docShell); } \
  NS_IMETHOD MarkAsLoginManagerField(nsIDOMHTMLInputElement *aInput) override { return !_to ? NS_ERROR_NULL_POINTER : _to->MarkAsLoginManagerField(aInput); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsFormFillController, nsIFormFillController)
