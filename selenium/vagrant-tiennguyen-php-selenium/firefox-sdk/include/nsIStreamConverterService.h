...
#define NS_DECL_NON_VIRTUAL_NSISTREAMCONVERTERSERVICE \
  NS_METHOD CanConvert(const char * aFromType, const char * aToType, bool *_retval); \
  NS_METHOD Convert(nsIInputStream *aFromStream, const char * aFromType, const char * aToType, nsISupports *aContext, nsIInputStream * *_retval); \
  NS_METHOD AsyncConvertData(const char * aFromType, const char * aToType, nsIStreamListener *aListener, nsISupports *aContext, nsIStreamListener * *_retval); 
