...
#define NS_DECL_NSIMOZSAXXMLDECLARATIONHANDLER \
  NS_IMETHOD HandleXMLDeclaration(const nsAString & version, const nsAString & encoding, bool standalone) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIMOZSAXXMLDECLARATIONHANDLER \
  NS_METHOD HandleXMLDeclaration(const nsAString & version, const nsAString & encoding, bool standalone); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIMOZSAXXMLDECLARATIONHANDLER(_to) \
  NS_IMETHOD HandleXMLDeclaration(const nsAString & version, const nsAString & encoding, bool standalone) override { return _to HandleXMLDeclaration(version, encoding, standalone); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIMOZSAXXMLDECLARATIONHANDLER(_to) \
  NS_IMETHOD HandleXMLDeclaration(const nsAString & version, const nsAString & encoding, bool standalone) override { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleXMLDeclaration(version, encoding, standalone); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsMozSAXXMLDeclarationHandler, nsIMozSAXXMLDeclarationHandler)
