...
#define NS_DECL_NON_VIRTUAL_NSIDOMHTMLIMAGEELEMENT \
  ...
  NS_METHOD GetSrcset(nsAString & aSrcset); \
  NS_METHOD SetSrcset(const nsAString & aSrcset); \
  NS_METHOD GetSizes(nsAString & aSizes); \
  NS_METHOD SetSizes(const nsAString & aSizes); \
  NS_METHOD GetUseMap(nsAString & aUseMap); \
  NS_METHOD SetUseMap(const nsAString & aUseMap); \
  NS_METHOD GetIsMap(bool *aIsMap); \
  NS_METHOD SetIsMap(bool aIsMap); \
  ...
  NS_METHOD GetComplete(bool *aComplete); \
  ...
  NS_METHOD GetLowsrc(nsAString & aLowsrc); \
  NS_METHOD SetLowsrc(const nsAString & aLowsrc); \
