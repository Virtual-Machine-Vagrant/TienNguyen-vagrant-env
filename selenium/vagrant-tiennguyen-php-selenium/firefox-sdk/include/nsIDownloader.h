...
#define NS_DECL_NON_VIRTUAL_NSIDOWNLOADER \
  NS_METHOD Init(nsIDownloadObserver *observer, nsIFile *downloadLocation); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDownloader, nsIDownloader)
...
#define NS_DECL_NON_VIRTUAL_NSIDOWNLOADOBSERVER \
  NS_METHOD OnDownloadComplete(nsIDownloader *downloader, nsIRequest *request, nsISupports *ctxt, nsresult status, nsIFile *result); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDownloadObserver, nsIDownloadObserver)
