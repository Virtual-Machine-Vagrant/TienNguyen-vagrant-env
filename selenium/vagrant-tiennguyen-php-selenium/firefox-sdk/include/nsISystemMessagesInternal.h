...
#define NS_ISYSTEMMESSAGESINTERNAL_IID_STR "59b6beda-f911-4d47-a296-8c81e6abcfb9"

#define NS_ISYSTEMMESSAGESINTERNAL_IID \
  {0x59b6beda, 0xf911, 0x4d47, \
    { 0xa2, 0x96, 0x8c, 0x81, 0xe6, 0xab, 0xcf, 0xb9 }}
...
class NS_NO_VTABLE nsISystemMessagesInternal : public nsISupports {
 public:
  ...
  /* nsISupports broadcastMessage (in DOMString type, in jsval message, [optional] in jsval extra); */
  NS_IMETHOD BroadcastMessage(const nsAString & type, JS::HandleValue message, JS::HandleValue extra, nsISupports * *_retval) = 0;
...
#define NS_DECL_NSISYSTEMMESSAGESINTERNAL \
  ...
  NS_IMETHOD BroadcastMessage(const nsAString & type, JS::HandleValue message, JS::HandleValue extra, nsISupports * *_retval) override; \
...
#define NS_DECL_NON_VIRTUAL_NSISYSTEMMESSAGESINTERNAL \
  NS_METHOD SendMessage(const nsAString & type, JS::HandleValue message, nsIURI *pageURI, nsIURI *manifestURI, JS::HandleValue extra, nsISupports * *_retval); \
  NS_METHOD BroadcastMessage(const nsAString & type, JS::HandleValue message, JS::HandleValue extra, nsISupports * *_retval); \
  NS_METHOD RegisterPage(const nsAString & type, nsIURI *pageURI, nsIURI *manifestURI); \
  NS_METHOD RefreshCache(nsIMessageSender *childMM, nsIURI *manifestURI); 
...
#define NS_FORWARD_NSISYSTEMMESSAGESINTERNAL(_to) \
  ...
  NS_IMETHOD BroadcastMessage(const nsAString & type, JS::HandleValue message, JS::HandleValue extra, nsISupports * *_retval) override { return _to BroadcastMessage(type, message, extra, _retval); } \
...
#define NS_FORWARD_SAFE_NSISYSTEMMESSAGESINTERNAL(_to) \
  ...
  NS_IMETHOD BroadcastMessage(const nsAString & type, JS::HandleValue message, JS::HandleValue extra, nsISupports * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->BroadcastMessage(type, message, extra, _retval); } \
...
/* nsISupports broadcastMessage (in DOMString type, in jsval message, [optional] in jsval extra); */
NS_IMETHODIMP nsSystemMessagesInternal::BroadcastMessage(const nsAString & type, JS::HandleValue message, JS::HandleValue extra, nsISupports * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSISYSTEMMESSAGESWRAPPER \
  NS_METHOD WrapMessage(JS::HandleValue message, nsIDOMWindow *window, JS::MutableHandleValue _retval); 
...
/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSISYSTEMMESSAGESCONFIGURATOR \
  NS_METHOD GetMustShowRunningApp(bool *aMustShowRunningApp); \
  NS_METHOD ShouldDispatch(const nsAString & manifestURL, const nsAString & pageURL, const nsAString & type, JS::HandleValue message, JS::HandleValue extra, JS::MutableHandleValue _retval); 
