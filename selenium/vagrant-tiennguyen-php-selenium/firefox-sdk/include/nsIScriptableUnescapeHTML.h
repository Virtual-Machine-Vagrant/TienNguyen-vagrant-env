...
#define NS_DECL_NSISCRIPTABLEUNESCAPEHTML \
  NS_IMETHOD Unescape(const nsAString & src, nsAString & _retval) override; \
  NS_IMETHOD ParseFragment(const nsAString & fragment, bool isXML, nsIURI *baseURI, nsIDOMElement *element, nsIDOMDocumentFragment * *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSISCRIPTABLEUNESCAPEHTML \
  NS_METHOD Unescape(const nsAString & src, nsAString & _retval); \
  NS_METHOD ParseFragment(const nsAString & fragment, bool isXML, nsIURI *baseURI, nsIDOMElement *element, nsIDOMDocumentFragment * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISCRIPTABLEUNESCAPEHTML(_to) \
  NS_IMETHOD Unescape(const nsAString & src, nsAString & _retval) override { return _to Unescape(src, _retval); } \
  NS_IMETHOD ParseFragment(const nsAString & fragment, bool isXML, nsIURI *baseURI, nsIDOMElement *element, nsIDOMDocumentFragment * *_retval) override { return _to ParseFragment(fragment, isXML, baseURI, element, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISCRIPTABLEUNESCAPEHTML(_to) \
  NS_IMETHOD Unescape(const nsAString & src, nsAString & _retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Unescape(src, _retval); } \
  NS_IMETHOD ParseFragment(const nsAString & fragment, bool isXML, nsIURI *baseURI, nsIDOMElement *element, nsIDOMDocumentFragment * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ParseFragment(fragment, isXML, baseURI, element, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsScriptableUnescapeHTML, nsIScriptableUnescapeHTML)
