...
#define NS_DECL_NON_VIRTUAL_NSIFILEINPUTSTREAM \
  NS_METHOD Init(nsIFile *file, int32_t ioFlags, int32_t perm, int32_t behaviorFlags); \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsFileInputStream, nsIFileInputStream)
...
#define NS_DECL_NON_VIRTUAL_NSIFILEOUTPUTSTREAM \
  NS_METHOD Init(nsIFile *file, int32_t ioFlags, int32_t perm, int32_t behaviorFlags); \
  NS_METHOD Preallocate(int64_t length); \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsFileOutputStream, nsIFileOutputStream)
...
/* [noscript] void preallocate (in long long length); */
NS_IMETHODIMP nsFileOutputStream::Preallocate(int64_t length)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
#define NS_DECL_NSIPARTIALFILEINPUTSTREAM \
  NS_IMETHOD Init(nsIFile *file, uint64_t start, uint64_t length, int32_t ioFlags, int32_t perm, int32_t behaviorFlags) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIPARTIALFILEINPUTSTREAM \
  NS_METHOD Init(nsIFile *file, uint64_t start, uint64_t length, int32_t ioFlags, int32_t perm, int32_t behaviorFlags); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPARTIALFILEINPUTSTREAM(_to) \
  NS_IMETHOD Init(nsIFile *file, uint64_t start, uint64_t length, int32_t ioFlags, int32_t perm, int32_t behaviorFlags) override { return _to Init(file, start, length, ioFlags, perm, behaviorFlags); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPARTIALFILEINPUTSTREAM(_to) \
  NS_IMETHOD Init(nsIFile *file, uint64_t start, uint64_t length, int32_t ioFlags, int32_t perm, int32_t behaviorFlags) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(file, start, length, ioFlags, perm, behaviorFlags); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsPartialFileInputStream, nsIPartialFileInputStream)
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsFileStream, nsIFileStream)
...
#define NS_DECL_NON_VIRTUAL_NSIFILEMETADATA \
  ...
  NS_METHOD GetLastModified(int64_t *aLastModified); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsFileMetadata, nsIFileMetadata)
