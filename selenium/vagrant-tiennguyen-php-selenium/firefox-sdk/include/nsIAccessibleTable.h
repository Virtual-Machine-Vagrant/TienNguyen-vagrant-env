...
#define NS_DECL_NON_VIRTUAL_NSIACCESSIBLETABLE \
  NS_METHOD GetCaption(nsIAccessible * *aCaption); \
  NS_METHOD GetSummary(nsAString & aSummary); \
  NS_METHOD GetColumnCount(int32_t *aColumnCount); \
  NS_METHOD GetRowCount(int32_t *aRowCount); \
  NS_METHOD GetCellAt(int32_t rowIndex, int32_t columnIndex, nsIAccessible * *_retval); \
  NS_METHOD GetCellIndexAt(int32_t rowIndex, int32_t columnIndex, int32_t *_retval); \
  NS_METHOD GetColumnIndexAt(int32_t cellIndex, int32_t *_retval); \
  NS_METHOD GetRowIndexAt(int32_t cellIndex, int32_t *_retval); \
  NS_METHOD GetRowAndColumnIndicesAt(int32_t cellIndex, int32_t *rowIndex, int32_t *columnIndex); \
  NS_METHOD GetColumnExtentAt(int32_t row, int32_t column, int32_t *_retval); \
  NS_METHOD GetRowExtentAt(int32_t row, int32_t column, int32_t *_retval); \
  NS_METHOD GetColumnDescription(int32_t columnIndex, nsAString & _retval); \
  NS_METHOD GetRowDescription(int32_t rowIndex, nsAString & _retval); \
  NS_METHOD IsColumnSelected(int32_t columnIndex, bool *_retval); \
  NS_METHOD IsRowSelected(int32_t rowIndex, bool *_retval); \
  NS_METHOD IsCellSelected(int32_t rowIndex, int32_t columnIndex, bool *_retval); \
  NS_METHOD GetSelectedCellCount(uint32_t *aSelectedCellCount); \
  NS_METHOD GetSelectedColumnCount(uint32_t *aSelectedColumnCount); \
  NS_METHOD GetSelectedRowCount(uint32_t *aSelectedRowCount); \
  NS_METHOD GetSelectedCells(nsIArray * *aSelectedCells); \
  NS_METHOD GetSelectedCellIndices(uint32_t *cellsArraySize, int32_t **cellsArray); \
  NS_METHOD GetSelectedColumnIndices(uint32_t *columnsArraySize, int32_t **columnsArray); \
  NS_METHOD GetSelectedRowIndices(uint32_t *rowsArraySize, int32_t **rowsArray); \
  NS_METHOD SelectRow(int32_t rowIndex); \
  NS_METHOD SelectColumn(int32_t columnIndex); \
  NS_METHOD UnselectRow(int32_t rowIndex); \
  NS_METHOD UnselectColumn(int32_t columnIndex); \
  NS_METHOD IsProbablyForLayout(bool *_retval); 
...
#define NS_DECL_NON_VIRTUAL_NSIACCESSIBLETABLECELL \
  NS_METHOD GetTable(nsIAccessibleTable * *aTable); \
  NS_METHOD GetColumnIndex(int32_t *aColumnIndex); \
  NS_METHOD GetRowIndex(int32_t *aRowIndex); \
  NS_METHOD GetColumnExtent(int32_t *aColumnExtent); \
  NS_METHOD GetRowExtent(int32_t *aRowExtent); \
  NS_METHOD GetColumnHeaderCells(nsIArray * *aColumnHeaderCells); \
  NS_METHOD GetRowHeaderCells(nsIArray * *aRowHeaderCells); \
  NS_METHOD IsSelected(bool *_retval); 
