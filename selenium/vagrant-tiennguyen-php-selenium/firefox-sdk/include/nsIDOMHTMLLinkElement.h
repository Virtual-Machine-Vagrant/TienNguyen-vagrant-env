...
#define NS_DECL_NON_VIRTUAL_NSIDOMHTMLLINKELEMENT \
  NS_METHOD GetMozDisabled(bool *aDisabled); \
  NS_METHOD SetMozDisabled(bool aDisabled); \
  NS_METHOD GetCharset(nsAString & aCharset); \
  NS_METHOD SetCharset(const nsAString & aCharset); \
  NS_METHOD GetHref(nsAString & aHref); \
  NS_METHOD SetHref(const nsAString & aHref); \
  NS_METHOD GetHreflang(nsAString & aHreflang); \
  NS_METHOD SetHreflang(const nsAString & aHreflang); \
  NS_METHOD GetMedia(nsAString & aMedia); \
  NS_METHOD SetMedia(const nsAString & aMedia); \
  NS_METHOD GetRel(nsAString & aRel); \
  NS_METHOD SetRel(const nsAString & aRel); \
  NS_METHOD GetRev(nsAString & aRev); \
  NS_METHOD SetRev(const nsAString & aRev); \
