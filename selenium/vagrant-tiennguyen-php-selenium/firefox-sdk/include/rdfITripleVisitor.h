...
#define NS_DECL_RDFITRIPLEVISITOR \
  NS_IMETHOD Visit(nsIRDFNode *aSubject, nsIRDFResource *aPredicate, nsIRDFNode *aObject, bool aTruthValue) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_RDFITRIPLEVISITOR \
  NS_METHOD Visit(nsIRDFNode *aSubject, nsIRDFResource *aPredicate, nsIRDFNode *aObject, bool aTruthValue); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_RDFITRIPLEVISITOR(_to) \
  NS_IMETHOD Visit(nsIRDFNode *aSubject, nsIRDFResource *aPredicate, nsIRDFNode *aObject, bool aTruthValue) override { return _to Visit(aSubject, aPredicate, aObject, aTruthValue); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_RDFITRIPLEVISITOR(_to) \
  NS_IMETHOD Visit(nsIRDFNode *aSubject, nsIRDFResource *aPredicate, nsIRDFNode *aObject, bool aTruthValue) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Visit(aSubject, aPredicate, aObject, aTruthValue); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(_MYCLASS_, rdfITripleVisitor)
