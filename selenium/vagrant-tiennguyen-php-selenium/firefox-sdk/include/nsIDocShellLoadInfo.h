...
#define NS_DECL_NON_VIRTUAL_NSIDOCSHELLLOADINFO \
  ...
  NS_METHOD GetInheritOwner(bool *aInheritOwner); \
  NS_METHOD SetInheritOwner(bool aInheritOwner); \
  NS_METHOD GetOwnerIsExplicit(bool *aOwnerIsExplicit); \
  NS_METHOD SetOwnerIsExplicit(bool aOwnerIsExplicit); \
