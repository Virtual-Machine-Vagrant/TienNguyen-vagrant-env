...
#define NS_DECL_NON_VIRTUAL_NSITREECONTENTVIEW \
  NS_METHOD GetItemAtIndex(int32_t index, nsIDOMElement * *_retval); \
  NS_METHOD GetIndexOfItem(nsIDOMElement *item, int32_t *_retval); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsTreeContentView, nsITreeContentView)
