...
#define NS_DECL_NON_VIRTUAL_NSIDELETEDMESSAGEINFO \
  NS_METHOD GetDeletedMessageIds(nsIVariant * *aDeletedMessageIds); \
  NS_METHOD GetDeletedThreadIds(nsIVariant * *aDeletedThreadIds); 
