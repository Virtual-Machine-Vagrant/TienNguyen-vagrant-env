...
class NS_NO_VTABLE nsIFontEnumerator : public nsISupports {
 public:
  ...
  NS_IMETHOD EnumerateAllFonts(uint32_t *aCount, char16_t * **aResult) = 0;
  ...
  NS_IMETHOD EnumerateFonts(const char * aLangGroup, const char * aGeneric, uint32_t *aCount, char16_t * **aResult) = 0;
  ...
  NS_IMETHOD GetDefaultFont(const char * aLangGroup, const char * aGeneric, char16_t * *_retval) = 0;

  /* boolean updateFontList (); */
  NS_IMETHOD UpdateFontList(bool *_retval) = 0;

  /* wstring getStandardFamilyName (in wstring aName); */
  NS_IMETHOD GetStandardFamilyName(const char16_t * aName, char16_t * *_retval) = 0;
...
#define NS_DECL_NSIFONTENUMERATOR \
  NS_IMETHOD EnumerateAllFonts(uint32_t *aCount, char16_t * **aResult) override; \
  NS_IMETHOD EnumerateFonts(const char * aLangGroup, const char * aGeneric, uint32_t *aCount, char16_t * **aResult) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIFONTENUMERATOR \
  NS_METHOD EnumerateAllFonts(uint32_t *aCount, char16_t * **aResult); \
  NS_METHOD EnumerateFonts(const char * aLangGroup, const char * aGeneric, uint32_t *aCount, char16_t * **aResult); \
  NS_METHOD HaveFontFor(const char * aLangGroup, bool *aResult); \
  NS_METHOD GetDefaultFont(const char * aLangGroup, const char * aGeneric, char16_t * *_retval); \
  NS_METHOD UpdateFontList(bool *_retval); \
  NS_METHOD GetStandardFamilyName(const char16_t * aName, char16_t * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIFONTENUMERATOR(_to) \
  NS_IMETHOD EnumerateAllFonts(uint32_t *aCount, char16_t * **aResult) override { return _to EnumerateAllFonts(aCount, aResult); } \
  NS_IMETHOD EnumerateFonts(const char * aLangGroup, const char * aGeneric, uint32_t *aCount, char16_t * **aResult) override { return _to EnumerateFonts(aLangGroup, aGeneric, aCount, aResult); } \
...
#define NS_FORWARD_SAFE_NSIFONTENUMERATOR(_to) \
  NS_IMETHOD EnumerateAllFonts(uint32_t *aCount, char16_t * **aResult) override { return !_to ? NS_ERROR_NULL_POINTER : _to->EnumerateAllFonts(aCount, aResult); } \
  NS_IMETHOD EnumerateFonts(const char * aLangGroup, const char * aGeneric, uint32_t *aCount, char16_t * **aResult) override { return !_to ? NS_ERROR_NULL_POINTER : _to->EnumerateFonts(aLangGroup, aGeneric, aCount, aResult); } \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsFontEnumerator, nsIFontEnumerator)
...
/* void EnumerateAllFonts (out uint32_t aCount, [array, size_is (aCount), retval] out wstring aResult); */
NS_IMETHODIMP nsFontEnumerator::EnumerateAllFonts(uint32_t *aCount, char16_t * **aResult)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void EnumerateFonts (in string aLangGroup, in string aGeneric, out uint32_t aCount, [array, size_is (aCount), retval] out wstring aResult); */
NS_IMETHODIMP nsFontEnumerator::EnumerateFonts(const char * aLangGroup, const char * aGeneric, uint32_t *aCount, char16_t * **aResult)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* wstring getDefaultFont (in string aLangGroup, in string aGeneric); */
NS_IMETHODIMP nsFontEnumerator::GetDefaultFont(const char * aLangGroup, const char * aGeneric, char16_t * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* wstring getStandardFamilyName (in wstring aName); */
NS_IMETHODIMP nsFontEnumerator::GetStandardFamilyName(const char16_t * aName, char16_t * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
