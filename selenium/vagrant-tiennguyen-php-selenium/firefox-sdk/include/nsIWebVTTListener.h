...
#define NS_DECL_NON_VIRTUAL_NSIWEBVTTLISTENER \
  NS_METHOD OnCue(JS::HandleValue cue, JSContext* cx); \
  NS_METHOD OnRegion(JS::HandleValue region, JSContext* cx); \
  NS_METHOD OnParsingError(int32_t errorCode, JSContext* cx); 
