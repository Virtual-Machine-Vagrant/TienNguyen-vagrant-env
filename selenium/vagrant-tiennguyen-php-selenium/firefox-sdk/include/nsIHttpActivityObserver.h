...
#define NS_DECL_NSIHTTPACTIVITYOBSERVER \
  NS_IMETHOD ObserveActivity(nsISupports *aHttpChannel, uint32_t aActivityType, uint32_t aActivitySubtype, PRTime aTimestamp, uint64_t aExtraSizeData, const nsACString & aExtraStringData) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIHTTPACTIVITYOBSERVER \
  NS_METHOD ObserveActivity(nsISupports *aHttpChannel, uint32_t aActivityType, uint32_t aActivitySubtype, PRTime aTimestamp, uint64_t aExtraSizeData, const nsACString & aExtraStringData); \
  NS_METHOD GetIsActive(bool *aIsActive); \

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIHTTPACTIVITYOBSERVER(_to) \
  NS_IMETHOD ObserveActivity(nsISupports *aHttpChannel, uint32_t aActivityType, uint32_t aActivitySubtype, PRTime aTimestamp, uint64_t aExtraSizeData, const nsACString & aExtraStringData) override { return _to ObserveActivity(aHttpChannel, aActivityType, aActivitySubtype, aTimestamp, aExtraSizeData, aExtraStringData); } \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsHttpActivityObserver, nsIHttpActivityObserver)
...
#define NS_DECL_NON_VIRTUAL_NSIHTTPACTIVITYDISTRIBUTOR \
  NS_METHOD AddObserver(nsIHttpActivityObserver *aObserver); \
  NS_METHOD RemoveObserver(nsIHttpActivityObserver *aObserver); 
