...
#define NS_DECL_NON_VIRTUAL_NSIDOMXULCONTAINERITEMELEMENT \
  NS_METHOD GetParentContainer(nsIDOMXULContainerElement * *aParentContainer); 
...
#define NS_DECL_NON_VIRTUAL_NSIDOMXULCONTAINERELEMENT \
  NS_METHOD AppendItem(const nsAString & aLabel, const nsAString & aValue, nsIDOMXULElement * *_retval); \
  NS_METHOD InsertItemAt(int32_t aIndex, const nsAString & aLabel, const nsAString & aValue, nsIDOMXULElement * *_retval); \
  NS_METHOD RemoveItemAt(int32_t aIndex, nsIDOMXULElement * *_retval); \
  NS_METHOD GetItemCount(uint32_t *aItemCount); \
  NS_METHOD GetIndexOfItem(nsIDOMXULElement *aItem, int32_t *_retval); \
  NS_METHOD GetItemAtIndex(int32_t aIndex, nsIDOMXULElement * *_retval); 
