...
#define NS_DECL_NON_VIRTUAL_NSIEXTENDEDEXPATSINK \
  NS_METHOD HandleStartDTD(const char16_t * aDoctypeName, const char16_t * aSysid, const char16_t * aPubid); \
  NS_METHOD HandleStartNamespaceDecl(const char16_t * aPrefix, const char16_t * aUri); \
  NS_METHOD HandleEndNamespaceDecl(const char16_t * aPrefix); \
  NS_METHOD HandleNotationDecl(const char16_t * aNotationName, const char16_t * aSysid, const char16_t * aPubid); \
  NS_METHOD HandleUnparsedEntityDecl(const char16_t * aName, const char16_t * aSysid, const char16_t * aPubid, const char16_t * aNotationName); 
