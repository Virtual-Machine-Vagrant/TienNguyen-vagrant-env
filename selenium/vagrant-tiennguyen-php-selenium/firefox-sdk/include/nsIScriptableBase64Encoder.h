...
#define NS_DECL_NON_VIRTUAL_NSISCRIPTABLEBASE64ENCODER \
  NS_METHOD EncodeToCString(nsIInputStream *stream, uint32_t length, nsACString & _retval); \
  NS_METHOD EncodeToString(nsIInputStream *stream, uint32_t length, nsAString & _retval); 
