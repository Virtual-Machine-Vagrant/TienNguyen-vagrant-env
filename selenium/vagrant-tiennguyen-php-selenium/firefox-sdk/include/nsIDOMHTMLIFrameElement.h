...
#define NS_DECL_NON_VIRTUAL_NSIDOMHTMLIFRAMEELEMENT \
  ...
  NS_METHOD GetSrcdoc(nsAString & aSrcdoc); \
  NS_METHOD SetSrcdoc(const nsAString & aSrcdoc); \
  ...
  NS_METHOD GetAllowFullscreen(bool *aAllowFullscreen); \
  NS_METHOD SetAllowFullscreen(bool aAllowFullscreen); 
