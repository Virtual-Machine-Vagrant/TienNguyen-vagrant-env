...
class NS_NO_VTABLE nsIDocShell : public nsIDocShellTreeItem {
 public:
  ...
  NS_IMETHOD SetIsActiveAndForeground(bool aIsActive) = 0;
  ...
  NS_IMETHOD SetIsInIsolatedMozBrowserElement(bool aIsInIsolatedMozBrowserElement) = 0;
  ...
  /* [noscript,nostdcall,notxpcom] void notifyJSRunToCompletionStart (in string aReason, in wstring functionName, in wstring fileName, in unsigned long lineNumber, in jsval asyncStack, in jsval asyncCause); */
  virtual void NotifyJSRunToCompletionStart(const char * aReason, const char16_t * functionName, const char16_t * fileName, uint32_t lineNumber, JS::HandleValue asyncStack, JS::HandleValue asyncCause) = 0;
...
#define NS_DECL_NSIDOCSHELL \
  ...
  NS_IMETHOD SetIsActiveAndForeground(bool aIsActive) override; \
  ...
  NS_IMETHOD SetIsInIsolatedMozBrowserElement(bool aIsInIsolatedMozBrowserElement) override; \
  ...
  virtual void NotifyJSRunToCompletionStart(const char * aReason, const char16_t * functionName, const char16_t * fileName, uint32_t lineNumber, JS::HandleValue asyncStack, JS::HandleValue asyncCause) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIDOCSHELL \
  ...
  NS_METHOD InternalLoad(nsIURI *aURI, nsIURI *aOriginalURI, bool aLoadReplace, nsIURI *aReferrer, uint32_t aReferrerPolicy, nsISupports *aOwner, uint32_t aFlags, const char16_t * aWindowTarget, const char * aTypeHint, const nsAString & aFileName, nsIInputStream *aPostDataStream, nsIInputStream *aHeadersStream, uint32_t aLoadFlags, nsISHEntry *aSHEntry, bool firstParty, const nsAString & aSrcdoc, nsIDocShell *aSourceDocShell, nsIURI *aBaseURI, nsIDocShell * *aDocShell, nsIRequest * *aRequest); \
  ...
  NS_METHOD SetIsActiveAndForeground(bool aIsActive); \
  NS_METHOD SetIsPrerendered(bool prerendered); \
  using nsIDocShell::GetIsPrerendered; \
  ...
  NS_METHOD SetIsInIsolatedMozBrowserElement(bool aIsInIsolatedMozBrowserElement); \
  using nsIDocShell::GetIsInMozBrowserOrApp; \
  ...
  void NotifyJSRunToCompletionStart(const char * aReason, const char16_t * functionName, const char16_t * fileName, uint32_t lineNumber, JS::HandleValue asyncStack, JS::HandleValue asyncCause); \
  void NotifyJSRunToCompletionStop(void); \
  using nsIDocShell::GetHasLoadedNonBlankURI; \
  NS_METHOD GetHasLoadedNonBlankURI(bool *aHasLoadedNonBlankURI); \
  NS_METHOD GetPaymentRequestId(nsAString & aPaymentRequestId); \
  NS_METHOD SetPaymentRequestId(const nsAString & aPaymentRequestId); \
...
#define NS_FORWARD_NSIDOCSHELL(_to) \
  ...
  NS_IMETHOD SetIsActiveAndForeground(bool aIsActive) override { return _to SetIsActiveAndForeground(aIsActive); } \
  ...
  NS_IMETHOD SetIsInIsolatedMozBrowserElement(bool aIsInIsolatedMozBrowserElement) override { return _to SetIsInIsolatedMozBrowserElement(aIsInIsolatedMozBrowserElement); } \
  using nsIDocShell::GetIsInMozBrowserOrApp; \
  ...
  virtual void NotifyJSRunToCompletionStart(const char * aReason, const char16_t * functionName, const char16_t * fileName, uint32_t lineNumber, JS::HandleValue asyncStack, JS::HandleValue asyncCause) override { return _to NotifyJSRunToCompletionStart(aReason, functionName, fileName, lineNumber, asyncStack, asyncCause); } \
...
#define NS_FORWARD_SAFE_NSIDOCSHELL(_to) \
  ...
  NS_IMETHOD SetIsActiveAndForeground(bool aIsActive) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetIsActiveAndForeground(aIsActive); } \
  ...
  NS_IMETHOD SetIsInIsolatedMozBrowserElement(bool aIsInIsolatedMozBrowserElement) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetIsInIsolatedMozBrowserElement(aIsInIsolatedMozBrowserElement); } \
...
/* [noscript] void internalLoad (in nsIURI aURI, in nsIURI aOriginalURI, in boolean aLoadReplace, in nsIURI aReferrer, in unsigned long aReferrerPolicy, in nsISupports aOwner, in uint32_t aFlags, in wstring aWindowTarget, in string aTypeHint, in AString aFileName, in nsIInputStream aPostDataStream, in nsIInputStream aHeadersStream, in unsigned long aLoadFlags, in nsISHEntry aSHEntry, in boolean firstParty, in AString aSrcdoc, in nsIDocShell aSourceDocShell, in nsIURI aBaseURI, out nsIDocShell aDocShell, out nsIRequest aRequest); */
NS_IMETHODIMP nsDocShell::InternalLoad(nsIURI *aURI, nsIURI *aOriginalURI, bool aLoadReplace, nsIURI *aReferrer, uint32_t aReferrerPolicy, nsISupports *aOwner, uint32_t aFlags, const char16_t * aWindowTarget, const char * aTypeHint, const nsAString & aFileName, nsIInputStream *aPostDataStream, nsIInputStream *aHeadersStream, uint32_t aLoadFlags, nsISHEntry *aSHEntry, bool firstParty, const nsAString & aSrcdoc, nsIDocShell *aSourceDocShell, nsIURI *aBaseURI, nsIDocShell * *aDocShell, nsIRequest * *aRequest)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void setIsActiveAndForeground (in boolean aIsActive); */
NS_IMETHODIMP nsDocShell::SetIsActiveAndForeground(bool aIsActive)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
NS_IMETHODIMP nsDocShell::SetIsInIsolatedMozBrowserElement(bool aIsInIsolatedMozBrowserElement)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [noscript,nostdcall,notxpcom] void notifyJSRunToCompletionStart (in string aReason, in wstring functionName, in wstring fileName, in unsigned long lineNumber, in jsval asyncStack, in jsval asyncCause); */
void nsDocShell::NotifyJSRunToCompletionStart(const char * aReason, const char16_t * functionName, const char16_t * fileName, uint32_t lineNumber, JS::HandleValue asyncStack, JS::HandleValue asyncCause)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
