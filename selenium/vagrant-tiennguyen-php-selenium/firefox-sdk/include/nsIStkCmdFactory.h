...
#define NS_DECL_NON_VIRTUAL_NSISTKCMDFACTORY \
  NS_METHOD CreateCommand(JS::HandleValue aCommandDetails, nsIStkProactiveCmd * *_retval); \
  NS_METHOD CreateCommandMessage(nsIStkProactiveCmd *aStkProactiveCmd, JS::MutableHandleValue _retval); \
  NS_METHOD DeflateCommand(nsIStkProactiveCmd *aStkProactiveCmd, nsAString & _retval); \
  NS_METHOD InflateCommand(const nsAString & aJSON, nsIStkProactiveCmd * *_retval); \
  NS_METHOD CreateResponse(JS::HandleValue aResponseMessage, nsIStkTerminalResponse * *_retval); \
  NS_METHOD CreateResponseMessage(nsIStkTerminalResponse *aStkTerminalResponse, JS::MutableHandleValue _retval); \
  NS_METHOD DeflateResponse(nsIStkTerminalResponse *aStkTerminalResponse, nsAString & _retval); \
  NS_METHOD InflateResponse(const nsAString & aJSON, nsIStkTerminalResponse * *_retval); \
  NS_METHOD CreateEvent(JS::HandleValue aEventMessage, nsIStkDownloadEvent * *_retval); \
  NS_METHOD CreateEventMessage(nsIStkDownloadEvent *aStkDownloadEvent, JS::MutableHandleValue _retval); \
  NS_METHOD DeflateDownloadEvent(nsIStkDownloadEvent *aStkDownloadEvent, nsAString & _retval); \
  NS_METHOD InflateDownloadEvent(const nsAString & aJSON, nsIStkDownloadEvent * *_retval); \
  NS_METHOD CreateTimer(JS::HandleValue aStkTimerMessage, nsIStkTimer * *_retval); 
