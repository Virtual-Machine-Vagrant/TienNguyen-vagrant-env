...
#define NS_DECL_NSIFORMATCONVERTER \
  NS_IMETHOD GetInputDataFlavors(nsISupportsArray * *_retval) override; \
  NS_IMETHOD GetOutputDataFlavors(nsISupportsArray * *_retval) override; \
  NS_IMETHOD CanConvert(const char * aFromDataFlavor, const char * aToDataFlavor, bool *_retval) override; \
  NS_IMETHOD Convert(const char * aFromDataFlavor, nsISupports *aFromData, uint32_t aDataLen, const char * aToDataFlavor, nsISupports * *aToData, uint32_t *aDataToLen) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIFORMATCONVERTER \
  NS_METHOD GetInputDataFlavors(nsISupportsArray * *_retval); \
  NS_METHOD GetOutputDataFlavors(nsISupportsArray * *_retval); \
  NS_METHOD CanConvert(const char * aFromDataFlavor, const char * aToDataFlavor, bool *_retval); \
  NS_METHOD Convert(const char * aFromDataFlavor, nsISupports *aFromData, uint32_t aDataLen, const char * aToDataFlavor, nsISupports * *aToData, uint32_t *aDataToLen); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIFORMATCONVERTER(_to) \
  NS_IMETHOD GetInputDataFlavors(nsISupportsArray * *_retval) override { return _to GetInputDataFlavors(_retval); } \
  NS_IMETHOD GetOutputDataFlavors(nsISupportsArray * *_retval) override { return _to GetOutputDataFlavors(_retval); } \
  ...
  NS_IMETHOD Convert(const char * aFromDataFlavor, nsISupports *aFromData, uint32_t aDataLen, const char * aToDataFlavor, nsISupports * *aToData, uint32_t *aDataToLen) override { return _to Convert(aFromDataFlavor, aFromData, aDataLen, aToDataFlavor, aToData, aDataToLen); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIFORMATCONVERTER(_to) \
  NS_IMETHOD GetInputDataFlavors(nsISupportsArray * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInputDataFlavors(_retval); } \
  NS_IMETHOD GetOutputDataFlavors(nsISupportsArray * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOutputDataFlavors(_retval); } \
  ...
  NS_IMETHOD Convert(const char * aFromDataFlavor, nsISupports *aFromData, uint32_t aDataLen, const char * aToDataFlavor, nsISupports * *aToData, uint32_t *aDataToLen) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Convert(aFromDataFlavor, aFromData, aDataLen, aToDataFlavor, aToData, aDataToLen); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsFormatConverter, nsIFormatConverter)
