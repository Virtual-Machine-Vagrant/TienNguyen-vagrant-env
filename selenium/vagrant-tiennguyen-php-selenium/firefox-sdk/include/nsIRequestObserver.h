...
#define NS_DECL_NON_VIRTUAL_NSIREQUESTOBSERVER \
  NS_METHOD OnStartRequest(nsIRequest *aRequest, nsISupports *aContext); \
  NS_METHOD OnStopRequest(nsIRequest *aRequest, nsISupports *aContext, nsresult aStatusCode); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsRequestObserver, nsIRequestObserver)
