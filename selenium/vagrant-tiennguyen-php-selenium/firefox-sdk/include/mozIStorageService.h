...
#define NS_DECL_MOZISTORAGESERVICE \
  ...
  NS_IMETHOD OpenSpecialDatabase(const char * aStorageKey, mozIStorageConnection * *_retval) override; \
  ...
  NS_IMETHOD OpenDatabaseWithFileURL(nsIFileURL *aFileURL, mozIStorageConnection * *_retval) override; \
...
#define NS_DECL_NON_VIRTUAL_MOZISTORAGESERVICE \
  NS_METHOD OpenAsyncDatabase(nsIVariant *aDatabaseStore, nsIPropertyBag2 *aOptions, mozIStorageCompletionCallback *aCallback); \
  NS_METHOD OpenSpecialDatabase(const char * aStorageKey, mozIStorageConnection * *_retval); \
  NS_METHOD OpenDatabase(nsIFile *aDatabaseFile, mozIStorageConnection * *_retval); \
  NS_METHOD OpenUnsharedDatabase(nsIFile *aDatabaseFile, mozIStorageConnection * *_retval); \
  NS_METHOD OpenDatabaseWithFileURL(nsIFileURL *aFileURL, mozIStorageConnection * *_retval); \
  NS_METHOD BackupDatabaseFile(nsIFile *aDBFile, const nsAString & aBackupFileName, nsIFile *aBackupParentDirectory, nsIFile * *_retval); 
...
#define NS_FORWARD_MOZISTORAGESERVICE(_to) \
  ...
  NS_IMETHOD OpenSpecialDatabase(const char * aStorageKey, mozIStorageConnection * *_retval) override { return _to OpenSpecialDatabase(aStorageKey, _retval); } \
  ...
  NS_IMETHOD OpenDatabaseWithFileURL(nsIFileURL *aFileURL, mozIStorageConnection * *_retval) override { return _to OpenDatabaseWithFileURL(aFileURL, _retval); } \
...
#define NS_FORWARD_SAFE_MOZISTORAGESERVICE(_to) \
  ...
  NS_IMETHOD OpenSpecialDatabase(const char * aStorageKey, mozIStorageConnection * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OpenSpecialDatabase(aStorageKey, _retval); } \
  ...
  NS_IMETHOD OpenDatabaseWithFileURL(nsIFileURL *aFileURL, mozIStorageConnection * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OpenDatabaseWithFileURL(aFileURL, _retval); } \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(_MYCLASS_, mozIStorageService)
