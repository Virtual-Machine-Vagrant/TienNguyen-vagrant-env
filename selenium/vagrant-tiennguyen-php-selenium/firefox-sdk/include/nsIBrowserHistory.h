...
#define NS_DECL_NSIBROWSERHISTORY \
  ...
  NS_IMETHOD RemoveVisitsByTimeframe(PRTime aBeginTime, PRTime aEndTime) override; \
  NS_IMETHOD RemoveAllPages(void) override; 
...
#define NS_DECL_NON_VIRTUAL_NSIBROWSERHISTORY \
  ...
  NS_METHOD RemoveVisitsByTimeframe(PRTime aBeginTime, PRTime aEndTime); \
  NS_METHOD RemoveAllPages(void); 
...
#define NS_FORWARD_NSIBROWSERHISTORY(_to) \
  ...
  NS_IMETHOD RemoveVisitsByTimeframe(PRTime aBeginTime, PRTime aEndTime) override { return _to RemoveVisitsByTimeframe(aBeginTime, aEndTime); } \
  NS_IMETHOD RemoveAllPages(void) override { return _to RemoveAllPages(); } 
...
#define NS_FORWARD_SAFE_NSIBROWSERHISTORY(_to) \
  ...
  NS_IMETHOD RemoveVisitsByTimeframe(PRTime aBeginTime, PRTime aEndTime) override { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveVisitsByTimeframe(aBeginTime, aEndTime); } \
  NS_IMETHOD RemoveAllPages(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveAllPages(); } 
