...
#define NS_DECL_NSINETWORKPROPERTIES \
  NS_IMETHOD GetIsWifi(bool *aIsWifi) override; \
  NS_IMETHOD GetDhcpGateway(uint32_t *aDhcpGateway) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSINETWORKPROPERTIES \
  NS_METHOD GetIsWifi(bool *aIsWifi); \
  NS_METHOD GetDhcpGateway(uint32_t *aDhcpGateway); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSINETWORKPROPERTIES(_to) \
  NS_IMETHOD GetIsWifi(bool *aIsWifi) override { return _to GetIsWifi(aIsWifi); } \
  NS_IMETHOD GetDhcpGateway(uint32_t *aDhcpGateway) override { return _to GetDhcpGateway(aDhcpGateway); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSINETWORKPROPERTIES(_to) \
  NS_IMETHOD GetIsWifi(bool *aIsWifi) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsWifi(aIsWifi); } \
  NS_IMETHOD GetDhcpGateway(uint32_t *aDhcpGateway) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDhcpGateway(aDhcpGateway); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsNetworkProperties, nsINetworkProperties)
