...
#define NS_DECL_NON_VIRTUAL_NSIPROMPT \
  NS_METHOD Alert(const char16_t * dialogTitle, const char16_t * text); \
  NS_METHOD AlertCheck(const char16_t * dialogTitle, const char16_t * text, const char16_t * checkMsg, bool *checkValue); \
  NS_METHOD Confirm(const char16_t * dialogTitle, const char16_t * text, bool *_retval); \
  NS_METHOD ConfirmCheck(const char16_t * dialogTitle, const char16_t * text, const char16_t * checkMsg, bool *checkValue, bool *_retval); \
  NS_METHOD ConfirmEx(const char16_t * dialogTitle, const char16_t * text, uint32_t buttonFlags, const char16_t * button0Title, const char16_t * button1Title, const char16_t * button2Title, const char16_t * checkMsg, bool *checkValue, int32_t *_retval); \
  NS_METHOD Prompt(const char16_t * dialogTitle, const char16_t * text, char16_t * *value, const char16_t * checkMsg, bool *checkValue, bool *_retval); \
  NS_METHOD PromptPassword(const char16_t * dialogTitle, const char16_t * text, char16_t * *password, const char16_t * checkMsg, bool *checkValue, bool *_retval); \
  NS_METHOD PromptUsernameAndPassword(const char16_t * dialogTitle, const char16_t * text, char16_t * *username, char16_t * *password, const char16_t * checkMsg, bool *checkValue, bool *_retval); \
  NS_METHOD Select(const char16_t * dialogTitle, const char16_t * text, uint32_t count, const char16_t * *selectList, int32_t *outSelection, bool *_retval); 
