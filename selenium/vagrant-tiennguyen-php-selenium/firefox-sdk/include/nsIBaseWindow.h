...
#define NS_DECL_NSIBASEWINDOW \
  ...
  NS_IMETHOD Create(void) override; \
  ...
  NS_IMETHOD SetPositionAndSize(int32_t x, int32_t y, int32_t cx, int32_t cy, bool fRepaint) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIBASEWINDOW \
  NS_METHOD InitWindow(nativeWindow parentNativeWindow, nsIWidget *parentWidget, int32_t x, int32_t y, int32_t cx, int32_t cy); \
  NS_METHOD Create(void); \
  NS_METHOD Destroy(void); \
  NS_METHOD SetPosition(int32_t x, int32_t y); \
  NS_METHOD SetPositionDesktopPix(int32_t x, int32_t y); \
  NS_METHOD GetPosition(int32_t *x, int32_t *y); \
  NS_METHOD SetSize(int32_t cx, int32_t cy, bool fRepaint); \
  NS_METHOD GetSize(int32_t *cx, int32_t *cy); \
  NS_METHOD SetPositionAndSize(int32_t x, int32_t y, int32_t cx, int32_t cy, bool fRepaint); \
  NS_METHOD GetPositionAndSize(int32_t *x, int32_t *y, int32_t *cx, int32_t *cy); \
  NS_METHOD Repaint(bool force); \
  NS_METHOD GetParentWidget(nsIWidget **aParentWidget); \
  NS_METHOD SetParentWidget(nsIWidget *aParentWidget); \
  NS_METHOD GetParentNativeWindow(nativeWindow *aParentNativeWindow); \
  NS_METHOD SetParentNativeWindow(nativeWindow aParentNativeWindow); \
  NS_METHOD GetNativeHandle(nsAString & aNativeHandle); \
  NS_METHOD GetVisibility(bool *aVisibility); \
  NS_METHOD SetVisibility(bool aVisibility); \
  NS_METHOD GetEnabled(bool *aEnabled); \
  NS_METHOD SetEnabled(bool aEnabled); \
  NS_METHOD GetMainWidget(nsIWidget **aMainWidget); \
  NS_METHOD GetUnscaledDevicePixelsPerCSSPixel(double *aUnscaledDevicePixelsPerCSSPixel); \
  NS_METHOD GetDevicePixelsPerDesktopPixel(double *aDevicePixelsPerDesktopPixel); \
...
#define NS_FORWARD_NSIBASEWINDOW(_to) \
  ...
  NS_IMETHOD Create(void) override { return _to Create(); } \
  ...
  NS_IMETHOD SetPositionAndSize(int32_t x, int32_t y, int32_t cx, int32_t cy, bool fRepaint) override { return _to SetPositionAndSize(x, y, cx, cy, fRepaint); } \
...
#define NS_FORWARD_SAFE_NSIBASEWINDOW(_to) \
  ...
  NS_IMETHOD Create(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Create(); } \
  ...
  NS_IMETHOD SetPositionAndSize(int32_t x, int32_t y, int32_t cx, int32_t cy, bool fRepaint) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPositionAndSize(x, y, cx, cy, fRepaint); } \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsBaseWindow, nsIBaseWindow)
...
/* void setPositionDesktopPix (in long x, in long y); */
NS_IMETHODIMP nsBaseWindow::SetPositionDesktopPix(int32_t x, int32_t y)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* readonly attribute double devicePixelsPerDesktopPixel; */
NS_IMETHODIMP nsBaseWindow::GetDevicePixelsPerDesktopPixel(double *aDevicePixelsPerDesktopPixel)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
