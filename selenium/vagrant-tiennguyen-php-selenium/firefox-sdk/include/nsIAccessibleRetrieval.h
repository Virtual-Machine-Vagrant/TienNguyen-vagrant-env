/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM ../../../dist/idl/nsIAccessibleRetrieval.idl
 */
...
/* nsISupports getStringStates (in unsigned long aStates, in unsigned long aExtraStates); */
NS_IMETHODIMP nsAccessibleRetrieval::GetStringStates(uint32_t aStates, uint32_t aExtraStates, nsISupports * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
