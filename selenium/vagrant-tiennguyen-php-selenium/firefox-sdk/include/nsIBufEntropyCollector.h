/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM ../../../dist/idl/nsIBufEntropyCollector.idl
 */
...
#define NS_DECL_NSIBUFENTROPYCOLLECTOR \
  NS_IMETHOD ForwardTo(nsIEntropyCollector *collector) override; \
  NS_IMETHOD DontForward(void) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIBUFENTROPYCOLLECTOR \
  NS_METHOD ForwardTo(nsIEntropyCollector *collector); \
  NS_METHOD DontForward(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIBUFENTROPYCOLLECTOR(_to) \
  NS_IMETHOD ForwardTo(nsIEntropyCollector *collector) override { return _to ForwardTo(collector); } \
  NS_IMETHOD DontForward(void) override { return _to DontForward(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIBUFENTROPYCOLLECTOR(_to) \
  NS_IMETHOD ForwardTo(nsIEntropyCollector *collector) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ForwardTo(collector); } \
  NS_IMETHOD DontForward(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->DontForward(); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsBufEntropyCollector, nsIBufEntropyCollector)
