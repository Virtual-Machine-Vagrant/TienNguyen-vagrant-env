...
#define NS_DECL_NON_VIRTUAL_NSIPROTOCOLPROXYFILTER \
  NS_METHOD ApplyFilter(nsIProtocolProxyService *aProxyService, nsIURI *aURI, nsIProxyInfo *aProxy, nsIProxyInfo * *_retval); 
...
#define NS_DECL_NON_VIRTUAL_NSIPROTOCOLPROXYCHANNELFILTER \
  NS_METHOD ApplyFilter(nsIProtocolProxyService *aProxyService, nsIChannel *aChannel, nsIProxyInfo *aProxy, nsIProxyInfo * *_retval); 
