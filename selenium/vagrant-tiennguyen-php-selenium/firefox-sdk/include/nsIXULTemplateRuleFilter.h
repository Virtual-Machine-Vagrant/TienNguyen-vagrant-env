...
#define NS_DECL_NSIXULTEMPLATERULEFILTER \
  NS_IMETHOD Match(nsIXULTemplateResult *aRef, nsIDOMNode *aRule, bool *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIXULTEMPLATERULEFILTER \
  NS_METHOD Match(nsIXULTemplateResult *aRef, nsIDOMNode *aRule, bool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXULTEMPLATERULEFILTER(_to) \
  NS_IMETHOD Match(nsIXULTemplateResult *aRef, nsIDOMNode *aRule, bool *_retval) override { return _to Match(aRef, aRule, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXULTEMPLATERULEFILTER(_to) \
  NS_IMETHOD Match(nsIXULTemplateResult *aRef, nsIDOMNode *aRule, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Match(aRef, aRule, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsXULTemplateRuleFilter, nsIXULTemplateRuleFilter)
