...
class NS_NO_VTABLE nsISecurityUITelemetry : public nsISupports {
 public:
  ...
  enum {
    ...
    WARNING_UNWANTED_PAGE_TOP = 92U,
    WARNING_UNWANTED_PAGE_TOP_WHY_BLOCKED = 93U,
    WARNING_UNWANTED_PAGE_TOP_GET_ME_OUT_OF_HERE = 94U,
    WARNING_UNWANTED_PAGE_TOP_IGNORE_WARNING = 95U,
    WARNING_UNWANTED_PAGE_FRAME = 96U,
    WARNING_UNWANTED_PAGE_FRAME_WHY_BLOCKED = 97U,
    WARNING_UNWANTED_PAGE_FRAME_GET_ME_OUT_OF_HERE = 98U,
    WARNING_UNWANTED_PAGE_FRAME_IGNORE_WARNING = 99U
  };
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsSecurityUITelemetry, nsISecurityUITelemetry)
