...
#define NS_DECL_NON_VIRTUAL_NSIFINALIZATIONWITNESSSERVICE \
  NS_METHOD Make(const char * aTopic, const char16_t * aString, JSContext* cx, JS::MutableHandleValue _retval); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsFinalizationWitnessService, nsIFinalizationWitnessService)
