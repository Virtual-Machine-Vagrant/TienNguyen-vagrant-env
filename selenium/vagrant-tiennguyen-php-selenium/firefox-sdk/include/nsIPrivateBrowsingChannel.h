...
#define NS_DECL_NON_VIRTUAL_NSIPRIVATEBROWSINGCHANNEL \
  NS_METHOD SetPrivate(bool aPrivate); \
  NS_METHOD GetIsChannelPrivate(bool *aIsChannelPrivate); \
  NS_METHOD IsPrivateModeOverriden(bool *aValue, bool *_retval); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsPrivateBrowsingChannel, nsIPrivateBrowsingChannel)
