...
#define NS_DECL_NON_VIRTUAL_NSIWEBPROGRESSLISTENER2 \
  NS_METHOD OnProgressChange64(nsIWebProgress *aWebProgress, nsIRequest *aRequest, int64_t aCurSelfProgress, int64_t aMaxSelfProgress, int64_t aCurTotalProgress, int64_t aMaxTotalProgress); \
  NS_METHOD OnRefreshAttempted(nsIWebProgress *aWebProgress, nsIURI *aRefreshURI, int32_t aMillis, bool aSameURI, bool *_retval); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsWebProgressListener2, nsIWebProgressListener2)
