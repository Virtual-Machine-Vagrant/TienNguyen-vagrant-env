...
#define NS_DECL_NSIDOMCLIENTRECTLIST \
  ...
  NS_IMETHOD Item(uint32_t index, nsIDOMClientRect * *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMCLIENTRECTLIST \
  NS_METHOD GetLength(uint32_t *aLength); \
  NS_METHOD Item(uint32_t index, nsIDOMClientRect * *_retval); 
...
#define NS_FORWARD_NSIDOMCLIENTRECTLIST(_to) \
  ...
  NS_IMETHOD Item(uint32_t index, nsIDOMClientRect * *_retval) override { return _to Item(index, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMCLIENTRECTLIST(_to) \
  ...
  NS_IMETHOD Item(uint32_t index, nsIDOMClientRect * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Item(index, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMClientRectList, nsIDOMClientRectList)
