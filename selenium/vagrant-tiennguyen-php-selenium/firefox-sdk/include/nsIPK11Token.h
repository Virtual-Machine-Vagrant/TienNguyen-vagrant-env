...
#define NS_DECL_NSIPK11TOKEN \
  NS_IMETHOD GetTokenName(char16_t * *aTokenName) override; \
  NS_IMETHOD GetTokenLabel(char16_t * *aTokenLabel) override; \
  NS_IMETHOD GetTokenManID(char16_t * *aTokenManID) override; \
  NS_IMETHOD GetTokenHWVersion(char16_t * *aTokenHWVersion) override; \
  NS_IMETHOD GetTokenFWVersion(char16_t * *aTokenFWVersion) override; \
  NS_IMETHOD GetTokenSerialNumber(char16_t * *aTokenSerialNumber) override; \
  ...
  NS_IMETHOD CheckPassword(const char16_t * password, bool *_retval) override; \
  NS_IMETHOD InitPassword(const char16_t * initialPassword) override; \
  NS_IMETHOD ChangePassword(const char16_t * oldPassword, const char16_t * newPassword) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIPK11TOKEN \
  NS_METHOD GetTokenName(char16_t * *aTokenName); \
  NS_METHOD GetTokenLabel(char16_t * *aTokenLabel); \
  NS_METHOD GetTokenManID(char16_t * *aTokenManID); \
  NS_METHOD GetTokenHWVersion(char16_t * *aTokenHWVersion); \
  NS_METHOD GetTokenFWVersion(char16_t * *aTokenFWVersion); \
  NS_METHOD GetTokenSerialNumber(char16_t * *aTokenSerialNumber); \
  ...
  NS_METHOD CheckPassword(const char16_t * password, bool *_retval); \
  NS_METHOD InitPassword(const char16_t * initialPassword); \
  NS_METHOD ChangePassword(const char16_t * oldPassword, const char16_t * newPassword); \
...
#define NS_FORWARD_NSIPK11TOKEN(_to) \
  NS_IMETHOD GetTokenName(char16_t * *aTokenName) override { return _to GetTokenName(aTokenName); } \
  NS_IMETHOD GetTokenLabel(char16_t * *aTokenLabel) override { return _to GetTokenLabel(aTokenLabel); } \
  NS_IMETHOD GetTokenManID(char16_t * *aTokenManID) override { return _to GetTokenManID(aTokenManID); } \
  NS_IMETHOD GetTokenHWVersion(char16_t * *aTokenHWVersion) override { return _to GetTokenHWVersion(aTokenHWVersion); } \
  NS_IMETHOD GetTokenFWVersion(char16_t * *aTokenFWVersion) override { return _to GetTokenFWVersion(aTokenFWVersion); } \
  NS_IMETHOD GetTokenSerialNumber(char16_t * *aTokenSerialNumber) override { return _to GetTokenSerialNumber(aTokenSerialNumber); } \
  ...
  NS_IMETHOD CheckPassword(const char16_t * password, bool *_retval) override { return _to CheckPassword(password, _retval); } \
  NS_IMETHOD InitPassword(const char16_t * initialPassword) override { return _to InitPassword(initialPassword); } \
  NS_IMETHOD ChangePassword(const char16_t * oldPassword, const char16_t * newPassword) override { return _to ChangePassword(oldPassword, newPassword); } \
...
#define NS_FORWARD_SAFE_NSIPK11TOKEN(_to) \
  NS_IMETHOD GetTokenName(char16_t * *aTokenName) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTokenName(aTokenName); } \
  NS_IMETHOD GetTokenLabel(char16_t * *aTokenLabel) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTokenLabel(aTokenLabel); } \
  NS_IMETHOD GetTokenManID(char16_t * *aTokenManID) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTokenManID(aTokenManID); } \
  NS_IMETHOD GetTokenHWVersion(char16_t * *aTokenHWVersion) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTokenHWVersion(aTokenHWVersion); } \
  NS_IMETHOD GetTokenFWVersion(char16_t * *aTokenFWVersion) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTokenFWVersion(aTokenFWVersion); } \
  NS_IMETHOD GetTokenSerialNumber(char16_t * *aTokenSerialNumber) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTokenSerialNumber(aTokenSerialNumber); } \
  ...
  NS_IMETHOD CheckPassword(const char16_t * password, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->CheckPassword(password, _retval); } \
  NS_IMETHOD InitPassword(const char16_t * initialPassword) override { return !_to ? NS_ERROR_NULL_POINTER : _to->InitPassword(initialPassword); } \
  NS_IMETHOD ChangePassword(const char16_t * oldPassword, const char16_t * newPassword) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ChangePassword(oldPassword, newPassword); } \
