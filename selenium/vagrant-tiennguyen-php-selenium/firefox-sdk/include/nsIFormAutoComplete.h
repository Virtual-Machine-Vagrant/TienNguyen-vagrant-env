...
class NS_NO_VTABLE nsIFormAutoComplete : public nsISupports {
 public:
  ...
  NS_IMETHOD StopControllingInput(nsIDOMHTMLInputElement *aField) = 0;
...
#define NS_DECL_NSIFORMAUTOCOMPLETE \
  ...
  NS_IMETHOD StopControllingInput(nsIDOMHTMLInputElement *aField) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIFORMAUTOCOMPLETE \
  NS_METHOD AutoCompleteSearchAsync(const nsAString & aInputName, const nsAString & aSearchString, nsIDOMHTMLInputElement *aField, nsIAutoCompleteResult *aPreviousResult, nsIAutoCompleteResult *aDatalistResult, nsIFormAutoCompleteObserver *aListener); \
  NS_METHOD StopAutoCompleteSearch(void); \
  NS_METHOD StopControllingInput(nsIDOMHTMLInputElement *aField); 
...
#define NS_FORWARD_NSIFORMAUTOCOMPLETE(_to) \
  ...
  NS_IMETHOD StopControllingInput(nsIDOMHTMLInputElement *aField) override { return _to StopControllingInput(aField); } 
...
#define NS_FORWARD_SAFE_NSIFORMAUTOCOMPLETE(_to) \
  ...
  NS_IMETHOD StopControllingInput(nsIDOMHTMLInputElement *aField) override { return !_to ? NS_ERROR_NULL_POINTER : _to->StopControllingInput(aField); } 
...
/* void stopControllingInput (in nsIDOMHTMLInputElement aField); */
NS_IMETHODIMP nsFormAutoComplete::StopControllingInput(nsIDOMHTMLInputElement *aField)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
#define NS_DECL_NON_VIRTUAL_NSIFORMAUTOCOMPLETEOBSERVER \
  NS_METHOD OnSearchCompletion(nsIAutoCompleteResult *result); 
