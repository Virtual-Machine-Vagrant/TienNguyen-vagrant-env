...
#define NS_DECL_NON_VIRTUAL_NSIREFLOWOBSERVER \
  NS_METHOD Reflow(DOMHighResTimeStamp start, DOMHighResTimeStamp end); \
  NS_METHOD ReflowInterruptible(DOMHighResTimeStamp start, DOMHighResTimeStamp end); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsReflowObserver, nsIReflowObserver)
