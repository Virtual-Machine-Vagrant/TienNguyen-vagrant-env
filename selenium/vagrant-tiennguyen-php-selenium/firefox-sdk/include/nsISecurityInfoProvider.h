...
#define NS_DECL_NSISECURITYINFOPROVIDER \
  ...
  NS_IMETHOD GetHasTransferredData(bool *aHasTransferredData) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSISECURITYINFOPROVIDER \
  NS_METHOD GetSecurityInfo(nsISupports * *aSecurityInfo); \
  NS_METHOD GetHasTransferredData(bool *aHasTransferredData); 
...
#define NS_FORWARD_NSISECURITYINFOPROVIDER(_to) \
  ...
  NS_IMETHOD GetHasTransferredData(bool *aHasTransferredData) override { return _to GetHasTransferredData(aHasTransferredData); } 
...
#define NS_FORWARD_SAFE_NSISECURITYINFOPROVIDER(_to) \
  ...
  NS_IMETHOD GetHasTransferredData(bool *aHasTransferredData) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHasTransferredData(aHasTransferredData); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsSecurityInfoProvider, nsISecurityInfoProvider)
