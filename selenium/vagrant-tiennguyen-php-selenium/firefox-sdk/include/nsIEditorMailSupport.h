...
#define NS_DECL_NSIEDITORMAILSUPPORT \
  ...
  NS_IMETHOD GetEmbeddedObjects(nsISupportsArray * *_retval) override; 
...
#define NS_DECL_NON_VIRTUAL_NSIEDITORMAILSUPPORT \
  ...
  NS_METHOD GetEmbeddedObjects(nsISupportsArray * *_retval); 
...
#define NS_FORWARD_NSIEDITORMAILSUPPORT(_to) \
  ...
  NS_IMETHOD GetEmbeddedObjects(nsISupportsArray * *_retval) override { return _to GetEmbeddedObjects(_retval); } 
...
#define NS_FORWARD_SAFE_NSIEDITORMAILSUPPORT(_to) \
  ...
  NS_IMETHOD GetEmbeddedObjects(nsISupportsArray * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEmbeddedObjects(_retval); } 
