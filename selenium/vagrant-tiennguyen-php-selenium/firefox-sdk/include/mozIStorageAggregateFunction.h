...
#define NS_DECL_MOZISTORAGEAGGREGATEFUNCTION \
  NS_IMETHOD OnStep(mozIStorageValueArray *aFunctionArguments) override; \
  NS_IMETHOD OnFinal(nsIVariant * *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_MOZISTORAGEAGGREGATEFUNCTION \
  NS_METHOD OnStep(mozIStorageValueArray *aFunctionArguments); \
  NS_METHOD OnFinal(nsIVariant * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_MOZISTORAGEAGGREGATEFUNCTION(_to) \
  NS_IMETHOD OnStep(mozIStorageValueArray *aFunctionArguments) override { return _to OnStep(aFunctionArguments); } \
  NS_IMETHOD OnFinal(nsIVariant * *_retval) override { return _to OnFinal(_retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_MOZISTORAGEAGGREGATEFUNCTION(_to) \
  NS_IMETHOD OnStep(mozIStorageValueArray *aFunctionArguments) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnStep(aFunctionArguments); } \
  NS_IMETHOD OnFinal(nsIVariant * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnFinal(_retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(_MYCLASS_, mozIStorageAggregateFunction)
