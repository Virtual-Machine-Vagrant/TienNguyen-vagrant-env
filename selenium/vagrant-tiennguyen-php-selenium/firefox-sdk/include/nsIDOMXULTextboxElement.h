...
#define NS_DECL_NON_VIRTUAL_NSIDOMXULTEXTBOXELEMENT \
  NS_METHOD GetInputField(nsIDOMNode * *aInputField); \
  ...
  NS_METHOD GetSize(int32_t *aSize); \
  NS_METHOD SetSize(int32_t aSize); \
  ...
  NS_METHOD SetSelectionRange(int32_t selectionStart, int32_t selectionEnd); 
