...
#define NS_DECL_NON_VIRTUAL_NSIRECOVERYSERVICE \
  NS_METHOD FactoryReset(const char * reason); \
  NS_METHOD InstallFotaUpdate(const char * updatePath); \
  NS_METHOD GetFotaUpdateStatus(int32_t *_retval); 
