...
#define NS_INAVBOOKMARKOBSERVER_IID_STR "cff3efcc-e144-490d-9f23-8b6f6dd09e7f"

#define NS_INAVBOOKMARKOBSERVER_IID \
  {0xcff3efcc, 0xe144, 0x490d, \
    { 0x9f, 0x23, 0x8b, 0x6f, 0x6d, 0xd0, 0x9e, 0x7f }}
...
class NS_NO_VTABLE nsINavBookmarkObserver : public nsISupports {
 public:
  ...
  /* void onItemChanged (in long long aItemId, in ACString aProperty, in boolean aIsAnnotationProperty, in AUTF8String aNewValue, in PRTime aLastModified, in unsigned short aItemType, in long long aParentId, in ACString aGuid, in ACString aParentGuid, in AUTF8String aOldValue); */
  NS_IMETHOD OnItemChanged(int64_t aItemId, const nsACString & aProperty, bool aIsAnnotationProperty, const nsACString & aNewValue, PRTime aLastModified, uint16_t aItemType, int64_t aParentId, const nsACString & aGuid, const nsACString & aParentGuid, const nsACString & aOldValue) = 0;
...
#define NS_DECL_NSINAVBOOKMARKOBSERVER \
  ...
  NS_IMETHOD OnItemChanged(int64_t aItemId, const nsACString & aProperty, bool aIsAnnotationProperty, const nsACString & aNewValue, PRTime aLastModified, uint16_t aItemType, int64_t aParentId, const nsACString & aGuid, const nsACString & aParentGuid, const nsACString & aOldValue) override; \
...
#define NS_DECL_NON_VIRTUAL_NSINAVBOOKMARKOBSERVER \
  ...
  NS_METHOD OnItemAdded(int64_t aItemId, int64_t aParentId, int32_t aIndex, uint16_t aItemType, nsIURI *aURI, const nsACString & aTitle, PRTime aDateAdded, const nsACString & aGuid, const nsACString & aParentGuid); \
  NS_METHOD OnItemRemoved(int64_t aItemId, int64_t aParentId, int32_t aIndex, uint16_t aItemType, nsIURI *aURI, const nsACString & aGuid, const nsACString & aParentGuid); \
  NS_METHOD OnItemChanged(int64_t aItemId, const nsACString & aProperty, bool aIsAnnotationProperty, const nsACString & aNewValue, PRTime aLastModified, uint16_t aItemType, int64_t aParentId, const nsACString & aGuid, const nsACString & aParentGuid, const nsACString & aOldValue); \
  NS_METHOD OnItemVisited(int64_t aItemId, int64_t aVisitId, PRTime aTime, uint32_t aTransitionType, nsIURI *aURI, int64_t aParentId, const nsACString & aGuid, const nsACString & aParentGuid); \
  NS_METHOD OnItemMoved(int64_t aItemId, int64_t aOldParentId, int32_t aOldIndex, int64_t aNewParentId, int32_t aNewIndex, uint16_t aItemType, const nsACString & aGuid, const nsACString & aOldParentGuid, const nsACString & aNewParentGuid); 
...
#define NS_FORWARD_NSINAVBOOKMARKOBSERVER(_to) \
  ...
  NS_IMETHOD OnItemChanged(int64_t aItemId, const nsACString & aProperty, bool aIsAnnotationProperty, const nsACString & aNewValue, PRTime aLastModified, uint16_t aItemType, int64_t aParentId, const nsACString & aGuid, const nsACString & aParentGuid, const nsACString & aOldValue) override { return _to OnItemChanged(aItemId, aProperty, aIsAnnotationProperty, aNewValue, aLastModified, aItemType, aParentId, aGuid, aParentGuid, aOldValue); } \
...
#define NS_FORWARD_SAFE_NSINAVBOOKMARKOBSERVER(_to) \
  ...
  NS_IMETHOD OnItemChanged(int64_t aItemId, const nsACString & aProperty, bool aIsAnnotationProperty, const nsACString & aNewValue, PRTime aLastModified, uint16_t aItemType, int64_t aParentId, const nsACString & aGuid, const nsACString & aParentGuid, const nsACString & aOldValue) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnItemChanged(aItemId, aProperty, aIsAnnotationProperty, aNewValue, aLastModified, aItemType, aParentId, aGuid, aParentGuid, aOldValue); } \
...
/* void onItemChanged (in long long aItemId, in ACString aProperty, in boolean aIsAnnotationProperty, in AUTF8String aNewValue, in PRTime aLastModified, in unsigned short aItemType, in long long aParentId, in ACString aGuid, in ACString aParentGuid, in AUTF8String aOldValue); */
NS_IMETHODIMP nsNavBookmarkObserver::OnItemChanged(int64_t aItemId, const nsACString & aProperty, bool aIsAnnotationProperty, const nsACString & aNewValue, PRTime aLastModified, uint16_t aItemType, int64_t aParentId, const nsACString & aGuid, const nsACString & aParentGuid, const nsACString & aOldValue)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
#define NS_DECL_NON_VIRTUAL_NSINAVBOOKMARKSSERVICE \
  NS_METHOD GetPlacesRoot(int64_t *aPlacesRoot); \
  NS_METHOD GetBookmarksMenuFolder(int64_t *aBookmarksMenuFolder); \
  NS_METHOD GetTagsFolder(int64_t *aTagsFolder); \
  NS_METHOD GetUnfiledBookmarksFolder(int64_t *aUnfiledBookmarksFolder); \
  NS_METHOD GetToolbarFolder(int64_t *aToolbarFolder); \
  NS_METHOD InsertBookmark(int64_t aParentId, nsIURI *aURI, int32_t aIndex, const nsACString & aTitle, const nsACString & aGuid, int64_t *_retval); \
  NS_METHOD RemoveItem(int64_t aItemId); \
  NS_METHOD CreateFolder(int64_t aParentFolder, const nsACString & name, int32_t index, const nsACString & aGuid, int64_t *_retval); \
  NS_METHOD GetRemoveFolderTransaction(int64_t aItemId, nsITransaction * *_retval); \
  NS_METHOD RemoveFolderChildren(int64_t aItemId); \
  NS_METHOD MoveItem(int64_t aItemId, int64_t aNewParentId, int32_t aIndex); \
  NS_METHOD InsertSeparator(int64_t aParentId, int32_t aIndex, const nsACString & aGuid, int64_t *_retval); \
  NS_METHOD GetIdForItemAt(int64_t aParentId, int32_t aIndex, int64_t *_retval); \
  NS_METHOD SetItemTitle(int64_t aItemId, const nsACString & aTitle); \
  NS_METHOD GetItemTitle(int64_t aItemId, nsACString & _retval); \
  NS_METHOD SetItemDateAdded(int64_t aItemId, PRTime aDateAdded); \
  NS_METHOD GetItemDateAdded(int64_t aItemId, PRTime *_retval); \
  NS_METHOD SetItemLastModified(int64_t aItemId, PRTime aLastModified); \
  NS_METHOD GetItemLastModified(int64_t aItemId, PRTime *_retval); \
  NS_METHOD GetBookmarkURI(int64_t aItemId, nsIURI * *_retval); \
  NS_METHOD GetItemIndex(int64_t aItemId, int32_t *_retval); \
  NS_METHOD SetItemIndex(int64_t aItemId, int32_t aNewIndex); \
  NS_METHOD GetItemType(int64_t aItemId, uint16_t *_retval); \
  NS_METHOD IsBookmarked(nsIURI *aURI, bool *_retval); \
  NS_METHOD GetBookmarkedURIFor(nsIURI *aURI, nsIURI * *_retval); \
  NS_METHOD ChangeBookmarkURI(int64_t aItemId, nsIURI *aNewURI); \
  NS_METHOD GetFolderIdForItem(int64_t aItemId, int64_t *_retval); \
  NS_METHOD GetBookmarkIdsForURI(nsIURI *aURI, uint32_t *count, int64_t **bookmarks); \
  NS_METHOD SetKeywordForBookmark(int64_t aItemId, const nsAString & aKeyword); \
  NS_METHOD GetKeywordForBookmark(int64_t aItemId, nsAString & _retval); \
  NS_METHOD GetURIForKeyword(const nsAString & keyword, nsIURI * *_retval); \
  NS_METHOD AddObserver(nsINavBookmarkObserver *observer, bool ownsWeak); \
  NS_METHOD RemoveObserver(nsINavBookmarkObserver *observer); \
  NS_METHOD GetObservers(uint32_t *count, nsINavBookmarkObserver * **observers); \
  NS_METHOD RunInBatchMode(nsINavHistoryBatchCallback *aCallback, nsISupports *aUserData); 
