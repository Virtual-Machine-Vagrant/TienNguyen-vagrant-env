...
#define NS_DECL_NON_VIRTUAL_NSISERVICEMANAGER \
  NS_METHOD GetService(const nsCID & aClass, const nsIID & aIID, void **result); \
  NS_METHOD GetServiceByContractID(const char * aContractID, const nsIID & aIID, void **result); \
  NS_METHOD IsServiceInstantiated(const nsCID & aClass, const nsIID & aIID, bool *_retval); \
  NS_METHOD IsServiceInstantiatedByContractID(const char * aContractID, const nsIID & aIID, bool *_retval); 
