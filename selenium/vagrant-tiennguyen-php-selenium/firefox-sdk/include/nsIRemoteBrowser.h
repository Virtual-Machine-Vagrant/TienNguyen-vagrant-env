...
#define NS_DECL_NON_VIRTUAL_NSIREMOTEBROWSER \
  NS_METHOD EnableDisableCommands(const nsAString & action, uint32_t enabledLength, const char * *enabledCommands, uint32_t disabledLength, const char * *disabledCommands); 
