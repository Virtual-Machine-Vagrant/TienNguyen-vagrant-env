...
#define NS_DECL_NSIPARSERUTILS \
  ...
  NS_IMETHOD ParseFragment(const nsAString & fragment, uint32_t flags, bool isXML, nsIURI *baseURI, nsIDOMElement *element, nsIDOMDocumentFragment * *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIPARSERUTILS \
  NS_METHOD Sanitize(const nsAString & src, uint32_t flags, nsAString & _retval); \
  NS_METHOD ConvertToPlainText(const nsAString & src, uint32_t flags, uint32_t wrapCol, nsAString & _retval); \
  NS_METHOD ParseFragment(const nsAString & fragment, uint32_t flags, bool isXML, nsIURI *baseURI, nsIDOMElement *element, nsIDOMDocumentFragment * *_retval); 
...
#define NS_FORWARD_NSIPARSERUTILS(_to) \
  ...
  NS_IMETHOD ParseFragment(const nsAString & fragment, uint32_t flags, bool isXML, nsIURI *baseURI, nsIDOMElement *element, nsIDOMDocumentFragment * *_retval) override { return _to ParseFragment(fragment, flags, isXML, baseURI, element, _retval); } 
...
#define NS_FORWARD_SAFE_NSIPARSERUTILS(_to) \
  ...
  NS_IMETHOD ParseFragment(const nsAString & fragment, uint32_t flags, bool isXML, nsIURI *baseURI, nsIDOMElement *element, nsIDOMDocumentFragment * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ParseFragment(fragment, flags, isXML, baseURI, element, _retval); } 
