...
#define NS_IDOMCUSTOMEVENT_IID_STR "5be16b03-36f9-4ca8-b2c5-0daadf3cd1b3"

#define NS_IDOMCUSTOMEVENT_IID \
  {0x5be16b03, 0x36f9, 0x4ca8, \
    { 0xb2, 0xc5, 0x0d, 0xaa, 0xdf, 0x3c, 0xd1, 0xb3 }}

class NS_NO_VTABLE nsIDOMCustomEvent : public nsISupports {
 public:
...
#define NS_DECL_NON_VIRTUAL_NSIDOMCUSTOMEVENT \
  NS_METHOD GetDetail(nsIVariant * *aDetail); \
  NS_METHOD InitCustomEvent(const nsAString & typeArg, bool canBubbleArg, bool cancelableArg, nsIVariant *detailArg); 
