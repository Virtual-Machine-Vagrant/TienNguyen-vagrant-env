...
class NS_NO_VTABLE nsIDialogParamBlock : public nsISupports {
 public:
  ...
  NS_IMETHOD GetString(int32_t inIndex, char16_t * *_retval) = 0;

  /* void SetString (in int32_t inIndex, in wstring inString); */
  NS_IMETHOD SetString(int32_t inIndex, const char16_t * inString) = 0;
...
#define NS_DECL_NON_VIRTUAL_NSIDIALOGPARAMBLOCK \
  NS_METHOD GetInt(int32_t inIndex, int32_t *_retval); \
  NS_METHOD SetInt(int32_t inIndex, int32_t inInt); \
  NS_METHOD SetNumberStrings(int32_t inNumStrings); \
  NS_METHOD GetString(int32_t inIndex, char16_t * *_retval); \
  NS_METHOD SetString(int32_t inIndex, const char16_t * inString); \
  NS_METHOD GetObjects(nsIMutableArray * *aObjects); \
  NS_METHOD SetObjects(nsIMutableArray *aObjects); 
