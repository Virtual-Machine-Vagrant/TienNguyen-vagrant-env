...
#define NS_DECL_NSIDOMNODEITERATOR \
  ...
  NS_IMETHOD GetReferenceNode(nsIDOMNode * *aReferenceNode) override; \
  NS_IMETHOD GetPointerBeforeReferenceNode(bool *aPointerBeforeReferenceNode) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMNODEITERATOR \
  ...
  NS_METHOD GetReferenceNode(nsIDOMNode * *aReferenceNode); \
  NS_METHOD GetPointerBeforeReferenceNode(bool *aPointerBeforeReferenceNode); 
...
#define NS_FORWARD_NSIDOMNODEITERATOR(_to) \
  ...
  NS_IMETHOD GetReferenceNode(nsIDOMNode * *aReferenceNode) override { return _to GetReferenceNode(aReferenceNode); } \
  NS_IMETHOD GetPointerBeforeReferenceNode(bool *aPointerBeforeReferenceNode) override { return _to GetPointerBeforeReferenceNode(aPointerBeforeReferenceNode); } 
...
#define NS_FORWARD_SAFE_NSIDOMNODEITERATOR(_to) \
  ...
  NS_IMETHOD GetReferenceNode(nsIDOMNode * *aReferenceNode) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetReferenceNode(aReferenceNode); } \
  NS_IMETHOD GetPointerBeforeReferenceNode(bool *aPointerBeforeReferenceNode) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPointerBeforeReferenceNode(aPointerBeforeReferenceNode); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMNodeIterator, nsIDOMNodeIterator)
