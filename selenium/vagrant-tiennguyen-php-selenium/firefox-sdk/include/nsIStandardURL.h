...
class NS_NO_VTABLE nsIStandardURL : public nsIMutable {
 public:
  ...
  NS_IMETHOD SetDefaultPort(int32_t aNewDefaultPort) = 0;
...
#define NS_DECL_NSISTANDARDURL \
  ...
  NS_IMETHOD SetDefaultPort(int32_t aNewDefaultPort) override; 
...
#define NS_DECL_NON_VIRTUAL_NSISTANDARDURL \
  ...
  NS_METHOD SetDefaultPort(int32_t aNewDefaultPort); 
...
#define NS_FORWARD_NSISTANDARDURL(_to) \
  ...
  NS_IMETHOD SetDefaultPort(int32_t aNewDefaultPort) override { return _to SetDefaultPort(aNewDefaultPort); } 
...
#define NS_FORWARD_SAFE_NSISTANDARDURL(_to) \
  ...
  NS_IMETHOD SetDefaultPort(int32_t aNewDefaultPort) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetDefaultPort(aNewDefaultPort); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsStandardURL, nsIStandardURL)
...
/* void setDefaultPort (in long aNewDefaultPort); */
NS_IMETHODIMP nsStandardURL::SetDefaultPort(int32_t aNewDefaultPort)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
