...
#define NS_DECL_NSIINPUTSTREAMPUMP \
  NS_IMETHOD Init(nsIInputStream *aStream, int64_t aStreamPos, int64_t aStreamLen, uint32_t aSegmentSize, uint32_t aSegmentCount, bool aCloseWhenDone) override; \
  NS_IMETHOD AsyncRead(nsIStreamListener *aListener, nsISupports *aListenerContext) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIINPUTSTREAMPUMP \
  NS_METHOD Init(nsIInputStream *aStream, int64_t aStreamPos, int64_t aStreamLen, uint32_t aSegmentSize, uint32_t aSegmentCount, bool aCloseWhenDone); \
  NS_METHOD AsyncRead(nsIStreamListener *aListener, nsISupports *aListenerContext); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIINPUTSTREAMPUMP(_to) \
  NS_IMETHOD Init(nsIInputStream *aStream, int64_t aStreamPos, int64_t aStreamLen, uint32_t aSegmentSize, uint32_t aSegmentCount, bool aCloseWhenDone) override { return _to Init(aStream, aStreamPos, aStreamLen, aSegmentSize, aSegmentCount, aCloseWhenDone); } \
  NS_IMETHOD AsyncRead(nsIStreamListener *aListener, nsISupports *aListenerContext) override { return _to AsyncRead(aListener, aListenerContext); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIINPUTSTREAMPUMP(_to) \
  NS_IMETHOD Init(nsIInputStream *aStream, int64_t aStreamPos, int64_t aStreamLen, uint32_t aSegmentSize, uint32_t aSegmentCount, bool aCloseWhenDone) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(aStream, aStreamPos, aStreamLen, aSegmentSize, aSegmentCount, aCloseWhenDone); } \
  NS_IMETHOD AsyncRead(nsIStreamListener *aListener, nsISupports *aListenerContext) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AsyncRead(aListener, aListenerContext); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsInputStreamPump, nsIInputStreamPump)
