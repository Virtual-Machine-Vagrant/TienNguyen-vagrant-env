...
#define NS_DECL_NSIATOMSERVICE \
  NS_IMETHOD GetAtom(const nsAString & value, nsIAtom * *_retval) override; \
  NS_IMETHOD GetPermanentAtom(const nsAString & value, nsIAtom * *_retval) override; \
  NS_IMETHOD GetAtomUTF8(const char * value, nsIAtom * *_retval) override; \
  NS_IMETHOD GetPermanentAtomUTF8(const char * value, nsIAtom * *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIATOMSERVICE \
  NS_METHOD GetAtom(const nsAString & value, nsIAtom * *_retval); \
  NS_METHOD GetPermanentAtom(const nsAString & value, nsIAtom * *_retval); \
  NS_METHOD GetAtomUTF8(const char * value, nsIAtom * *_retval); \
  NS_METHOD GetPermanentAtomUTF8(const char * value, nsIAtom * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIATOMSERVICE(_to) \
  NS_IMETHOD GetAtom(const nsAString & value, nsIAtom * *_retval) override { return _to GetAtom(value, _retval); } \
  NS_IMETHOD GetPermanentAtom(const nsAString & value, nsIAtom * *_retval) override { return _to GetPermanentAtom(value, _retval); } \
  NS_IMETHOD GetAtomUTF8(const char * value, nsIAtom * *_retval) override { return _to GetAtomUTF8(value, _retval); } \
  NS_IMETHOD GetPermanentAtomUTF8(const char * value, nsIAtom * *_retval) override { return _to GetPermanentAtomUTF8(value, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIATOMSERVICE(_to) \
  NS_IMETHOD GetAtom(const nsAString & value, nsIAtom * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAtom(value, _retval); } \
  NS_IMETHOD GetPermanentAtom(const nsAString & value, nsIAtom * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPermanentAtom(value, _retval); } \
  NS_IMETHOD GetAtomUTF8(const char * value, nsIAtom * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAtomUTF8(value, _retval); } \
  NS_IMETHOD GetPermanentAtomUTF8(const char * value, nsIAtom * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPermanentAtomUTF8(value, _retval); } 
