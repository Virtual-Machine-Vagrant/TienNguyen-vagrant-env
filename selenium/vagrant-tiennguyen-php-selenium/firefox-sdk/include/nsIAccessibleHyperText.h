...
#define NS_DECL_NON_VIRTUAL_NSIACCESSIBLEHYPERTEXT \
  NS_METHOD GetLinkCount(int32_t *aLinkCount); \
  NS_METHOD GetLinkAt(int32_t index, nsIAccessibleHyperLink * *_retval); \
  NS_METHOD GetLinkIndex(nsIAccessibleHyperLink *link, int32_t *_retval); \
  NS_METHOD GetLinkIndexAtOffset(int32_t offset, int32_t *_retval); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsAccessibleHyperText, nsIAccessibleHyperText)
