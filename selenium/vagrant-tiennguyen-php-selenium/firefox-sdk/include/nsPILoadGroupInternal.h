...
#define NS_DECL_NSPILOADGROUPINTERNAL \
  NS_IMETHOD OnEndPageLoad(nsIChannel *aDefaultChannel) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSPILOADGROUPINTERNAL \
  NS_METHOD OnEndPageLoad(nsIChannel *aDefaultChannel); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSPILOADGROUPINTERNAL(_to) \
  NS_IMETHOD OnEndPageLoad(nsIChannel *aDefaultChannel) override { return _to OnEndPageLoad(aDefaultChannel); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSPILOADGROUPINTERNAL(_to) \
  NS_IMETHOD OnEndPageLoad(nsIChannel *aDefaultChannel) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnEndPageLoad(aDefaultChannel); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(_MYCLASS_, nsPILoadGroupInternal)
