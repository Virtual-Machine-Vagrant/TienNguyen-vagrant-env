...
#define NS_DECL_NON_VIRTUAL_NSIDOWNLOADPROGRESSLISTENER \
  NS_METHOD GetDocument(nsIDOMDocument * *aDocument); \
  NS_METHOD SetDocument(nsIDOMDocument *aDocument); \
  NS_METHOD OnDownloadStateChange(int16_t aState, nsIDownload *aDownload); \
  NS_METHOD OnStateChange(nsIWebProgress *aWebProgress, nsIRequest *aRequest, uint32_t aStateFlags, nsresult aStatus, nsIDownload *aDownload); \
  NS_METHOD OnProgressChange(nsIWebProgress *aWebProgress, nsIRequest *aRequest, int64_t aCurSelfProgress, int64_t aMaxSelfProgress, int64_t aCurTotalProgress, int64_t aMaxTotalProgress, nsIDownload *aDownload); \
  NS_METHOD OnSecurityChange(nsIWebProgress *aWebProgress, nsIRequest *aRequest, uint32_t aState, nsIDownload *aDownload); 
