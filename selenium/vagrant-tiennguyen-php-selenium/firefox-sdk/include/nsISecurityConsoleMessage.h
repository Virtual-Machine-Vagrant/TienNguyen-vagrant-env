...
#define NS_DECL_NON_VIRTUAL_NSISECURITYCONSOLEMESSAGE \
  NS_METHOD GetTag(nsAString & aTag); \
  NS_METHOD SetTag(const nsAString & aTag); \
  NS_METHOD GetCategory(nsAString & aCategory); \
  NS_METHOD SetCategory(const nsAString & aCategory); 
