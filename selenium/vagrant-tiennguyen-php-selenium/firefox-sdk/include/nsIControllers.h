...
#define NS_DECL_NON_VIRTUAL_NSICONTROLLERS \
  ...
  NS_METHOD InsertControllerAt(uint32_t index, nsIController *controller); \
  NS_METHOD RemoveControllerAt(uint32_t index, nsIController * *_retval); \
  NS_METHOD GetControllerAt(uint32_t index, nsIController * *_retval); \
  NS_METHOD AppendController(nsIController *controller); \
  NS_METHOD RemoveController(nsIController *controller); \
  NS_METHOD GetControllerId(nsIController *controller, uint32_t *_retval); \
  NS_METHOD GetControllerById(uint32_t controllerID, nsIController * *_retval); \
  NS_METHOD GetControllerCount(uint32_t *_retval); 
