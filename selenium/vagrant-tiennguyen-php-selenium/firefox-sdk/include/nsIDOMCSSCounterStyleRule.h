...
#define NS_DECL_NON_VIRTUAL_NSIDOMCSSCOUNTERSTYLERULE \
  ...
  NS_METHOD GetSystem(nsAString & aSystem); \
  NS_METHOD SetSystem(const nsAString & aSystem); \
  NS_METHOD GetSymbols(nsAString & aSymbols); \
  NS_METHOD SetSymbols(const nsAString & aSymbols); \
  NS_METHOD GetAdditiveSymbols(nsAString & aAdditiveSymbols); \
  NS_METHOD SetAdditiveSymbols(const nsAString & aAdditiveSymbols); \
  NS_METHOD GetNegative(nsAString & aNegative); \
  NS_METHOD SetNegative(const nsAString & aNegative); \
  NS_METHOD GetPrefix(nsAString & aPrefix); \
  NS_METHOD SetPrefix(const nsAString & aPrefix); \
  NS_METHOD GetSuffix(nsAString & aSuffix); \
  NS_METHOD SetSuffix(const nsAString & aSuffix); \
  NS_METHOD GetRange(nsAString & aRange); \
  NS_METHOD SetRange(const nsAString & aRange); \
  NS_METHOD GetPad(nsAString & aPad); \
  NS_METHOD SetPad(const nsAString & aPad); \
  NS_METHOD GetSpeakAs(nsAString & aSpeakAs); \
  NS_METHOD SetSpeakAs(const nsAString & aSpeakAs); \
  NS_METHOD GetFallback(nsAString & aFallback); \
  NS_METHOD SetFallback(const nsAString & aFallback); 
