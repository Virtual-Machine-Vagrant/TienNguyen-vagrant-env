...
#define NS_DECL_NON_VIRTUAL_NSIDOMELEMENT \
  NS_METHOD GetTagName(nsAString & aTagName); \
  NS_METHOD GetId(nsAString & aId); \
  NS_METHOD SetId(const nsAString & aId); \
  NS_METHOD GetClassName(nsAString & aClassName); \
  NS_METHOD SetClassName(const nsAString & aClassName); \
  NS_METHOD GetClassList(nsISupports * *aClassList); \
  NS_METHOD GetAttributes(nsIDOMMozNamedAttrMap * *aAttributes); \
  NS_METHOD GetAttribute(const nsAString & name, nsAString & _retval); \
  NS_METHOD GetAttributeNS(const nsAString & namespaceURI, const nsAString & localName, nsAString & _retval); \
  NS_METHOD SetAttribute(const nsAString & name, const nsAString & value); \
  NS_METHOD SetAttributeNS(const nsAString & namespaceURI, const nsAString & qualifiedName, const nsAString & value); \
  NS_METHOD RemoveAttribute(const nsAString & name); \
  NS_METHOD RemoveAttributeNS(const nsAString & namespaceURI, const nsAString & localName); \
  NS_METHOD HasAttribute(const nsAString & name, bool *_retval); \
  NS_METHOD HasAttributeNS(const nsAString & namespaceURI, const nsAString & localName, bool *_retval); \
  NS_METHOD HasAttributes(bool *_retval); \
  NS_METHOD GetAttributeNode(const nsAString & name, nsIDOMAttr * *_retval); \
  NS_METHOD SetAttributeNode(nsIDOMAttr *newAttr, nsIDOMAttr * *_retval); \
  NS_METHOD RemoveAttributeNode(nsIDOMAttr *oldAttr, nsIDOMAttr * *_retval); \
  NS_METHOD GetAttributeNodeNS(const nsAString & namespaceURI, const nsAString & localName, nsIDOMAttr * *_retval); \
  NS_METHOD SetAttributeNodeNS(nsIDOMAttr *newAttr, nsIDOMAttr * *_retval); \
  NS_METHOD GetElementsByTagName(const nsAString & name, nsIDOMHTMLCollection * *_retval); \
  NS_METHOD GetElementsByTagNameNS(const nsAString & namespaceURI, const nsAString & localName, nsIDOMHTMLCollection * *_retval); \
  NS_METHOD GetElementsByClassName(const nsAString & classes, nsIDOMHTMLCollection * *_retval); \
  NS_METHOD GetChildElements(nsIDOMNodeList * *aChildren); \
  NS_METHOD GetFirstElementChild(nsIDOMElement * *aFirstElementChild); \
  NS_METHOD GetLastElementChild(nsIDOMElement * *aLastElementChild); \
  NS_METHOD GetPreviousElementSibling(nsIDOMElement * *aPreviousElementSibling); \
  NS_METHOD GetNextElementSibling(nsIDOMElement * *aNextElementSibling); \
  NS_METHOD GetChildElementCount(uint32_t *aChildElementCount); \
  ...
  NS_METHOD GetScrollTop(int32_t *aScrollTop); \
  NS_METHOD SetScrollTop(int32_t aScrollTop); \
  NS_METHOD GetScrollLeft(int32_t *aScrollLeft); \
  NS_METHOD SetScrollLeft(int32_t aScrollLeft); \
  NS_METHOD GetScrollWidth(int32_t *aScrollWidth); \
  NS_METHOD GetScrollHeight(int32_t *aScrollHeight); \
  NS_METHOD GetClientTop(int32_t *aClientTop); \
  NS_METHOD GetClientLeft(int32_t *aClientLeft); \
  NS_METHOD GetClientWidth(int32_t *aClientWidth); \
  NS_METHOD GetClientHeight(int32_t *aClientHeight); \
  NS_METHOD GetScrollLeftMax(int32_t *aScrollLeftMax); \
  NS_METHOD GetScrollTopMax(int32_t *aScrollTopMax); \
  NS_METHOD MozMatchesSelector(const nsAString & selector, bool *_retval); \
  NS_METHOD SetCapture(bool retargetToElement); \
  NS_METHOD ReleaseCapture(void); \
  NS_METHOD MozRequestFullScreen(void); \
  NS_METHOD MozRequestPointerLock(void); \
