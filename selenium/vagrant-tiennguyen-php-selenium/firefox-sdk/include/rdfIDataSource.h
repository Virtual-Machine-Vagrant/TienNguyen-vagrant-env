...
#define NS_DECL_NON_VIRTUAL_RDFIDATASOURCE \
  NS_METHOD VisitAllSubjects(rdfITripleVisitor *aVisitor); \
  NS_METHOD VisitAllTriples(rdfITripleVisitor *aVisitor); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_RDFIDATASOURCE(_to) \
  NS_IMETHOD VisitAllSubjects(rdfITripleVisitor *aVisitor) override { return _to VisitAllSubjects(aVisitor); } \
  NS_IMETHOD VisitAllTriples(rdfITripleVisitor *aVisitor) override { return _to VisitAllTriples(aVisitor); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_RDFIDATASOURCE(_to) \
  NS_IMETHOD VisitAllSubjects(rdfITripleVisitor *aVisitor) override { return !_to ? NS_ERROR_NULL_POINTER : _to->VisitAllSubjects(aVisitor); } \
  NS_IMETHOD VisitAllTriples(rdfITripleVisitor *aVisitor) override { return !_to ? NS_ERROR_NULL_POINTER : _to->VisitAllTriples(aVisitor); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(_MYCLASS_, rdfIDataSource)
