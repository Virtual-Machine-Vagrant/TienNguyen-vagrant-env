...
#define NS_DECL_NON_VIRTUAL_NSICONTROLLERCOMMAND \
  NS_METHOD IsCommandEnabled(const char * aCommandName, nsISupports *aCommandContext, bool *_retval); \
  NS_METHOD GetCommandStateParams(const char * aCommandName, nsICommandParams *aParams, nsISupports *aCommandContext); \
  NS_METHOD DoCommand(const char * aCommandName, nsISupports *aCommandContext); \
  NS_METHOD DoCommandParams(const char * aCommandName, nsICommandParams *aParams, nsISupports *aCommandContext); 
...
#define NS_FORWARD_NSICONTROLLERCOMMAND(_to) \
  ...
  NS_IMETHOD DoCommand(const char * aCommandName, nsISupports *aCommandContext) override { return _to DoCommand(aCommandName, aCommandContext); } \
  NS_IMETHOD DoCommandParams(const char * aCommandName, nsICommandParams *aParams, nsISupports *aCommandContext) override { return _to DoCommandParams(aCommandName, aParams, aCommandContext); } 
...
#define NS_FORWARD_SAFE_NSICONTROLLERCOMMAND(_to) \
  ...
  NS_IMETHOD DoCommand(const char * aCommandName, nsISupports *aCommandContext) override { return !_to ? NS_ERROR_NULL_POINTER : _to->DoCommand(aCommandName, aCommandContext); } \
  NS_IMETHOD DoCommandParams(const char * aCommandName, nsICommandParams *aParams, nsISupports *aCommandContext) override { return !_to ? NS_ERROR_NULL_POINTER : _to->DoCommandParams(aCommandName, aParams, aCommandContext); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsControllerCommand, nsIControllerCommand)
