...
#define NS_DECL_NSIRDFINMEMORYDATASOURCE \
  NS_IMETHOD EnsureFastContainment(nsIRDFResource *aSource) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIRDFINMEMORYDATASOURCE \
  NS_METHOD EnsureFastContainment(nsIRDFResource *aSource); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIRDFINMEMORYDATASOURCE(_to) \
  NS_IMETHOD EnsureFastContainment(nsIRDFResource *aSource) override { return _to EnsureFastContainment(aSource); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIRDFINMEMORYDATASOURCE(_to) \
  NS_IMETHOD EnsureFastContainment(nsIRDFResource *aSource) override { return !_to ? NS_ERROR_NULL_POINTER : _to->EnsureFastContainment(aSource); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsRDFInMemoryDataSource, nsIRDFInMemoryDataSource)
