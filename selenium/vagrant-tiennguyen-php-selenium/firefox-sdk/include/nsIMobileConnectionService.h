...
class nsIMobileDeviceIdentities; /* forward declaration */
...
#define NS_IMOBILECONNECTIONLISTENER_IID_STR "8884b326-891c-11e5-a434-67def07c4a41"

#define NS_IMOBILECONNECTIONLISTENER_IID \
  {0x8884b326, 0x891c, 0x11e5, \
    { 0xa4, 0x34, 0x67, 0xde, 0xf0, 0x7c, 0x4a, 0x41 }}
...
class NS_NO_VTABLE nsIMobileConnectionListener : public nsISupports {
 public:
  ...
  NS_IMETHOD NotifyDeviceIdentitiesChanged(void) = 0;
...
#define NS_DECL_NSIMOBILECONNECTIONLISTENER \
  ...
  NS_IMETHOD NotifyDeviceIdentitiesChanged(void) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIMOBILECONNECTIONLISTENER \
  NS_METHOD NotifyVoiceChanged(void); \
  NS_METHOD NotifyDataChanged(void); \
  NS_METHOD NotifyDataError(const nsAString & message); \
  NS_METHOD NotifyCFStateChanged(uint16_t action, uint16_t reason, const nsAString & number, uint16_t timeSeconds, uint16_t serviceClass); \
  NS_METHOD NotifyEmergencyCbModeChanged(bool active, uint32_t timeoutMs); \
  NS_METHOD NotifyOtaStatusChanged(const nsAString & status); \
  NS_METHOD NotifyRadioStateChanged(void); \
  NS_METHOD NotifyClirModeChanged(uint32_t mode); \
  NS_METHOD NotifyLastKnownNetworkChanged(void); \
  NS_METHOD NotifyLastKnownHomeNetworkChanged(void); \
  NS_METHOD NotifyNetworkSelectionModeChanged(void); \
  NS_METHOD NotifyDeviceIdentitiesChanged(void); 
...
#define NS_FORWARD_NSIMOBILECONNECTIONLISTENER(_to) \
  ...
  NS_IMETHOD NotifyDeviceIdentitiesChanged(void) override { return _to NotifyDeviceIdentitiesChanged(); } 
...
#define NS_FORWARD_SAFE_NSIMOBILECONNECTIONLISTENER(_to) \
  ...
  NS_IMETHOD NotifyDeviceIdentitiesChanged(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->NotifyDeviceIdentitiesChanged(); } 
...
/* void notifyDeviceIdentitiesChanged (); */
NS_IMETHODIMP nsMobileConnectionListener::NotifyDeviceIdentitiesChanged()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIMOBILECONNECTIONCALLBACK \
  NS_METHOD NotifySuccess(void); \
  NS_METHOD NotifySuccessWithBoolean(bool result); \
  NS_METHOD NotifyGetNetworksSuccess(uint32_t count, nsIMobileNetworkInfo **networks); \
  NS_METHOD NotifyGetCallForwardingSuccess(uint32_t count, nsIMobileCallForwardingOptions **results); \
  NS_METHOD NotifyGetCallBarringSuccess(uint16_t program, bool enabled, uint16_t serviceClass); \
  NS_METHOD NotifyGetCallWaitingSuccess(uint16_t serviceClass); \
  NS_METHOD NotifyGetClirStatusSuccess(uint16_t n, uint16_t m); \
  NS_METHOD NotifyGetPreferredNetworkTypeSuccess(int32_t type); \
  NS_METHOD NotifyGetRoamingPreferenceSuccess(int32_t mode); \
  NS_METHOD NotifyError(const nsAString & name); 
...
/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIMOBILECONNECTIONSERVICE \
  NS_METHOD GetNumItems(uint32_t *aNumItems); \
  NS_METHOD GetItemByServiceId(uint32_t serviceId, nsIMobileConnection * *_retval); 
...
#define NS_IMOBILECONNECTION_IID_STR "7a557116-8753-11e5-9f9b-6794b577c0a1"

#define NS_IMOBILECONNECTION_IID \
  {0x7a557116, 0x8753, 0x11e5, \
    { 0x9f, 0x9b, 0x67, 0x94, 0xb5, 0x77, 0xc0, 0xa1 }}
...
class NS_NO_VTABLE nsIMobileConnection : public nsISupports {
 public:
  ...
  NS_IMETHOD GetDeviceIdentities(nsIMobileDeviceIdentities * *aDeviceIdentities) = 0;
...
#define NS_DECL_NSIMOBILECONNECTION \
  ...
  NS_IMETHOD GetDeviceIdentities(nsIMobileDeviceIdentities * *aDeviceIdentities) override; \
...
/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIMOBILECONNECTION \
  NS_METHOD GetServiceId(uint32_t *aServiceId); \
  NS_METHOD RegisterListener(nsIMobileConnectionListener *listener); \
  NS_METHOD UnregisterListener(nsIMobileConnectionListener *listener); \
  NS_METHOD GetLastKnownNetwork(nsAString & aLastKnownNetwork); \
  NS_METHOD GetLastKnownHomeNetwork(nsAString & aLastKnownHomeNetwork); \
  NS_METHOD GetVoice(nsIMobileConnectionInfo * *aVoice); \
  NS_METHOD GetData(nsIMobileConnectionInfo * *aData); \
  NS_METHOD GetNetworkSelectionMode(int32_t *aNetworkSelectionMode); \
  NS_METHOD GetRadioState(int32_t *aRadioState); \
  NS_METHOD GetDeviceIdentities(nsIMobileDeviceIdentities * *aDeviceIdentities); \
  NS_METHOD GetSupportedNetworkTypes(int32_t **types, uint32_t *length); \
  NS_METHOD GetNetworks(nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD SelectNetwork(nsIMobileNetworkInfo *network, nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD SelectNetworkAutomatically(nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD SetPreferredNetworkType(int32_t type, nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD GetPreferredNetworkType(nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD SetRoamingPreference(int32_t mode, nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD GetRoamingPreference(nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD SetVoicePrivacyMode(bool enabled, nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD GetVoicePrivacyMode(nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD GetCallForwarding(uint16_t reason, nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD SetCallForwarding(uint16_t action, uint16_t reason, const nsAString & number, uint16_t timeSeconds, uint16_t serviceClass, nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD GetCallBarring(uint16_t program, const nsAString & password, uint16_t serviceClass, nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD SetCallBarring(uint16_t program, bool enabled, const nsAString & password, uint16_t serviceClass, nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD ChangeCallBarringPassword(const nsAString & pin, const nsAString & newPin, nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD SetCallWaiting(bool enabled, uint16_t serviceClass, nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD GetCallWaiting(nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD SetCallingLineIdRestriction(uint16_t clirMode, nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD GetCallingLineIdRestriction(nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD ExitEmergencyCbMode(nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD SetRadioEnabled(bool enabled, nsIMobileConnectionCallback *requestCallback); \
  NS_METHOD GetNeighboringCellIds(nsINeighboringCellIdsCallback *callback); \
  NS_METHOD GetCellInfoList(nsICellInfoListCallback *callback); 
...
#define NS_FORWARD_NSIMOBILECONNECTION(_to) \
  ...
  NS_IMETHOD GetDeviceIdentities(nsIMobileDeviceIdentities * *aDeviceIdentities) override { return _to GetDeviceIdentities(aDeviceIdentities); } \
...
#define NS_FORWARD_SAFE_NSIMOBILECONNECTION(_to) \
  ...
  NS_IMETHOD GetDeviceIdentities(nsIMobileDeviceIdentities * *aDeviceIdentities) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDeviceIdentities(aDeviceIdentities); } \
...
/* readonly attribute nsIMobileDeviceIdentities deviceIdentities; */
NS_IMETHODIMP nsMobileConnection::GetDeviceIdentities(nsIMobileDeviceIdentities * *aDeviceIdentities)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
