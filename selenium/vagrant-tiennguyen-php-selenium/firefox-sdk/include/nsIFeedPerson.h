...
#define NS_DECL_NSIFEEDPERSON \
  ...
  NS_IMETHOD SetEmail(const nsAString & aEmail) override; \
  NS_IMETHOD GetUri(nsIURI * *aUri) override; \
  NS_IMETHOD SetUri(nsIURI *aUri) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIFEEDPERSON \
  NS_METHOD GetName(nsAString & aName); \
  NS_METHOD SetName(const nsAString & aName); \
  NS_METHOD GetEmail(nsAString & aEmail); \
  NS_METHOD SetEmail(const nsAString & aEmail); \
...
#define NS_FORWARD_NSIFEEDPERSON(_to) \
  ...
  NS_IMETHOD SetEmail(const nsAString & aEmail) override { return _to SetEmail(aEmail); } \
...
#define NS_FORWARD_SAFE_NSIFEEDPERSON(_to) \
  ...
  NS_IMETHOD SetEmail(const nsAString & aEmail) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetEmail(aEmail); } \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsFeedPerson, nsIFeedPerson)
