...
#define NS_DECL_NSISTREAMINGPROTOCOLMETADATA \
  ...
  NS_IMETHOD GetTotalTracks(uint32_t *aTotalTracks) override; \
  NS_IMETHOD SetTotalTracks(uint32_t aTotalTracks) override; \
  NS_IMETHOD GetMimeType(nsACString & aMimeType) override; \
  NS_IMETHOD SetMimeType(const nsACString & aMimeType) override; \
  ...
  NS_IMETHOD GetSampleRate(uint32_t *aSampleRate) override; \
  NS_IMETHOD SetSampleRate(uint32_t aSampleRate) override; \
  NS_IMETHOD GetTimeStamp(uint64_t *aTimeStamp) override; \
  NS_IMETHOD SetTimeStamp(uint64_t aTimeStamp) override; \
  NS_IMETHOD GetChannelCount(uint32_t *aChannelCount) override; \
  NS_IMETHOD SetChannelCount(uint32_t aChannelCount) override; \
  NS_IMETHOD GetEsdsData(nsACString & aEsdsData) override; \
  NS_IMETHOD SetEsdsData(const nsACString & aEsdsData) override; \
  NS_IMETHOD GetAvccData(nsACString & aAvccData) override; \
  NS_IMETHOD SetAvccData(const nsACString & aAvccData) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSISTREAMINGPROTOCOLMETADATA \
  NS_METHOD GetFrameType(uint32_t *aFrameType); \
  NS_METHOD SetFrameType(uint32_t aFrameType); \
  NS_METHOD GetTotalTracks(uint32_t *aTotalTracks); \
  NS_METHOD SetTotalTracks(uint32_t aTotalTracks); \
  NS_METHOD GetMimeType(nsACString & aMimeType); \
  NS_METHOD SetMimeType(const nsACString & aMimeType); \
  ...
  NS_METHOD GetSampleRate(uint32_t *aSampleRate); \
  NS_METHOD SetSampleRate(uint32_t aSampleRate); \
  NS_METHOD GetTimeStamp(uint64_t *aTimeStamp); \
  NS_METHOD SetTimeStamp(uint64_t aTimeStamp); \
  NS_METHOD GetChannelCount(uint32_t *aChannelCount); \
  NS_METHOD SetChannelCount(uint32_t aChannelCount); \
  NS_METHOD GetEsdsData(nsACString & aEsdsData); \
  NS_METHOD SetEsdsData(const nsACString & aEsdsData); \
  NS_METHOD GetAvccData(nsACString & aAvccData); \
  NS_METHOD SetAvccData(const nsACString & aAvccData); 
...
#define NS_FORWARD_NSISTREAMINGPROTOCOLMETADATA(_to) \
  ...
  NS_IMETHOD GetTotalTracks(uint32_t *aTotalTracks) override { return _to GetTotalTracks(aTotalTracks); } \
  NS_IMETHOD SetTotalTracks(uint32_t aTotalTracks) override { return _to SetTotalTracks(aTotalTracks); } \
  NS_IMETHOD GetMimeType(nsACString & aMimeType) override { return _to GetMimeType(aMimeType); } \
  NS_IMETHOD SetMimeType(const nsACString & aMimeType) override { return _to SetMimeType(aMimeType); } \
  ...
  NS_IMETHOD GetSampleRate(uint32_t *aSampleRate) override { return _to GetSampleRate(aSampleRate); } \
  NS_IMETHOD SetSampleRate(uint32_t aSampleRate) override { return _to SetSampleRate(aSampleRate); } \
  NS_IMETHOD GetTimeStamp(uint64_t *aTimeStamp) override { return _to GetTimeStamp(aTimeStamp); } \
  NS_IMETHOD SetTimeStamp(uint64_t aTimeStamp) override { return _to SetTimeStamp(aTimeStamp); } \
  NS_IMETHOD GetChannelCount(uint32_t *aChannelCount) override { return _to GetChannelCount(aChannelCount); } \
  NS_IMETHOD SetChannelCount(uint32_t aChannelCount) override { return _to SetChannelCount(aChannelCount); } \
  NS_IMETHOD GetEsdsData(nsACString & aEsdsData) override { return _to GetEsdsData(aEsdsData); } \
  NS_IMETHOD SetEsdsData(const nsACString & aEsdsData) override { return _to SetEsdsData(aEsdsData); } \
  NS_IMETHOD GetAvccData(nsACString & aAvccData) override { return _to GetAvccData(aAvccData); } \
  NS_IMETHOD SetAvccData(const nsACString & aAvccData) override { return _to SetAvccData(aAvccData); } 
...
#define NS_FORWARD_SAFE_NSISTREAMINGPROTOCOLMETADATA(_to) \
  ...
  NS_IMETHOD GetTotalTracks(uint32_t *aTotalTracks) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTotalTracks(aTotalTracks); } \
  NS_IMETHOD SetTotalTracks(uint32_t aTotalTracks) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTotalTracks(aTotalTracks); } \
  NS_IMETHOD GetMimeType(nsACString & aMimeType) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMimeType(aMimeType); } \
  NS_IMETHOD SetMimeType(const nsACString & aMimeType) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMimeType(aMimeType); } \
  ...
  NS_IMETHOD GetSampleRate(uint32_t *aSampleRate) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSampleRate(aSampleRate); } \
  NS_IMETHOD SetSampleRate(uint32_t aSampleRate) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSampleRate(aSampleRate); } \
  NS_IMETHOD GetTimeStamp(uint64_t *aTimeStamp) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTimeStamp(aTimeStamp); } \
  NS_IMETHOD SetTimeStamp(uint64_t aTimeStamp) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTimeStamp(aTimeStamp); } \
  NS_IMETHOD GetChannelCount(uint32_t *aChannelCount) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetChannelCount(aChannelCount); } \
  NS_IMETHOD SetChannelCount(uint32_t aChannelCount) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetChannelCount(aChannelCount); } \
  NS_IMETHOD GetEsdsData(nsACString & aEsdsData) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEsdsData(aEsdsData); } \
  NS_IMETHOD SetEsdsData(const nsACString & aEsdsData) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetEsdsData(aEsdsData); } \
  NS_IMETHOD GetAvccData(nsACString & aAvccData) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAvccData(aAvccData); } \
  NS_IMETHOD SetAvccData(const nsACString & aAvccData) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAvccData(aAvccData); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsStreamingProtocolMetaData, nsIStreamingProtocolMetaData)
...
#define NS_DECL_NSISTREAMINGPROTOCOLLISTENER \
  NS_IMETHOD OnMediaDataAvailable(uint8_t index, const nsACString & data, uint32_t length, uint32_t offset, nsIStreamingProtocolMetaData *meta) override; \
  NS_IMETHOD OnConnected(uint8_t index, nsIStreamingProtocolMetaData *meta) override; \
  NS_IMETHOD OnDisconnected(uint8_t index, nsresult reason) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSISTREAMINGPROTOCOLLISTENER \
  NS_METHOD OnMediaDataAvailable(uint8_t index, const nsACString & data, uint32_t length, uint32_t offset, nsIStreamingProtocolMetaData *meta); \
  NS_METHOD OnConnected(uint8_t index, nsIStreamingProtocolMetaData *meta); \
  NS_METHOD OnDisconnected(uint8_t index, nsresult reason); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISTREAMINGPROTOCOLLISTENER(_to) \
  NS_IMETHOD OnMediaDataAvailable(uint8_t index, const nsACString & data, uint32_t length, uint32_t offset, nsIStreamingProtocolMetaData *meta) override { return _to OnMediaDataAvailable(index, data, length, offset, meta); } \
  NS_IMETHOD OnConnected(uint8_t index, nsIStreamingProtocolMetaData *meta) override { return _to OnConnected(index, meta); } \
  NS_IMETHOD OnDisconnected(uint8_t index, nsresult reason) override { return _to OnDisconnected(index, reason); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISTREAMINGPROTOCOLLISTENER(_to) \
  NS_IMETHOD OnMediaDataAvailable(uint8_t index, const nsACString & data, uint32_t length, uint32_t offset, nsIStreamingProtocolMetaData *meta) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnMediaDataAvailable(index, data, length, offset, meta); } \
  NS_IMETHOD OnConnected(uint8_t index, nsIStreamingProtocolMetaData *meta) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnConnected(index, meta); } \
  NS_IMETHOD OnDisconnected(uint8_t index, nsresult reason) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnDisconnected(index, reason); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsStreamingProtocolListener, nsIStreamingProtocolListener)
...
#define NS_ISTREAMINGPROTOCOLCONTROLLER_IID_STR "4ce040f0-c50d-461f-94e2-af5a77fe13a5"

#define NS_ISTREAMINGPROTOCOLCONTROLLER_IID \
  {0x4ce040f0, 0xc50d, 0x461f, \
...
class NS_NO_VTABLE nsIStreamingProtocolController : public nsISupports {
 public:
  ...
  /* void playbackEnded (); */
  NS_IMETHOD PlaybackEnded(void) = 0;
...
#define NS_DECL_NSISTREAMINGPROTOCOLCONTROLLER \
  NS_IMETHOD Init(nsIURI *aUri) override; \
  NS_IMETHOD AsyncOpen(nsIStreamingProtocolListener *aListener) override; \
  NS_IMETHOD GetTrackMetaData(uint8_t index, nsIStreamingProtocolMetaData * *_retval) override; \
  ...
  NS_IMETHOD Seek(uint64_t seekTimeUs) override; \
  NS_IMETHOD Stop(void) override; \
  NS_IMETHOD PlaybackEnded(void) override; \
  NS_IMETHOD GetTotalTracks(uint8_t *aTotalTracks) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSISTREAMINGPROTOCOLCONTROLLER \
  NS_METHOD Init(nsIURI *aUri); \
  NS_METHOD AsyncOpen(nsIStreamingProtocolListener *aListener); \
  NS_METHOD GetTrackMetaData(uint8_t index, nsIStreamingProtocolMetaData * *_retval); \
  NS_METHOD Play(void); \
  NS_METHOD Pause(void); \
  NS_METHOD Resume(void); \
  NS_METHOD Suspend(void); \
  NS_METHOD Seek(uint64_t seekTimeUs); \
  NS_METHOD Stop(void); \
  NS_METHOD PlaybackEnded(void); \
  NS_METHOD GetTotalTracks(uint8_t *aTotalTracks); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISTREAMINGPROTOCOLCONTROLLER(_to) \
  NS_IMETHOD Init(nsIURI *aUri) override { return _to Init(aUri); } \
  NS_IMETHOD AsyncOpen(nsIStreamingProtocolListener *aListener) override { return _to AsyncOpen(aListener); } \
  NS_IMETHOD GetTrackMetaData(uint8_t index, nsIStreamingProtocolMetaData * *_retval) override { return _to GetTrackMetaData(index, _retval); } \
  ...
  NS_IMETHOD Seek(uint64_t seekTimeUs) override { return _to Seek(seekTimeUs); } \
  NS_IMETHOD Stop(void) override { return _to Stop(); } \
  NS_IMETHOD PlaybackEnded(void) override { return _to PlaybackEnded(); } \
  NS_IMETHOD GetTotalTracks(uint8_t *aTotalTracks) override { return _to GetTotalTracks(aTotalTracks); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISTREAMINGPROTOCOLCONTROLLER(_to) \
  NS_IMETHOD Init(nsIURI *aUri) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(aUri); } \
  NS_IMETHOD AsyncOpen(nsIStreamingProtocolListener *aListener) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AsyncOpen(aListener); } \
  NS_IMETHOD GetTrackMetaData(uint8_t index, nsIStreamingProtocolMetaData * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTrackMetaData(index, _retval); } \
  ...
  NS_IMETHOD Seek(uint64_t seekTimeUs) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Seek(seekTimeUs); } \
  NS_IMETHOD Stop(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Stop(); } \
  NS_IMETHOD PlaybackEnded(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->PlaybackEnded(); } \
  NS_IMETHOD GetTotalTracks(uint8_t *aTotalTracks) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTotalTracks(aTotalTracks); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsStreamingProtocolController, nsIStreamingProtocolController)
...
/* void playbackEnded (); */
NS_IMETHODIMP nsStreamingProtocolController::PlaybackEnded()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
