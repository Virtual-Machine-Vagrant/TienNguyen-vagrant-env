...
#define NS_DECL_NON_VIRTUAL_NSIACCESSIBLEVALUE \
  NS_METHOD GetMaximumValue(double *aMaximumValue); \
  NS_METHOD GetMinimumValue(double *aMinimumValue); \
  NS_METHOD GetCurrentValue(double *aCurrentValue); \
  NS_METHOD SetCurrentValue(double aCurrentValue); \
  NS_METHOD GetMinimumIncrement(double *aMinimumIncrement); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsAccessibleValue, nsIAccessibleValue)
