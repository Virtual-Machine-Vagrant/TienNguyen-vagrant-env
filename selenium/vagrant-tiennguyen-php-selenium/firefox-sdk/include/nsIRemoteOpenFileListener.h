/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM ../../../dist/idl/nsIRemoteOpenFileListener.idl
 */
...
#define NS_DECL_NSIREMOTEOPENFILELISTENER \
  NS_IMETHOD OnRemoteFileOpenComplete(nsresult aOpenStatus) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIREMOTEOPENFILELISTENER \
  NS_METHOD OnRemoteFileOpenComplete(nsresult aOpenStatus); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIREMOTEOPENFILELISTENER(_to) \
  NS_IMETHOD OnRemoteFileOpenComplete(nsresult aOpenStatus) override { return _to OnRemoteFileOpenComplete(aOpenStatus); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIREMOTEOPENFILELISTENER(_to) \
  NS_IMETHOD OnRemoteFileOpenComplete(nsresult aOpenStatus) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnRemoteFileOpenComplete(aOpenStatus); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsRemoteOpenFileListener, nsIRemoteOpenFileListener)
