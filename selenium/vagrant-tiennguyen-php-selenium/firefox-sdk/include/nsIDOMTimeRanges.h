...
#define NS_DECL_NSIDOMTIMERANGES \
  ...
  NS_IMETHOD Start(uint32_t index, double *_retval) override; \
  NS_IMETHOD End(uint32_t index, double *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMTIMERANGES \
  NS_METHOD GetLength(uint32_t *aLength); \
  NS_METHOD Start(uint32_t index, double *_retval); \
  NS_METHOD End(uint32_t index, double *_retval); 
...
#define NS_FORWARD_NSIDOMTIMERANGES(_to) \
  ...
  NS_IMETHOD Start(uint32_t index, double *_retval) override { return _to Start(index, _retval); } \
  NS_IMETHOD End(uint32_t index, double *_retval) override { return _to End(index, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMTIMERANGES(_to) \
  ...
  NS_IMETHOD Start(uint32_t index, double *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Start(index, _retval); } \
  NS_IMETHOD End(uint32_t index, double *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->End(index, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMTimeRanges, nsIDOMTimeRanges)
