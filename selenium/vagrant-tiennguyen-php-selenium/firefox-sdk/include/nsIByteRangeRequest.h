...
#define NS_DECL_NON_VIRTUAL_NSIBYTERANGEREQUEST \
  NS_METHOD GetIsByteRangeRequest(bool *aIsByteRangeRequest); \
  NS_METHOD GetStartRange(int64_t *aStartRange); \
  NS_METHOD GetEndRange(int64_t *aEndRange); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsByteRangeRequest, nsIByteRangeRequest)
