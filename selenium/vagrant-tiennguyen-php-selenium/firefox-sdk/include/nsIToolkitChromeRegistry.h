...
#define NS_DECL_NSITOOLKITCHROMEREGISTRY \
  NS_IMETHOD CheckForOSAccessibility(void) override; \
...
#define NS_DECL_NON_VIRTUAL_NSITOOLKITCHROMEREGISTRY \
  NS_METHOD CheckForOSAccessibility(void); \
  NS_METHOD GetLocalesForPackage(const nsACString & aPackage, nsIUTF8StringEnumerator * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITOOLKITCHROMEREGISTRY(_to) \
  NS_IMETHOD CheckForOSAccessibility(void) override { return _to CheckForOSAccessibility(); } \
...
#define NS_FORWARD_SAFE_NSITOOLKITCHROMEREGISTRY(_to) \
  NS_IMETHOD CheckForOSAccessibility(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->CheckForOSAccessibility(); } \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsToolkitChromeRegistry, nsIToolkitChromeRegistry)
