...
#define NS_DECL_NON_VIRTUAL_NSIPKCS11 \
  NS_METHOD DeleteModule(const nsAString & moduleName); \
  NS_METHOD AddModule(const nsAString & moduleName, const nsAString & libraryFullPath, int32_t cryptoMechanismFlags, int32_t cipherFlags); 
