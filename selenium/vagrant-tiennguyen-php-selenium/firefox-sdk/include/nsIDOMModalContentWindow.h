...
#define NS_DECL_NSIDOMMODALCONTENTWINDOW \
  NS_IMETHOD GetDialogArguments(nsIVariant * *aDialogArguments) override; \
  NS_IMETHOD GetReturnValue(nsIVariant * *aReturnValue) override; \
  NS_IMETHOD SetReturnValue(nsIVariant *aReturnValue) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMMODALCONTENTWINDOW \
  NS_METHOD GetDialogArguments(nsIVariant * *aDialogArguments); \
  NS_METHOD GetReturnValue(nsIVariant * *aReturnValue); \
  NS_METHOD SetReturnValue(nsIVariant *aReturnValue); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMMODALCONTENTWINDOW(_to) \
  NS_IMETHOD GetDialogArguments(nsIVariant * *aDialogArguments) override { return _to GetDialogArguments(aDialogArguments); } \
  NS_IMETHOD GetReturnValue(nsIVariant * *aReturnValue) override { return _to GetReturnValue(aReturnValue); } \
  NS_IMETHOD SetReturnValue(nsIVariant *aReturnValue) override { return _to SetReturnValue(aReturnValue); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMMODALCONTENTWINDOW(_to) \
  NS_IMETHOD GetDialogArguments(nsIVariant * *aDialogArguments) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDialogArguments(aDialogArguments); } \
  NS_IMETHOD GetReturnValue(nsIVariant * *aReturnValue) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetReturnValue(aReturnValue); } \
  NS_IMETHOD SetReturnValue(nsIVariant *aReturnValue) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetReturnValue(aReturnValue); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMModalContentWindow, nsIDOMModalContentWindow)
