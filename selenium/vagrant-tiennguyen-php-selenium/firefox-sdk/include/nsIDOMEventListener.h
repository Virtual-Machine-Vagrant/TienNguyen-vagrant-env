...
#define NS_DECL_NON_VIRTUAL_NSIDOMEVENTLISTENER \
  NS_METHOD HandleEvent(nsIDOMEvent *event); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMEVENTLISTENER(_to) \
  NS_IMETHOD HandleEvent(nsIDOMEvent *event) override { return _to HandleEvent(event); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMEVENTLISTENER(_to) \
  NS_IMETHOD HandleEvent(nsIDOMEvent *event) override { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleEvent(event); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMEventListener, nsIDOMEventListener)
