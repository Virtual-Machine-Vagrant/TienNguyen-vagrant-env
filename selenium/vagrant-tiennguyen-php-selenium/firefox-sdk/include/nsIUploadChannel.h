...
#define NS_DECL_NON_VIRTUAL_NSIUPLOADCHANNEL \
  NS_METHOD SetUploadStream(nsIInputStream *aStream, const nsACString & aContentType, int64_t aContentLength); \
  NS_METHOD GetUploadStream(nsIInputStream * *aUploadStream); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsUploadChannel, nsIUploadChannel)
