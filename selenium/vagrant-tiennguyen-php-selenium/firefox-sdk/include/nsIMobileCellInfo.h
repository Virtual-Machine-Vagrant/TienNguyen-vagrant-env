...
#define NS_DECL_NON_VIRTUAL_NSIMOBILECELLINFO \
  NS_METHOD GetGsmLocationAreaCode(int32_t *aGsmLocationAreaCode); \
  NS_METHOD GetGsmCellId(int64_t *aGsmCellId); \
  NS_METHOD GetCdmaBaseStationId(int32_t *aCdmaBaseStationId); \
  NS_METHOD GetCdmaBaseStationLatitude(int32_t *aCdmaBaseStationLatitude); \
  NS_METHOD GetCdmaBaseStationLongitude(int32_t *aCdmaBaseStationLongitude); \
  NS_METHOD GetCdmaSystemId(int32_t *aCdmaSystemId); \
  NS_METHOD GetCdmaNetworkId(int32_t *aCdmaNetworkId); 
