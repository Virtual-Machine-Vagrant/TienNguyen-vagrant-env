/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM ../../../dist/idl/nsIUDPSocketFilter.idl
 */
...
#define NS_DECL_NON_VIRTUAL_NSIUDPSOCKETFILTER \
  NS_METHOD FilterPacket(const mozilla::net::NetAddr *remote_addr, const uint8_t *data, uint32_t len, int32_t direction, bool *_retval); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsUDPSocketFilter, nsIUDPSocketFilter)
...
#define NS_DECL_NSIUDPSOCKETFILTERHANDLER \
  NS_IMETHOD NewFilter(nsIUDPSocketFilter * *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIUDPSOCKETFILTERHANDLER \
  NS_METHOD NewFilter(nsIUDPSocketFilter * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIUDPSOCKETFILTERHANDLER(_to) \
  NS_IMETHOD NewFilter(nsIUDPSocketFilter * *_retval) override { return _to NewFilter(_retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIUDPSOCKETFILTERHANDLER(_to) \
  NS_IMETHOD NewFilter(nsIUDPSocketFilter * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->NewFilter(_retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsUDPSocketFilterHandler, nsIUDPSocketFilterHandler)
