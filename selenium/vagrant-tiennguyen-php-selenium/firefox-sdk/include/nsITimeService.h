...
#define NS_DECL_NSITIMESERVICE \
  NS_IMETHOD Set(int64_t aTimeInMS) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSITIMESERVICE \
  NS_METHOD Set(int64_t aTimeInMS); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITIMESERVICE(_to) \
  NS_IMETHOD Set(int64_t aTimeInMS) override { return _to Set(aTimeInMS); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITIMESERVICE(_to) \
  NS_IMETHOD Set(int64_t aTimeInMS) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Set(aTimeInMS); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsTimeService, nsITimeService)
