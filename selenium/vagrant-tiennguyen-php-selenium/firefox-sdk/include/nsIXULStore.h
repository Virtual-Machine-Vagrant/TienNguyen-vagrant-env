...
#define NS_DECL_NON_VIRTUAL_NSIXULSTORE \
  NS_METHOD SetValue(const nsAString & doc, const nsAString & id, const nsAString & attr, const nsAString & value); \
  NS_METHOD HasValue(const nsAString & doc, const nsAString & id, const nsAString & attr, bool *_retval); \
  NS_METHOD GetValue(const nsAString & doc, const nsAString & id, const nsAString & attr, nsAString & _retval); \
  NS_METHOD RemoveValue(const nsAString & doc, const nsAString & id, const nsAString & attr); \
  NS_METHOD GetIDsEnumerator(const nsAString & doc, nsIStringEnumerator * *_retval); \
  NS_METHOD GetAttributeEnumerator(const nsAString & doc, const nsAString & id, nsIStringEnumerator * *_retval); 
