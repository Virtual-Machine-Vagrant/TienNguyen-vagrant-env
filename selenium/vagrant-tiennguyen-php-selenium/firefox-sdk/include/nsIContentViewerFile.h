...
#define NS_DECL_NSICONTENTVIEWERFILE \
  NS_IMETHOD GetPrintable(bool *aPrintable) override; \
  NS_IMETHOD Print(bool aSilent, FILE *aDebugFile, nsIPrintSettings *aPrintSettings) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSICONTENTVIEWERFILE \
  NS_METHOD GetPrintable(bool *aPrintable); \
  NS_METHOD Print(bool aSilent, FILE *aDebugFile, nsIPrintSettings *aPrintSettings); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICONTENTVIEWERFILE(_to) \
  NS_IMETHOD GetPrintable(bool *aPrintable) override { return _to GetPrintable(aPrintable); } \
  NS_IMETHOD Print(bool aSilent, FILE *aDebugFile, nsIPrintSettings *aPrintSettings) override { return _to Print(aSilent, aDebugFile, aPrintSettings); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICONTENTVIEWERFILE(_to) \
  NS_IMETHOD GetPrintable(bool *aPrintable) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrintable(aPrintable); } \
  NS_IMETHOD Print(bool aSilent, FILE *aDebugFile, nsIPrintSettings *aPrintSettings) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Print(aSilent, aDebugFile, aPrintSettings); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsContentViewerFile, nsIContentViewerFile)
