...
#define NS_DECL_NON_VIRTUAL_NSIDOMXULELEMENT \
  ...
  NS_METHOD GetFlex(nsAString & aFlex); \
  NS_METHOD SetFlex(const nsAString & aFlex); \
  NS_METHOD GetFlexGroup(nsAString & aFlexGroup); \
  NS_METHOD SetFlexGroup(const nsAString & aFlexGroup); \
  NS_METHOD GetOrdinal(nsAString & aOrdinal); \
  NS_METHOD SetOrdinal(const nsAString & aOrdinal); \
  NS_METHOD GetOrient(nsAString & aOrient); \
  NS_METHOD SetOrient(const nsAString & aOrient); \
  NS_METHOD GetPack(nsAString & aPack); \
  NS_METHOD SetPack(const nsAString & aPack); \
  NS_METHOD GetHidden(bool *aHidden); \
  NS_METHOD SetHidden(bool aHidden); \
  NS_METHOD GetCollapsed(bool *aCollapsed); \
  NS_METHOD SetCollapsed(bool aCollapsed); \
  NS_METHOD GetObserves(nsAString & aObserves); \
  NS_METHOD SetObserves(const nsAString & aObserves); \
  NS_METHOD GetMenu(nsAString & aMenu); \
  NS_METHOD SetMenu(const nsAString & aMenu); \
  NS_METHOD GetContextMenu(nsAString & aContextMenu); \
  NS_METHOD SetContextMenu(const nsAString & aContextMenu); \
  ...
  NS_METHOD GetMinWidth(nsAString & aMinWidth); \
  NS_METHOD SetMinWidth(const nsAString & aMinWidth); \
  NS_METHOD GetMinHeight(nsAString & aMinHeight); \
  NS_METHOD SetMinHeight(const nsAString & aMinHeight); \
  NS_METHOD GetMaxWidth(nsAString & aMaxWidth); \
  NS_METHOD SetMaxWidth(const nsAString & aMaxWidth); \
  NS_METHOD GetMaxHeight(nsAString & aMaxHeight); \
  NS_METHOD SetMaxHeight(const nsAString & aMaxHeight); \
  NS_METHOD GetPersist(nsAString & aPersist); \
  NS_METHOD SetPersist(const nsAString & aPersist); \
  NS_METHOD GetLeft(nsAString & aLeft); \
  NS_METHOD SetLeft(const nsAString & aLeft); \
  NS_METHOD GetTop(nsAString & aTop); \
  NS_METHOD SetTop(const nsAString & aTop); \
  NS_METHOD GetDatasources(nsAString & aDatasources); \
  NS_METHOD SetDatasources(const nsAString & aDatasources); \
  NS_METHOD GetRef(nsAString & aRef); \
  NS_METHOD SetRef(const nsAString & aRef); \
  NS_METHOD GetTooltipText(nsAString & aTooltipText); \
  NS_METHOD SetTooltipText(const nsAString & aTooltipText); \
  NS_METHOD GetStatusText(nsAString & aStatusText); \
  NS_METHOD SetStatusText(const nsAString & aStatusText); \
  NS_METHOD GetAllowEvents(bool *aAllowEvents); \
  NS_METHOD SetAllowEvents(bool aAllowEvents); \
  NS_METHOD GetDatabase(nsIRDFCompositeDataSource * *aDatabase); \
  NS_METHOD GetBuilder(nsIXULTemplateBuilder * *aBuilder); \
  NS_METHOD GetResource(nsIRDFResource * *aResource); \
  NS_METHOD GetControllers(nsIControllers * *aControllers); \
  NS_METHOD GetBoxObject(nsIBoxObject * *aBoxObject); \
  NS_METHOD Focus(void); \
  NS_METHOD Blur(void); \
  NS_METHOD Click(void); \
  NS_METHOD DoCommand(void); \
