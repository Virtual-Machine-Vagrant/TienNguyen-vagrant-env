...
#define NS_DECL_NON_VIRTUAL_NSIAUTHPROMPTCALLBACK \
  NS_METHOD OnAuthAvailable(nsISupports *aContext, nsIAuthInformation *aAuthInfo); \
  NS_METHOD OnAuthCancelled(nsISupports *aContext, bool userCancel); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsAuthPromptCallback, nsIAuthPromptCallback)
