...
#define NS_DECL_NON_VIRTUAL_NSIDOMHTMLMETAELEMENT \
  NS_METHOD GetContent(nsAString & aContent); \
  NS_METHOD SetContent(const nsAString & aContent); \
  NS_METHOD GetHttpEquiv(nsAString & aHttpEquiv); \
  NS_METHOD SetHttpEquiv(const nsAString & aHttpEquiv); \
  NS_METHOD GetName(nsAString & aName); \
  NS_METHOD SetName(const nsAString & aName); \
  NS_METHOD GetScheme(nsAString & aScheme); \
  NS_METHOD SetScheme(const nsAString & aScheme); 
