...
#define NS_DECL_NON_VIRTUAL_NSIAPPLICATIONCACHECONTAINER \
  NS_METHOD GetApplicationCache(nsIApplicationCache * *aApplicationCache); \
  NS_METHOD SetApplicationCache(nsIApplicationCache *aApplicationCache); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsApplicationCacheContainer, nsIApplicationCacheContainer)
