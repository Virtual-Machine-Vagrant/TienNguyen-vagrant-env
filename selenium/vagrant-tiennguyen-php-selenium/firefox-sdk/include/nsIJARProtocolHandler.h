...
#define NS_DECL_NSIJARPROTOCOLHANDLER \
  NS_IMETHOD GetJARCache(nsIZipReaderCache * *aJARCache) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIJARPROTOCOLHANDLER \
  NS_METHOD GetJARCache(nsIZipReaderCache * *aJARCache); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIJARPROTOCOLHANDLER(_to) \
  NS_IMETHOD GetJARCache(nsIZipReaderCache * *aJARCache) override { return _to GetJARCache(aJARCache); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIJARPROTOCOLHANDLER(_to) \
  NS_IMETHOD GetJARCache(nsIZipReaderCache * *aJARCache) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetJARCache(aJARCache); } 
