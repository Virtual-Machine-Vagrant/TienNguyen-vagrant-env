...
#define NS_DECL_NSITRACEABLECHANNEL \
  NS_IMETHOD SetNewListener(nsIStreamListener *aListener, nsIStreamListener * *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSITRACEABLECHANNEL \
  NS_METHOD SetNewListener(nsIStreamListener *aListener, nsIStreamListener * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITRACEABLECHANNEL(_to) \
  NS_IMETHOD SetNewListener(nsIStreamListener *aListener, nsIStreamListener * *_retval) override { return _to SetNewListener(aListener, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITRACEABLECHANNEL(_to) \
  NS_IMETHOD SetNewListener(nsIStreamListener *aListener, nsIStreamListener * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetNewListener(aListener, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsTraceableChannel, nsITraceableChannel)
