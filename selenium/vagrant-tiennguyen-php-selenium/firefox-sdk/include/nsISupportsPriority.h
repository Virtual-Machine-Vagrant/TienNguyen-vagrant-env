...
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSPRIORITY \
  NS_METHOD GetPriority(int32_t *aPriority); \
  NS_METHOD SetPriority(int32_t aPriority); \
  NS_METHOD AdjustPriority(int32_t delta); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsSupportsPriority, nsISupportsPriority)
