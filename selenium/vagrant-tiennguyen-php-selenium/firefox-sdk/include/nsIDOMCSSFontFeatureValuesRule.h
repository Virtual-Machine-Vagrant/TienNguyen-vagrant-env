...
#define NS_DECL_NON_VIRTUAL_NSIDOMCSSFONTFEATUREVALUESRULE \
  NS_METHOD GetFontFamily(nsAString & aFontFamily); \
  NS_METHOD SetFontFamily(const nsAString & aFontFamily); \
  NS_METHOD GetValueText(nsAString & aValueText); \
  NS_METHOD SetValueText(const nsAString & aValueText); 
