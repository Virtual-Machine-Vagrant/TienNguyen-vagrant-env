...
#define NS_DECL_NON_VIRTUAL_NSPIEDITORTRANSACTION \
  NS_METHOD GetTxnDescription(nsAString & aTxnDescription); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSPIEDITORTRANSACTION(_to) \
  NS_IMETHOD GetTxnDescription(nsAString & aTxnDescription) override { return _to GetTxnDescription(aTxnDescription); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSPIEDITORTRANSACTION(_to) \
  NS_IMETHOD GetTxnDescription(nsAString & aTxnDescription) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTxnDescription(aTxnDescription); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(_MYCLASS_, nsPIEditorTransaction)
