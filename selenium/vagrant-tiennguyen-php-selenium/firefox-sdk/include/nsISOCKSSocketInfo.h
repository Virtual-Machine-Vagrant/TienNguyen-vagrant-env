...
#define NS_DECL_NON_VIRTUAL_NSISOCKSSOCKETINFO \
  NS_METHOD GetDestinationAddr(mozilla::net::NetAddr **aDestinationAddr); \
  NS_METHOD SetDestinationAddr(mozilla::net::NetAddr *aDestinationAddr); \
  NS_METHOD GetExternalProxyAddr(mozilla::net::NetAddr **aExternalProxyAddr); \
  NS_METHOD SetExternalProxyAddr(mozilla::net::NetAddr *aExternalProxyAddr); \
  NS_METHOD GetInternalProxyAddr(mozilla::net::NetAddr **aInternalProxyAddr); \
  NS_METHOD SetInternalProxyAddr(mozilla::net::NetAddr *aInternalProxyAddr); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsSOCKSSocketInfo, nsISOCKSSocketInfo)
