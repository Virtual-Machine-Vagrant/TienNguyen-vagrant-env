...
#define NS_DECL_NSIAUTOCONFIG \
  NS_IMETHOD GetConfigURL(char * *aConfigURL) override; \
  NS_IMETHOD SetConfigURL(const char * aConfigURL) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIAUTOCONFIG \
  NS_METHOD GetConfigURL(char * *aConfigURL); \
  NS_METHOD SetConfigURL(const char * aConfigURL); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIAUTOCONFIG(_to) \
  NS_IMETHOD GetConfigURL(char * *aConfigURL) override { return _to GetConfigURL(aConfigURL); } \
  NS_IMETHOD SetConfigURL(const char * aConfigURL) override { return _to SetConfigURL(aConfigURL); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIAUTOCONFIG(_to) \
  NS_IMETHOD GetConfigURL(char * *aConfigURL) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetConfigURL(aConfigURL); } \
  NS_IMETHOD SetConfigURL(const char * aConfigURL) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetConfigURL(aConfigURL); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsAutoConfig, nsIAutoConfig)
