...
#define NS_DECL_TXIXPATHOBJECT \
  NS_IMETHOD_(txAExprResult *) GetResult(void) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_TXIXPATHOBJECT \
  NS_METHOD_(txAExprResult *) GetResult(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_TXIXPATHOBJECT(_to) \
  NS_IMETHOD_(txAExprResult *) GetResult(void) override { return _to GetResult(); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(txXPathObject, txIXPathObject)
