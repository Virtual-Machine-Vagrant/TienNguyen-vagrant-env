...
#define NS_DECL_NSICLIPBOARD \
  ...
  NS_IMETHOD HasDataMatchingFlavors(const char * *aFlavorList, uint32_t aLength, int32_t aWhichClipboard, bool *_retval) override; \
...
#define NS_DECL_NON_VIRTUAL_NSICLIPBOARD \
  NS_METHOD SetData(nsITransferable *aTransferable, nsIClipboardOwner *anOwner, int32_t aWhichClipboard); \
  NS_METHOD GetData(nsITransferable *aTransferable, int32_t aWhichClipboard); \
  NS_METHOD EmptyClipboard(int32_t aWhichClipboard); \
  NS_METHOD HasDataMatchingFlavors(const char * *aFlavorList, uint32_t aLength, int32_t aWhichClipboard, bool *_retval); \
  NS_METHOD SupportsSelectionClipboard(bool *_retval); \
  NS_METHOD SupportsFindClipboard(bool *_retval); 
...
#define NS_FORWARD_NSICLIPBOARD(_to) \
  ...
  NS_IMETHOD HasDataMatchingFlavors(const char * *aFlavorList, uint32_t aLength, int32_t aWhichClipboard, bool *_retval) override { return _to HasDataMatchingFlavors(aFlavorList, aLength, aWhichClipboard, _retval); } \
...
#define NS_FORWARD_SAFE_NSICLIPBOARD(_to) \
  ...
  NS_IMETHOD HasDataMatchingFlavors(const char * *aFlavorList, uint32_t aLength, int32_t aWhichClipboard, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->HasDataMatchingFlavors(aFlavorList, aLength, aWhichClipboard, _retval); } \
