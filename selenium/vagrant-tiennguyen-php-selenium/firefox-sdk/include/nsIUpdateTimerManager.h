...
#define NS_DECL_NSIUPDATETIMERMANAGER \
  NS_IMETHOD RegisterTimer(const nsAString & id, nsITimerCallback *callback, uint32_t interval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIUPDATETIMERMANAGER \
  NS_METHOD RegisterTimer(const nsAString & id, nsITimerCallback *callback, uint32_t interval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIUPDATETIMERMANAGER(_to) \
  NS_IMETHOD RegisterTimer(const nsAString & id, nsITimerCallback *callback, uint32_t interval) override { return _to RegisterTimer(id, callback, interval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIUPDATETIMERMANAGER(_to) \
  NS_IMETHOD RegisterTimer(const nsAString & id, nsITimerCallback *callback, uint32_t interval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->RegisterTimer(id, callback, interval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsUpdateTimerManager, nsIUpdateTimerManager)
