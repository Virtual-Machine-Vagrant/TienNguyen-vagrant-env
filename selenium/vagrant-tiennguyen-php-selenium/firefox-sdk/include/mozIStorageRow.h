...
#define NS_DECL_NON_VIRTUAL_MOZISTORAGEROW \
  NS_METHOD GetResultByIndex(uint32_t aIndex, nsIVariant * *_retval); \
  NS_METHOD GetResultByName(const nsACString & aName, nsIVariant * *_retval); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(_MYCLASS_, mozIStorageRow)
