...
#define NS_DECL_NON_VIRTUAL_NSINAVHISTORYOBSERVER \
  ...
  NS_METHOD OnVisit(nsIURI *aURI, int64_t aVisitID, PRTime aTime, int64_t aSessionID, int64_t aReferringID, uint32_t aTransitionType, const nsACString & aGUID, bool aHidden); \
