...
#define NS_DECL_NSIRDFNODE \
  NS_IMETHOD EqualsNode(nsIRDFNode *aNode, bool *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIRDFNODE \
  NS_METHOD EqualsNode(nsIRDFNode *aNode, bool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIRDFNODE(_to) \
  NS_IMETHOD EqualsNode(nsIRDFNode *aNode, bool *_retval) override { return _to EqualsNode(aNode, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIRDFNODE(_to) \
  NS_IMETHOD EqualsNode(nsIRDFNode *aNode, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->EqualsNode(aNode, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsRDFNode, nsIRDFNode)
