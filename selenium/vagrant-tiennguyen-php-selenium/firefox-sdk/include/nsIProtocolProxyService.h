...
class NS_NO_VTABLE nsIProtocolProxyService : public nsISupports {
 public:
  ...
  NS_IMETHOD NewProxyInfoWithAuth(const nsACString & aType, const nsACString & aHost, int32_t aPort, const nsACString & aUsername, const nsACString & aPassword, uint32_t aFlags, uint32_t aFailoverTimeout, nsIProxyInfo *aFailoverProxy, nsIProxyInfo * *_retval) = 0;
...
#define NS_DECL_NSIPROTOCOLPROXYSERVICE \
  ...
  NS_IMETHOD NewProxyInfoWithAuth(const nsACString & aType, const nsACString & aHost, int32_t aPort, const nsACString & aUsername, const nsACString & aPassword, uint32_t aFlags, uint32_t aFailoverTimeout, nsIProxyInfo *aFailoverProxy, nsIProxyInfo * *_retval) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIPROTOCOLPROXYSERVICE \
  NS_METHOD AsyncResolve(nsISupports *aChannelOrURI, uint32_t aFlags, nsIProtocolProxyCallback *aCallback, nsICancelable * *_retval); \
  NS_METHOD NewProxyInfo(const nsACString & aType, const nsACString & aHost, int32_t aPort, uint32_t aFlags, uint32_t aFailoverTimeout, nsIProxyInfo *aFailoverProxy, nsIProxyInfo * *_retval); \
  NS_METHOD NewProxyInfoWithAuth(const nsACString & aType, const nsACString & aHost, int32_t aPort, const nsACString & aUsername, const nsACString & aPassword, uint32_t aFlags, uint32_t aFailoverTimeout, nsIProxyInfo *aFailoverProxy, nsIProxyInfo * *_retval); \
  NS_METHOD GetFailoverForProxy(nsIProxyInfo *aProxyInfo, nsIURI *aURI, nsresult aReason, nsIProxyInfo * *_retval); \
  NS_METHOD RegisterFilter(nsIProtocolProxyFilter *aFilter, uint32_t aPosition); \
  NS_METHOD RegisterChannelFilter(nsIProtocolProxyChannelFilter *aFilter, uint32_t aPosition); \
  NS_METHOD UnregisterFilter(nsIProtocolProxyFilter *aFilter); \
  NS_METHOD UnregisterChannelFilter(nsIProtocolProxyChannelFilter *aFilter); \
  NS_METHOD GetProxyConfigType(uint32_t *aProxyConfigType); 
...
#define NS_FORWARD_NSIPROTOCOLPROXYSERVICE(_to) \
  ...
  NS_IMETHOD NewProxyInfoWithAuth(const nsACString & aType, const nsACString & aHost, int32_t aPort, const nsACString & aUsername, const nsACString & aPassword, uint32_t aFlags, uint32_t aFailoverTimeout, nsIProxyInfo *aFailoverProxy, nsIProxyInfo * *_retval) override { return _to NewProxyInfoWithAuth(aType, aHost, aPort, aUsername, aPassword, aFlags, aFailoverTimeout, aFailoverProxy, _retval); } \
...
/* nsIProxyInfo newProxyInfoWithAuth (in ACString aType, in AUTF8String aHost, in long aPort, in ACString aUsername, in ACString aPassword, in unsigned long aFlags, in unsigned long aFailoverTimeout, in nsIProxyInfo aFailoverProxy); */
NS_IMETHODIMP nsProtocolProxyService::NewProxyInfoWithAuth(const nsACString & aType, const nsACString & aHost, int32_t aPort, const nsACString & aUsername, const nsACString & aPassword, uint32_t aFlags, uint32_t aFailoverTimeout, nsIProxyInfo *aFailoverProxy, nsIProxyInfo * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
