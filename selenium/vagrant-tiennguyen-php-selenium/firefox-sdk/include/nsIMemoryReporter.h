...
class NS_NO_VTABLE nsIMemoryReporterManager : public nsISupports {
 public:
  ...
  NS_IMETHOD GetHeapOverheadFraction(int64_t *aHeapOverheadFraction) = 0;
  ...
  /* void sizeOfTab (in mozIDOMWindowProxy window, out int64_t jsObjectsSize, out int64_t jsStringsSize, out int64_t jsOtherSize, out int64_t domSize, out int64_t styleSize, out int64_t otherSize, out int64_t totalSize, out double jsMilliseconds, out double nonJSMilliseconds); */
  NS_IMETHOD SizeOfTab(mozIDOMWindowProxy *window, int64_t *jsObjectsSize, int64_t *jsStringsSize, int64_t *jsOtherSize, int64_t *domSize, int64_t *styleSize, int64_t *otherSize, int64_t *totalSize, double *jsMilliseconds, double *nonJSMilliseconds) = 0;
...
#define NS_DECL_NSIMEMORYREPORTERMANAGER \
  ...
  NS_IMETHOD GetHeapOverheadFraction(int64_t *aHeapOverheadFraction) override; \
  ...
  NS_IMETHOD SizeOfTab(mozIDOMWindowProxy *window, int64_t *jsObjectsSize, int64_t *jsStringsSize, int64_t *jsOtherSize, int64_t *domSize, int64_t *styleSize, int64_t *otherSize, int64_t *totalSize, double *jsMilliseconds, double *nonJSMilliseconds) override; 
...
#define NS_DECL_NON_VIRTUAL_NSIMEMORYREPORTERMANAGER \
  ...
  NS_METHOD GetVsize(int64_t *aVsize); \
  NS_METHOD GetVsizeMaxContiguous(int64_t *aVsizeMaxContiguous); \
  NS_METHOD GetResident(int64_t *aResident); \
  NS_METHOD GetResidentFast(int64_t *aResidentFast); \
  NS_METHOD GetResidentPeak(int64_t *aResidentPeak); \
  NS_METHOD GetResidentUnique(int64_t *aResidentUnique); \
  NS_METHOD GetHeapAllocated(int64_t *aHeapAllocated); \
  NS_METHOD GetHeapOverheadFraction(int64_t *aHeapOverheadFraction); \
  NS_METHOD GetJSMainRuntimeGCHeap(int64_t *aJSMainRuntimeGCHeap); \
  NS_METHOD GetJSMainRuntimeTemporaryPeak(int64_t *aJSMainRuntimeTemporaryPeak); \
  NS_METHOD GetJSMainRuntimeCompartmentsSystem(int64_t *aJSMainRuntimeCompartmentsSystem); \
  NS_METHOD GetJSMainRuntimeCompartmentsUser(int64_t *aJSMainRuntimeCompartmentsUser); \
  NS_METHOD GetImagesContentUsedUncompressed(int64_t *aImagesContentUsedUncompressed); \
  NS_METHOD GetStorageSQLite(int64_t *aStorageSQLite); \
  NS_METHOD GetLowMemoryEventsVirtual(int64_t *aLowMemoryEventsVirtual); \
  NS_METHOD GetLowMemoryEventsPhysical(int64_t *aLowMemoryEventsPhysical); \
  NS_METHOD GetGhostWindows(int64_t *aGhostWindows); \
  NS_METHOD GetPageFaultsHard(int64_t *aPageFaultsHard); \
  using nsIMemoryReporterManager::GetHasMozMallocUsableSize; \
  ...
  NS_METHOD MinimizeMemoryUsage(nsIRunnable *callback); \
  NS_METHOD SizeOfTab(mozIDOMWindowProxy *window, int64_t *jsObjectsSize, int64_t *jsStringsSize, int64_t *jsOtherSize, int64_t *domSize, int64_t *styleSize, int64_t *otherSize, int64_t *totalSize, double *jsMilliseconds, double *nonJSMilliseconds); 
...
#define NS_FORWARD_NSIMEMORYREPORTERMANAGER(_to) \
  ...
  NS_IMETHOD GetHeapOverheadFraction(int64_t *aHeapOverheadFraction) override { return _to GetHeapOverheadFraction(aHeapOverheadFraction); } \
  ...
  NS_IMETHOD SizeOfTab(mozIDOMWindowProxy *window, int64_t *jsObjectsSize, int64_t *jsStringsSize, int64_t *jsOtherSize, int64_t *domSize, int64_t *styleSize, int64_t *otherSize, int64_t *totalSize, double *jsMilliseconds, double *nonJSMilliseconds) override { return _to SizeOfTab(window, jsObjectsSize, jsStringsSize, jsOtherSize, domSize, styleSize, otherSize, totalSize, jsMilliseconds, nonJSMilliseconds); } 
...
#define NS_FORWARD_SAFE_NSIMEMORYREPORTERMANAGER(_to) \
  ...
  NS_IMETHOD GetHeapOverheadFraction(int64_t *aHeapOverheadFraction) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHeapOverheadFraction(aHeapOverheadFraction); } \
  ...
  NS_IMETHOD SizeOfTab(mozIDOMWindowProxy *window, int64_t *jsObjectsSize, int64_t *jsStringsSize, int64_t *jsOtherSize, int64_t *domSize, int64_t *styleSize, int64_t *otherSize, int64_t *totalSize, double *jsMilliseconds, double *nonJSMilliseconds) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SizeOfTab(window, jsObjectsSize, jsStringsSize, jsOtherSize, domSize, styleSize, otherSize, totalSize, jsMilliseconds, nonJSMilliseconds); } 
...
/* readonly attribute int64_t heapOverheadFraction; */
NS_IMETHODIMP nsMemoryReporterManager::GetHeapOverheadFraction(int64_t *aHeapOverheadFraction)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void sizeOfTab (in mozIDOMWindowProxy window, out int64_t jsObjectsSize, out int64_t jsStringsSize, out int64_t jsOtherSize, out int64_t domSize, out int64_t styleSize, out int64_t otherSize, out int64_t totalSize, out double jsMilliseconds, out double nonJSMilliseconds); */
NS_IMETHODIMP nsMemoryReporterManager::SizeOfTab(mozIDOMWindowProxy *window, int64_t *jsObjectsSize, int64_t *jsStringsSize, int64_t *jsOtherSize, int64_t *domSize, int64_t *styleSize, int64_t *otherSize, int64_t *totalSize, double *jsMilliseconds, double *nonJSMilliseconds)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
