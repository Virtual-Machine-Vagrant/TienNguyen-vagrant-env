...
#define NS_DECL_NSIGLOBALHISTORY2 \
  NS_IMETHOD AddURI(nsIURI *aURI, bool aRedirect, bool aToplevel, nsIURI *aReferrer) override; \
  NS_IMETHOD IsVisited(nsIURI *aURI, bool *_retval) override; \
  NS_IMETHOD SetPageTitle(nsIURI *aURI, const nsAString & aTitle) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIGLOBALHISTORY2 \
  NS_METHOD AddURI(nsIURI *aURI, bool aRedirect, bool aToplevel, nsIURI *aReferrer); \
  NS_METHOD IsVisited(nsIURI *aURI, bool *_retval); \
  NS_METHOD SetPageTitle(nsIURI *aURI, const nsAString & aTitle); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIGLOBALHISTORY2(_to) \
  NS_IMETHOD AddURI(nsIURI *aURI, bool aRedirect, bool aToplevel, nsIURI *aReferrer) override { return _to AddURI(aURI, aRedirect, aToplevel, aReferrer); } \
  NS_IMETHOD IsVisited(nsIURI *aURI, bool *_retval) override { return _to IsVisited(aURI, _retval); } \
  NS_IMETHOD SetPageTitle(nsIURI *aURI, const nsAString & aTitle) override { return _to SetPageTitle(aURI, aTitle); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIGLOBALHISTORY2(_to) \
  NS_IMETHOD AddURI(nsIURI *aURI, bool aRedirect, bool aToplevel, nsIURI *aReferrer) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AddURI(aURI, aRedirect, aToplevel, aReferrer); } \
  NS_IMETHOD IsVisited(nsIURI *aURI, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->IsVisited(aURI, _retval); } \
  NS_IMETHOD SetPageTitle(nsIURI *aURI, const nsAString & aTitle) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPageTitle(aURI, aTitle); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsGlobalHistory2, nsIGlobalHistory2)
