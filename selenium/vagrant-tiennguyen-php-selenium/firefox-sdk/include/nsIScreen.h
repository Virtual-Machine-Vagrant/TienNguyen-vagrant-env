...
#define NS_DECL_NON_VIRTUAL_NSISCREEN \
  ...
  NS_METHOD GetRect(int32_t *left, int32_t *top, int32_t *width, int32_t *height); \
  NS_METHOD GetAvailRect(int32_t *left, int32_t *top, int32_t *width, int32_t *height); \
  NS_METHOD GetRectDisplayPix(int32_t *left, int32_t *top, int32_t *width, int32_t *height); \
  NS_METHOD GetAvailRectDisplayPix(int32_t *left, int32_t *top, int32_t *width, int32_t *height); \
  NS_METHOD LockMinimumBrightness(uint32_t brightness); \
  NS_METHOD UnlockMinimumBrightness(uint32_t brightness); \
  NS_METHOD GetPixelDepth(int32_t *aPixelDepth); \
  NS_METHOD GetColorDepth(int32_t *aColorDepth); \
  NS_METHOD GetRotation(uint32_t *aRotation); \
  NS_METHOD SetRotation(uint32_t aRotation); \
  NS_METHOD GetContentsScaleFactor(double *aContentsScaleFactor); \
  NS_METHOD GetDefaultCSSScaleFactor(double *aDefaultCSSScaleFactor); 
...
/* readonly attribute double defaultCSSScaleFactor; */
NS_IMETHODIMP nsScreen::GetDefaultCSSScaleFactor(double *aDefaultCSSScaleFactor)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
