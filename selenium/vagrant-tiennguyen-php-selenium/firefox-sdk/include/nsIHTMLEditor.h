...
#define NS_DECL_NSIHTMLEDITOR \
  ...
  NS_IMETHOD GetLinkedObjects(nsISupportsArray * *_retval) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIHTMLEDITOR \
  ...
  NS_METHOD GetLinkedObjects(nsISupportsArray * *_retval); \
...
#define NS_FORWARD_NSIHTMLEDITOR(_to) \
  ...
  NS_IMETHOD GetLinkedObjects(nsISupportsArray * *_retval) override { return _to GetLinkedObjects(_retval); } \
...
#define NS_FORWARD_SAFE_NSIHTMLEDITOR(_to) \
  ...
  NS_IMETHOD GetLinkedObjects(nsISupportsArray * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLinkedObjects(_retval); } \
