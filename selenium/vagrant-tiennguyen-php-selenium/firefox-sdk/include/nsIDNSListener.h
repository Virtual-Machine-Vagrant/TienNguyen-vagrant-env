...
#define NS_DECL_NON_VIRTUAL_NSIDNSLISTENER \
  NS_METHOD OnLookupComplete(nsICancelable *aRequest, nsIDNSRecord *aRecord, nsresult aStatus); 
...
/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDNSLISTENERPROXY \
  NS_METHOD GetOriginalListener(nsIDNSListener * *aOriginalListener); 
