...
#define NS_DECL_NSIRDFXMLSOURCE \
  NS_IMETHOD Serialize(nsIOutputStream *aStream) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIRDFXMLSOURCE \
  NS_METHOD Serialize(nsIOutputStream *aStream); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIRDFXMLSOURCE(_to) \
  NS_IMETHOD Serialize(nsIOutputStream *aStream) override { return _to Serialize(aStream); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIRDFXMLSOURCE(_to) \
  NS_IMETHOD Serialize(nsIOutputStream *aStream) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Serialize(aStream); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsRDFXMLSource, nsIRDFXMLSource)
