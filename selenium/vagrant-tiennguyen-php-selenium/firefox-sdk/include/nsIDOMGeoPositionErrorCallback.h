...
#define NS_DECL_NSIDOMGEOPOSITIONERRORCALLBACK \
  NS_IMETHOD HandleEvent(nsIDOMGeoPositionError *positionError) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMGEOPOSITIONERRORCALLBACK \
  NS_METHOD HandleEvent(nsIDOMGeoPositionError *positionError); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMGEOPOSITIONERRORCALLBACK(_to) \
  NS_IMETHOD HandleEvent(nsIDOMGeoPositionError *positionError) override { return _to HandleEvent(positionError); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMGEOPOSITIONERRORCALLBACK(_to) \
  NS_IMETHOD HandleEvent(nsIDOMGeoPositionError *positionError) override { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleEvent(positionError); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMGeoPositionErrorCallback, nsIDOMGeoPositionErrorCallback)
