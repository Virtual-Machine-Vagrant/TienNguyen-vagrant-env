...
#define NS_DECL_NSIXBLACCESSIBLE \
  NS_IMETHOD GetAccessibleName(nsAString & aAccessibleName) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIXBLACCESSIBLE \
  NS_METHOD GetAccessibleName(nsAString & aAccessibleName); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXBLACCESSIBLE(_to) \
  NS_IMETHOD GetAccessibleName(nsAString & aAccessibleName) override { return _to GetAccessibleName(aAccessibleName); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXBLACCESSIBLE(_to) \
  NS_IMETHOD GetAccessibleName(nsAString & aAccessibleName) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAccessibleName(aAccessibleName); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsXBLAccessible, nsIXBLAccessible)
