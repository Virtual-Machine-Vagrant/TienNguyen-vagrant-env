...
#define NS_DECL_NON_VIRTUAL_NSIXULBUILDERLISTENER \
  NS_METHOD WillRebuild(nsIXULTemplateBuilder *aBuilder); \
  NS_METHOD DidRebuild(nsIXULTemplateBuilder *aBuilder); 
