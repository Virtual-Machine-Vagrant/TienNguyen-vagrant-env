...
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSID \
  NS_METHOD GetData(nsID **aData); \
  NS_METHOD SetData(const nsID *aData); \
  NS_METHOD ToString(char * *_retval); 
...
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSCSTRING \
  ...
  NS_METHOD SetData(const nsACString & aData); \
  NS_METHOD ToString(char * *_retval); 
...
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSSTRING \
  ...
  NS_METHOD ToString(char16_t * *_retval); 
...
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSPRBOOL \
  NS_METHOD GetData(bool *aData); \
  NS_METHOD SetData(bool aData); \
  NS_METHOD ToString(char * *_retval); 
...
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSPRUINT8 \
  NS_METHOD GetData(uint8_t *aData); \
  NS_METHOD SetData(uint8_t aData); \
  NS_METHOD ToString(char * *_retval); 
...
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSPRUINT16 \
  NS_METHOD GetData(uint16_t *aData); \
  NS_METHOD SetData(uint16_t aData); \
  NS_METHOD ToString(char * *_retval); 
...
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSPRUINT32 \
  NS_METHOD GetData(uint32_t *aData); \
  NS_METHOD SetData(uint32_t aData); \
  NS_METHOD ToString(char * *_retval); 
...
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSPRUINT64 \
  NS_METHOD GetData(uint64_t *aData); \
  NS_METHOD SetData(uint64_t aData); \
  NS_METHOD ToString(char * *_retval); 
...
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSPRTIME \
  NS_METHOD GetData(PRTime *aData); \
  NS_METHOD SetData(PRTime aData); \
  NS_METHOD ToString(char * *_retval); 
...
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSCHAR \
  NS_METHOD GetData(char *aData); \
  NS_METHOD SetData(char aData); \
  NS_METHOD ToString(char * *_retval); 
...
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSPRINT16 \
  NS_METHOD GetData(int16_t *aData); \
  NS_METHOD SetData(int16_t aData); \
  NS_METHOD ToString(char * *_retval); 
...
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSPRINT32 \
  NS_METHOD GetData(int32_t *aData); \
  NS_METHOD SetData(int32_t aData); \
  NS_METHOD ToString(char * *_retval); 
...
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSPRINT64 \
  NS_METHOD GetData(int64_t *aData); \
  NS_METHOD SetData(int64_t aData); \
  NS_METHOD ToString(char * *_retval); 
...
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSFLOAT \
  NS_METHOD GetData(float *aData); \
  NS_METHOD SetData(float aData); \
  NS_METHOD ToString(char * *_retval); 
...
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSDOUBLE \
  NS_METHOD GetData(double *aData); \
  NS_METHOD SetData(double aData); \
  NS_METHOD ToString(char * *_retval); 
...
/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSVOID \
  NS_METHOD GetData(void **aData); \
  NS_METHOD SetData(void *aData); \
  NS_METHOD ToString(char * *_retval); 
...
#define NS_DECL_NON_VIRTUAL_NSISUPPORTSINTERFACEPOINTER \
  ...
  NS_METHOD SetData(nsISupports *aData); \
  NS_METHOD GetDataIID(nsID **aDataIID); \
  NS_METHOD SetDataIID(const nsID *aDataIID); \
  NS_METHOD ToString(char * *_retval); 
