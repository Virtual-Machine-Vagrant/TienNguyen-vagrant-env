/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM ../../../dist/idl/nsIHTMLObjectResizeListener.idl
 */
...
#define NS_DECL_NON_VIRTUAL_NSIHTMLOBJECTRESIZELISTENER \
  NS_METHOD OnStartResizing(nsIDOMElement *aElement); \
  NS_METHOD OnEndResizing(nsIDOMElement *aElement, int32_t aOldWidth, int32_t aOldHeight, int32_t aNewWidth, int32_t aNewHeight); 
