...
#define NS_DECL_NSIDOMXULLABELELEMENT \
  ...
  NS_IMETHOD GetControl(nsAString & aControl) override; \
  NS_IMETHOD SetControl(const nsAString & aControl) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMXULLABELELEMENT \
  NS_METHOD GetAccessKey(nsAString & aAccessKey); \
  NS_METHOD SetAccessKey(const nsAString & aAccessKey); \
  NS_METHOD GetControl(nsAString & aControl); \
  NS_METHOD SetControl(const nsAString & aControl); 
...
#define NS_FORWARD_NSIDOMXULLABELELEMENT(_to) \
  ...
  NS_IMETHOD GetControl(nsAString & aControl) override { return _to GetControl(aControl); } \
  NS_IMETHOD SetControl(const nsAString & aControl) override { return _to SetControl(aControl); } 
...
#define NS_FORWARD_SAFE_NSIDOMXULLABELELEMENT(_to) \
  ...
  NS_IMETHOD GetControl(nsAString & aControl) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetControl(aControl); } \
  NS_IMETHOD SetControl(const nsAString & aControl) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetControl(aControl); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMXULLabelElement, nsIDOMXULLabelElement)
