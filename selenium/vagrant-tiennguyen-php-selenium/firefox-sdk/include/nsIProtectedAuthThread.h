...
#define NS_DECL_NSIPROTECTEDAUTHTHREAD \
  NS_IMETHOD Login(nsIObserver *observer) override; \
  NS_IMETHOD GetSlot(nsIPKCS11Slot * *aSlot) override; \
  NS_IMETHOD GetTokenName(nsAString & _retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIPROTECTEDAUTHTHREAD \
  NS_METHOD Login(nsIObserver *observer); \
  NS_METHOD GetSlot(nsIPKCS11Slot * *aSlot); \
  NS_METHOD GetTokenName(nsAString & _retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPROTECTEDAUTHTHREAD(_to) \
  NS_IMETHOD Login(nsIObserver *observer) override { return _to Login(observer); } \
  NS_IMETHOD GetSlot(nsIPKCS11Slot * *aSlot) override { return _to GetSlot(aSlot); } \
  NS_IMETHOD GetTokenName(nsAString & _retval) override { return _to GetTokenName(_retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPROTECTEDAUTHTHREAD(_to) \
  NS_IMETHOD Login(nsIObserver *observer) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Login(observer); } \
  NS_IMETHOD GetSlot(nsIPKCS11Slot * *aSlot) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSlot(aSlot); } \
  NS_IMETHOD GetTokenName(nsAString & _retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTokenName(_retval); } 
