...
#define NS_DECL_NON_VIRTUAL_NSICONTENTSNIFFER \
  NS_METHOD GetMIMETypeFromContent(nsIRequest *aRequest, const uint8_t *aData, uint32_t aLength, nsACString & _retval); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsContentSniffer, nsIContentSniffer)
