...
#define NS_DECL_NSIKEYGENTHREAD \
  NS_IMETHOD StartKeyGeneration(nsIObserver *observer) override; \
  NS_IMETHOD UserCanceled(bool *threadAlreadyClosedDialog) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIKEYGENTHREAD \
  NS_METHOD StartKeyGeneration(nsIObserver *observer); \
  NS_METHOD UserCanceled(bool *threadAlreadyClosedDialog); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIKEYGENTHREAD(_to) \
  NS_IMETHOD StartKeyGeneration(nsIObserver *observer) override { return _to StartKeyGeneration(observer); } \
  NS_IMETHOD UserCanceled(bool *threadAlreadyClosedDialog) override { return _to UserCanceled(threadAlreadyClosedDialog); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIKEYGENTHREAD(_to) \
  NS_IMETHOD StartKeyGeneration(nsIObserver *observer) override { return !_to ? NS_ERROR_NULL_POINTER : _to->StartKeyGeneration(observer); } \
  NS_IMETHOD UserCanceled(bool *threadAlreadyClosedDialog) override { return !_to ? NS_ERROR_NULL_POINTER : _to->UserCanceled(threadAlreadyClosedDialog); } 
