...
#define NS_DECL_NON_VIRTUAL_NSIENCODEDCHANNEL \
  NS_METHOD GetContentEncodings(nsIUTF8StringEnumerator * *aContentEncodings); \
  NS_METHOD GetApplyConversion(bool *aApplyConversion); \
  NS_METHOD SetApplyConversion(bool aApplyConversion); \
  NS_METHOD DoApplyContentConversions(nsIStreamListener *aNextListener, nsIStreamListener * *aNewNextListener, nsISupports *aCtxt); 
