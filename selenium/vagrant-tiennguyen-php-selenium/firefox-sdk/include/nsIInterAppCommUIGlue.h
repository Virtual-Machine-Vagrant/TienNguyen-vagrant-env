...
#define NS_DECL_NON_VIRTUAL_NSIINTERAPPCOMMUIGLUE \
  NS_METHOD SelectApps(const nsAString & callerID, const nsAString & pubAppManifestURL, const nsAString & keyword, JS::HandleValue appsToSelect, JS::MutableHandleValue _retval); 
