...
#define NS_DECL_NSILOGININFO \
  ...
  NS_IMETHOD Init(const nsAString & aHostname, const nsAString & aFormSubmitURL, const nsAString & aHttpRealm, const nsAString & aUsername, const nsAString & aPassword, const nsAString & aUsernameField, const nsAString & aPasswordField) override; \
...
#define NS_DECL_NON_VIRTUAL_NSILOGININFO \
  ...
  NS_METHOD GetFormSubmitURL(nsAString & aFormSubmitURL); \
  NS_METHOD SetFormSubmitURL(const nsAString & aFormSubmitURL); \
  NS_METHOD GetHttpRealm(nsAString & aHttpRealm); \
  NS_METHOD SetHttpRealm(const nsAString & aHttpRealm); \
  NS_METHOD GetUsername(nsAString & aUsername); \
  NS_METHOD SetUsername(const nsAString & aUsername); \
  NS_METHOD GetUsernameField(nsAString & aUsernameField); \
  NS_METHOD SetUsernameField(const nsAString & aUsernameField); \
  NS_METHOD GetPassword(nsAString & aPassword); \
  NS_METHOD SetPassword(const nsAString & aPassword); \
  NS_METHOD GetPasswordField(nsAString & aPasswordField); \
  NS_METHOD SetPasswordField(const nsAString & aPasswordField); \
  NS_METHOD Init(const nsAString & aHostname, const nsAString & aFormSubmitURL, const nsAString & aHttpRealm, const nsAString & aUsername, const nsAString & aPassword, const nsAString & aUsernameField, const nsAString & aPasswordField); \
  NS_METHOD Equals(nsILoginInfo *aLoginInfo, bool *_retval); \
  NS_METHOD Matches(nsILoginInfo *aLoginInfo, bool ignorePassword, bool *_retval); \
  NS_METHOD Clone(nsILoginInfo * *_retval); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsLoginInfo, nsILoginInfo)
