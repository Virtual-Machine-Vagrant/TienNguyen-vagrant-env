...
#define NS_DECL_NON_VIRTUAL_NSIBUFFEREDINPUTSTREAM \
  NS_METHOD Init(nsIInputStream *fillFromStream, uint32_t bufferSize); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsBufferedInputStream, nsIBufferedInputStream)
...
#define NS_DECL_NON_VIRTUAL_NSIBUFFEREDOUTPUTSTREAM \
  NS_METHOD Init(nsIOutputStream *sinkToStream, uint32_t bufferSize); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsBufferedOutputStream, nsIBufferedOutputStream)
