...
#define NS_DECL_NON_VIRTUAL_NSIENVIRONMENT \
  NS_METHOD Set(const nsAString & aName, const nsAString & aValue); \
  NS_METHOD Get(const nsAString & aName, nsAString & _retval); \
  NS_METHOD Exists(const nsAString & aName, bool *_retval); 
