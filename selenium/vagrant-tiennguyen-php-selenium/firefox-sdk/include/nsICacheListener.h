...
#define NS_DECL_NSICACHELISTENER \
  NS_IMETHOD OnCacheEntryAvailable(nsICacheEntryDescriptor *descriptor, nsCacheAccessMode accessGranted, nsresult status) override; \
  NS_IMETHOD OnCacheEntryDoomed(nsresult status) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSICACHELISTENER \
  NS_METHOD OnCacheEntryAvailable(nsICacheEntryDescriptor *descriptor, nsCacheAccessMode accessGranted, nsresult status); \
  NS_METHOD OnCacheEntryDoomed(nsresult status); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICACHELISTENER(_to) \
  NS_IMETHOD OnCacheEntryAvailable(nsICacheEntryDescriptor *descriptor, nsCacheAccessMode accessGranted, nsresult status) override { return _to OnCacheEntryAvailable(descriptor, accessGranted, status); } \
  NS_IMETHOD OnCacheEntryDoomed(nsresult status) override { return _to OnCacheEntryDoomed(status); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICACHELISTENER(_to) \
  NS_IMETHOD OnCacheEntryAvailable(nsICacheEntryDescriptor *descriptor, nsCacheAccessMode accessGranted, nsresult status) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnCacheEntryAvailable(descriptor, accessGranted, status); } \
  NS_IMETHOD OnCacheEntryDoomed(nsresult status) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnCacheEntryDoomed(status); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsCacheListener, nsICacheListener)
