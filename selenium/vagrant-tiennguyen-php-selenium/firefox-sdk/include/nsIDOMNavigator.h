...
#define NS_DECL_NON_VIRTUAL_NSIDOMNAVIGATOR \
  NS_METHOD GetAppCodeName(nsAString & aAppCodeName); \
  NS_METHOD GetAppName(nsAString & aAppName); \
  NS_METHOD GetAppVersion(nsAString & aAppVersion); \
  NS_METHOD GetLanguage(nsAString & aLanguage); \
  NS_METHOD GetPlatform(nsAString & aPlatform); \
  NS_METHOD GetOscpu(nsAString & aOscpu); \
  NS_METHOD GetVendor(nsAString & aVendor); \
  NS_METHOD GetVendorSub(nsAString & aVendorSub); \
  NS_METHOD GetProduct(nsAString & aProduct); \
  NS_METHOD GetProductSub(nsAString & aProductSub); \
  NS_METHOD GetUserAgent(nsAString & aUserAgent); \
  NS_METHOD GetBuildID(nsAString & aBuildID); \
  NS_METHOD GetDoNotTrack(nsAString & aDoNotTrack); 
