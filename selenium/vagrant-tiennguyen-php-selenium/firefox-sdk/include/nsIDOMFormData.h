...
#define NS_DECL_NSIDOMFORMDATA \
  NS_IMETHOD Append(const nsAString & name, nsIVariant *value) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMFORMDATA \
  NS_METHOD Append(const nsAString & name, nsIVariant *value); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMFORMDATA(_to) \
  NS_IMETHOD Append(const nsAString & name, nsIVariant *value) override { return _to Append(name, value); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMFORMDATA(_to) \
  NS_IMETHOD Append(const nsAString & name, nsIVariant *value) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Append(name, value); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMFormData, nsIDOMFormData)
