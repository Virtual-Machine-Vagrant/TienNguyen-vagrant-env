...
#define NS_DECL_NON_VIRTUAL_NSIDOMCLIENTRECT \
  NS_METHOD GetLeft(float *aLeft); \
  NS_METHOD GetTop(float *aTop); \
  NS_METHOD GetRight(float *aRight); \
  NS_METHOD GetBottom(float *aBottom); \
  NS_METHOD GetWidth(float *aWidth); \
  NS_METHOD GetHeight(float *aHeight); 
