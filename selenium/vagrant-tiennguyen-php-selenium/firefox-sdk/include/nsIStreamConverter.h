...
#define NS_DECL_NON_VIRTUAL_NSISTREAMCONVERTER \
  NS_METHOD Convert(nsIInputStream *aFromStream, const char * aFromType, const char * aToType, nsISupports *aCtxt, nsIInputStream * *_retval); \
  NS_METHOD AsyncConvertData(const char * aFromType, const char * aToType, nsIStreamListener *aListener, nsISupports *aCtxt); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsStreamConverter, nsIStreamConverter)
