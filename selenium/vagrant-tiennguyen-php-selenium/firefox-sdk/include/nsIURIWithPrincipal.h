...
#define NS_DECL_NSIURIWITHPRINCIPAL \
  ...
  NS_IMETHOD GetPrincipalUri(nsIURI * *aPrincipalUri) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIURIWITHPRINCIPAL \
  NS_METHOD GetPrincipal(nsIPrincipal * *aPrincipal); \
  NS_METHOD GetPrincipalUri(nsIURI * *aPrincipalUri); 
...
#define NS_FORWARD_NSIURIWITHPRINCIPAL(_to) \
  ...
  NS_IMETHOD GetPrincipalUri(nsIURI * *aPrincipalUri) override { return _to GetPrincipalUri(aPrincipalUri); } 
...
#define NS_FORWARD_SAFE_NSIURIWITHPRINCIPAL(_to) \
  ...
  NS_IMETHOD GetPrincipalUri(nsIURI * *aPrincipalUri) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrincipalUri(aPrincipalUri); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsURIWithPrincipal, nsIURIWithPrincipal)
