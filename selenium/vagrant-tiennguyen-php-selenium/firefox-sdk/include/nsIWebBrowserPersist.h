...
class NS_NO_VTABLE nsIWebBrowserPersist : public nsICancelable {
 public:
  ...
  NS_IMETHOD SaveURI(nsIURI *aURI, nsISupports *aCacheKey, nsIURI *aReferrer, uint32_t aReferrerPolicy, nsIInputStream *aPostData, const char * aExtraHeaders, nsISupports *aFile, nsILoadContext *aPrivacyContext) = 0;
  ...
  NS_IMETHOD SavePrivacyAwareURI(nsIURI *aURI, nsISupports *aCacheKey, nsIURI *aReferrer, uint32_t aReferrerPolicy, nsIInputStream *aPostData, const char * aExtraHeaders, nsISupports *aFile, bool aIsPrivate) = 0;
  ...
  NS_IMETHOD SaveDocument(nsISupports *aDocument, nsISupports *aFile, nsISupports *aDataPath, const char * aOutputContentType, uint32_t aEncodingFlags, uint32_t aWrapColumn) = 0;
...
#define NS_DECL_NSIWEBBROWSERPERSIST \
  ...
  NS_IMETHOD SaveURI(nsIURI *aURI, nsISupports *aCacheKey, nsIURI *aReferrer, uint32_t aReferrerPolicy, nsIInputStream *aPostData, const char * aExtraHeaders, nsISupports *aFile, nsILoadContext *aPrivacyContext) override; \
  NS_IMETHOD SavePrivacyAwareURI(nsIURI *aURI, nsISupports *aCacheKey, nsIURI *aReferrer, uint32_t aReferrerPolicy, nsIInputStream *aPostData, const char * aExtraHeaders, nsISupports *aFile, bool aIsPrivate) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIWEBBROWSERPERSIST \
  ...
  NS_METHOD GetCurrentState(uint32_t *aCurrentState); \
  NS_METHOD GetResult(nsresult *aResult); \
  NS_METHOD GetProgressListener(nsIWebProgressListener * *aProgressListener); \
  NS_METHOD SetProgressListener(nsIWebProgressListener *aProgressListener); \
  NS_METHOD SaveURI(nsIURI *aURI, nsISupports *aCacheKey, nsIURI *aReferrer, uint32_t aReferrerPolicy, nsIInputStream *aPostData, const char * aExtraHeaders, nsISupports *aFile, nsILoadContext *aPrivacyContext); \
  NS_METHOD SavePrivacyAwareURI(nsIURI *aURI, nsISupports *aCacheKey, nsIURI *aReferrer, uint32_t aReferrerPolicy, nsIInputStream *aPostData, const char * aExtraHeaders, nsISupports *aFile, bool aIsPrivate); \
  NS_METHOD SaveChannel(nsIChannel *aChannel, nsISupports *aFile); \
  NS_METHOD SaveDocument(nsISupports *aDocument, nsISupports *aFile, nsISupports *aDataPath, const char * aOutputContentType, uint32_t aEncodingFlags, uint32_t aWrapColumn); \
  NS_METHOD CancelSave(void); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsWebBrowserPersist, nsIWebBrowserPersist)
...
/* void saveURI (in nsIURI aURI, in nsISupports aCacheKey, in nsIURI aReferrer, in unsigned long aReferrerPolicy, in nsIInputStream aPostData, in string aExtraHeaders, in nsISupports aFile, in nsILoadContext aPrivacyContext); */
NS_IMETHODIMP nsWebBrowserPersist::SaveURI(nsIURI *aURI, nsISupports *aCacheKey, nsIURI *aReferrer, uint32_t aReferrerPolicy, nsIInputStream *aPostData, const char * aExtraHeaders, nsISupports *aFile, nsILoadContext *aPrivacyContext)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void savePrivacyAwareURI (in nsIURI aURI, in nsISupports aCacheKey, in nsIURI aReferrer, in unsigned long aReferrerPolicy, in nsIInputStream aPostData, in string aExtraHeaders, in nsISupports aFile, in boolean aIsPrivate); */
NS_IMETHODIMP nsWebBrowserPersist::SavePrivacyAwareURI(nsIURI *aURI, nsISupports *aCacheKey, nsIURI *aReferrer, uint32_t aReferrerPolicy, nsIInputStream *aPostData, const char * aExtraHeaders, nsISupports *aFile, bool aIsPrivate)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void saveDocument (in nsISupports aDocument, in nsISupports aFile, in nsISupports aDataPath, in string aOutputContentType, in unsigned long aEncodingFlags, in unsigned long aWrapColumn); */
NS_IMETHODIMP nsWebBrowserPersist::SaveDocument(nsISupports *aDocument, nsISupports *aFile, nsISupports *aDataPath, const char * aOutputContentType, uint32_t aEncodingFlags, uint32_t aWrapColumn)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
