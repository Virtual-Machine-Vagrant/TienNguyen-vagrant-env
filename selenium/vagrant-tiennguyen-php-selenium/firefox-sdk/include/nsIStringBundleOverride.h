...
#define NS_DECL_NON_VIRTUAL_NSISTRINGBUNDLEOVERRIDE \
  NS_METHOD GetStringFromName(const nsACString & url, const nsACString & key, nsAString & _retval); \
  NS_METHOD EnumerateKeysInBundle(const nsACString & url, nsISimpleEnumerator * *_retval); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsStringBundleOverride, nsIStringBundleOverride)
