...
#define NS_DECL_NSIDOMHTMLSTYLEELEMENT \
  ...
  NS_IMETHOD GetScoped(bool *aScoped) override; \
  NS_IMETHOD SetScoped(bool aScoped) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMHTMLSTYLEELEMENT \
  NS_METHOD GetMozDisabled(bool *aDisabled); \
  NS_METHOD SetMozDisabled(bool aDisabled); \
  NS_METHOD GetMedia(nsAString & aMedia); \
  NS_METHOD SetMedia(const nsAString & aMedia); \
  NS_METHOD GetType(nsAString & aType); \
  NS_METHOD SetType(const nsAString & aType); \
  NS_METHOD GetScoped(bool *aScoped); \
  NS_METHOD SetScoped(bool aScoped); 
...
#define NS_FORWARD_NSIDOMHTMLSTYLEELEMENT(_to) \
  ...
  NS_IMETHOD GetScoped(bool *aScoped) override { return _to GetScoped(aScoped); } \
  NS_IMETHOD SetScoped(bool aScoped) override { return _to SetScoped(aScoped); } 
...
#define NS_FORWARD_SAFE_NSIDOMHTMLSTYLEELEMENT(_to) \
  ...
  NS_IMETHOD GetScoped(bool *aScoped) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetScoped(aScoped); } \
  NS_IMETHOD SetScoped(bool aScoped) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetScoped(aScoped); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMHTMLStyleElement, nsIDOMHTMLStyleElement)
