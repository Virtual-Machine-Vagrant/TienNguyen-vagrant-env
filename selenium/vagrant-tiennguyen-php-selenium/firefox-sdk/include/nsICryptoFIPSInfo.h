/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM ../../../dist/idl/nsICryptoFIPSInfo.idl
 */
...
#define NS_DECL_NSICRYPTOFIPSINFO \
  NS_IMETHOD GetIsFIPSModeActive(bool *aIsFIPSModeActive) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSICRYPTOFIPSINFO \
  NS_METHOD GetIsFIPSModeActive(bool *aIsFIPSModeActive); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICRYPTOFIPSINFO(_to) \
  NS_IMETHOD GetIsFIPSModeActive(bool *aIsFIPSModeActive) override { return _to GetIsFIPSModeActive(aIsFIPSModeActive); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICRYPTOFIPSINFO(_to) \
  NS_IMETHOD GetIsFIPSModeActive(bool *aIsFIPSModeActive) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsFIPSModeActive(aIsFIPSModeActive); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsCryptoFIPSInfo, nsICryptoFIPSInfo)
