...
#define NS_DECL_NSIMULTIPLEXINPUTSTREAM \
  ...
  NS_IMETHOD InsertStream(nsIInputStream *stream, uint32_t index) override; \
  NS_IMETHOD RemoveStream(uint32_t index) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIMULTIPLEXINPUTSTREAM \
  ...
  NS_METHOD AppendStream(nsIInputStream *stream); \
  NS_METHOD InsertStream(nsIInputStream *stream, uint32_t index); \
  NS_METHOD RemoveStream(uint32_t index); \
  NS_METHOD GetStream(uint32_t index, nsIInputStream * *_retval); 
...
#define NS_FORWARD_NSIMULTIPLEXINPUTSTREAM(_to) \
  ...
  NS_IMETHOD InsertStream(nsIInputStream *stream, uint32_t index) override { return _to InsertStream(stream, index); } \
  NS_IMETHOD RemoveStream(uint32_t index) override { return _to RemoveStream(index); } \
...
#define NS_FORWARD_SAFE_NSIMULTIPLEXINPUTSTREAM(_to) \
  ...
  NS_IMETHOD InsertStream(nsIInputStream *stream, uint32_t index) override { return !_to ? NS_ERROR_NULL_POINTER : _to->InsertStream(stream, index); } \
  NS_IMETHOD RemoveStream(uint32_t index) override { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveStream(index); } \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsMultiplexInputStream, nsIMultiplexInputStream)
