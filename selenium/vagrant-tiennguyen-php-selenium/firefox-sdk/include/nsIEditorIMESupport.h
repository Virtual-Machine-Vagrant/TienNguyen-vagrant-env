...
#define NS_DECL_NSIEDITORIMESUPPORT \
  ...
  NS_IMETHOD GetPreferredIMEState(mozilla::widget::IMEState *_retval) override; \
  NS_IMETHOD GetComposing(bool *aComposing) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIEDITORIMESUPPORT \
  NS_METHOD ForceCompositionEnd(void); \
  NS_METHOD GetPreferredIMEState(mozilla::widget::IMEState *_retval); \
  NS_METHOD GetComposing(bool *aComposing); 
...
#define NS_FORWARD_NSIEDITORIMESUPPORT(_to) \
  ...
  NS_IMETHOD GetPreferredIMEState(mozilla::widget::IMEState *_retval) override { return _to GetPreferredIMEState(_retval); } \
...
#define NS_FORWARD_SAFE_NSIEDITORIMESUPPORT(_to) \
  ...
  NS_IMETHOD GetPreferredIMEState(mozilla::widget::IMEState *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPreferredIMEState(_retval); } \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsEditorIMESupport, nsIEditorIMESupport)
