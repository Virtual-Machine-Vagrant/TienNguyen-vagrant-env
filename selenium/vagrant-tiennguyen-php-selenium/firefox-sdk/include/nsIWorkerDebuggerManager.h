...
#define NS_DECL_NON_VIRTUAL_NSIWORKERDEBUGGERMANAGERLISTENER \
  NS_METHOD OnRegister(nsIWorkerDebugger *debugger); \
  NS_METHOD OnUnregister(nsIWorkerDebugger *debugger); 
...
#define NS_DECL_NON_VIRTUAL_NSIWORKERDEBUGGERMANAGER \
  NS_METHOD GetWorkerDebuggerEnumerator(nsISimpleEnumerator * *_retval); \
  NS_METHOD AddListener(nsIWorkerDebuggerManagerListener *listener); \
  NS_METHOD RemoveListener(nsIWorkerDebuggerManagerListener *listener); 
