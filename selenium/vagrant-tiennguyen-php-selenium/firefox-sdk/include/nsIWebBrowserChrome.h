...
#define NS_DECL_NSIWEBBROWSERCHROME \
  NS_IMETHOD SetStatus(uint32_t statusType, const char16_t * status) override; \
  NS_IMETHOD GetWebBrowser(nsIWebBrowser * *aWebBrowser) override; \
  NS_IMETHOD SetWebBrowser(nsIWebBrowser *aWebBrowser) override; \
  NS_IMETHOD GetChromeFlags(uint32_t *aChromeFlags) override; \
  NS_IMETHOD SetChromeFlags(uint32_t aChromeFlags) override; \
  NS_IMETHOD DestroyBrowserWindow(void) override; \
  NS_IMETHOD SizeBrowserTo(int32_t aCX, int32_t aCY) override; \
  NS_IMETHOD ShowAsModal(void) override; \
  NS_IMETHOD IsWindowModal(bool *_retval) override; \
  NS_IMETHOD ExitModalEventLoop(nsresult aStatus) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIWEBBROWSERCHROME \
  NS_METHOD SetStatus(uint32_t statusType, const char16_t * status); \
  NS_METHOD GetWebBrowser(nsIWebBrowser * *aWebBrowser); \
  NS_METHOD SetWebBrowser(nsIWebBrowser *aWebBrowser); \
  NS_METHOD GetChromeFlags(uint32_t *aChromeFlags); \
  NS_METHOD SetChromeFlags(uint32_t aChromeFlags); \
  NS_METHOD DestroyBrowserWindow(void); \
  NS_METHOD SizeBrowserTo(int32_t aCX, int32_t aCY); \
  NS_METHOD ShowAsModal(void); \
  NS_METHOD IsWindowModal(bool *_retval); \
  NS_METHOD ExitModalEventLoop(nsresult aStatus); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWEBBROWSERCHROME(_to) \
  NS_IMETHOD SetStatus(uint32_t statusType, const char16_t * status) override { return _to SetStatus(statusType, status); } \
  NS_IMETHOD GetWebBrowser(nsIWebBrowser * *aWebBrowser) override { return _to GetWebBrowser(aWebBrowser); } \
  NS_IMETHOD SetWebBrowser(nsIWebBrowser *aWebBrowser) override { return _to SetWebBrowser(aWebBrowser); } \
  ...
  NS_IMETHOD DestroyBrowserWindow(void) override { return _to DestroyBrowserWindow(); } \
  NS_IMETHOD SizeBrowserTo(int32_t aCX, int32_t aCY) override { return _to SizeBrowserTo(aCX, aCY); } \
  ...
  NS_IMETHOD ExitModalEventLoop(nsresult aStatus) override { return _to ExitModalEventLoop(aStatus); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWEBBROWSERCHROME(_to) \
  NS_IMETHOD SetStatus(uint32_t statusType, const char16_t * status) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetStatus(statusType, status); } \
  NS_IMETHOD GetWebBrowser(nsIWebBrowser * *aWebBrowser) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetWebBrowser(aWebBrowser); } \
  NS_IMETHOD SetWebBrowser(nsIWebBrowser *aWebBrowser) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetWebBrowser(aWebBrowser); } \
  ...
  NS_IMETHOD DestroyBrowserWindow(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->DestroyBrowserWindow(); } \
  NS_IMETHOD SizeBrowserTo(int32_t aCX, int32_t aCY) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SizeBrowserTo(aCX, aCY); } \
  ...
  NS_IMETHOD ExitModalEventLoop(nsresult aStatus) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ExitModalEventLoop(aStatus); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsWebBrowserChrome, nsIWebBrowserChrome)
