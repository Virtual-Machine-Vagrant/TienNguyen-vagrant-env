...
#define NS_DECL_NON_VIRTUAL_NSISTREAMLISTENERTEE \
  NS_METHOD Init(nsIStreamListener *listener, nsIOutputStream *sink, nsIRequestObserver *requestObserver); \
  NS_METHOD InitAsync(nsIStreamListener *listener, nsIEventTarget *eventTarget, nsIOutputStream *sink, nsIRequestObserver *requestObserver); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsStreamListenerTee, nsIStreamListenerTee)
