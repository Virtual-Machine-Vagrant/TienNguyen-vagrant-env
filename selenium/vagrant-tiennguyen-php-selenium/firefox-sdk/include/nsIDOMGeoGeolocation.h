...
#define NS_DECL_NSIDOMGEOGEOLOCATION \
  NS_IMETHOD WatchPosition(nsIDOMGeoPositionCallback *callback, nsIDOMGeoPositionErrorCallback *errorCallback, mozilla::dom::PositionOptions *options, int32_t *_retval) override; \
  NS_IMETHOD GetCurrentPosition(nsIDOMGeoPositionCallback *callback, nsIDOMGeoPositionErrorCallback *errorCallback, mozilla::dom::PositionOptions *options) override; \
  NS_IMETHOD ClearWatch(int32_t watchId) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMGEOGEOLOCATION \
  NS_METHOD WatchPosition(nsIDOMGeoPositionCallback *callback, nsIDOMGeoPositionErrorCallback *errorCallback, mozilla::dom::PositionOptions *options, int32_t *_retval); \
  NS_METHOD GetCurrentPosition(nsIDOMGeoPositionCallback *callback, nsIDOMGeoPositionErrorCallback *errorCallback, mozilla::dom::PositionOptions *options); \
  NS_METHOD ClearWatch(int32_t watchId); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMGEOGEOLOCATION(_to) \
  NS_IMETHOD WatchPosition(nsIDOMGeoPositionCallback *callback, nsIDOMGeoPositionErrorCallback *errorCallback, mozilla::dom::PositionOptions *options, int32_t *_retval) override { return _to WatchPosition(callback, errorCallback, options, _retval); } \
  NS_IMETHOD GetCurrentPosition(nsIDOMGeoPositionCallback *callback, nsIDOMGeoPositionErrorCallback *errorCallback, mozilla::dom::PositionOptions *options) override { return _to GetCurrentPosition(callback, errorCallback, options); } \
  NS_IMETHOD ClearWatch(int32_t watchId) override { return _to ClearWatch(watchId); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMGEOGEOLOCATION(_to) \
  NS_IMETHOD WatchPosition(nsIDOMGeoPositionCallback *callback, nsIDOMGeoPositionErrorCallback *errorCallback, mozilla::dom::PositionOptions *options, int32_t *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->WatchPosition(callback, errorCallback, options, _retval); } \
  NS_IMETHOD GetCurrentPosition(nsIDOMGeoPositionCallback *callback, nsIDOMGeoPositionErrorCallback *errorCallback, mozilla::dom::PositionOptions *options) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCurrentPosition(callback, errorCallback, options); } \
  NS_IMETHOD ClearWatch(int32_t watchId) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ClearWatch(watchId); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMGeoGeolocation, nsIDOMGeoGeolocation)
