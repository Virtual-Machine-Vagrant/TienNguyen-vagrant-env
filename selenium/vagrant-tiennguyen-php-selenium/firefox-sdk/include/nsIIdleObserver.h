...
#define NS_DECL_NSIIDLEOBSERVER \
  NS_IMETHOD GetTime(uint32_t *aTime) override; \
  NS_IMETHOD Onidle(void) override; \
  NS_IMETHOD Onactive(void) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIIDLEOBSERVER \
  NS_METHOD GetTime(uint32_t *aTime); \
  NS_METHOD Onidle(void); \
  NS_METHOD Onactive(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIIDLEOBSERVER(_to) \
  NS_IMETHOD GetTime(uint32_t *aTime) override { return _to GetTime(aTime); } \
  NS_IMETHOD Onidle(void) override { return _to Onidle(); } \
  NS_IMETHOD Onactive(void) override { return _to Onactive(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIIDLEOBSERVER(_to) \
  NS_IMETHOD GetTime(uint32_t *aTime) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTime(aTime); } \
  NS_IMETHOD Onidle(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Onidle(); } \
  NS_IMETHOD Onactive(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Onactive(); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsIdleObserver, nsIIdleObserver)
