...
class NS_NO_VTABLE mozISpellI18NManager : public nsISupports {
 public:
  ...
  NS_IMETHOD GetUtil(const char16_t * language, mozISpellI18NUtil * *_retval) = 0;
...
#define NS_DECL_MOZISPELLI18NMANAGER \
  NS_IMETHOD GetUtil(const char16_t * language, mozISpellI18NUtil * *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_MOZISPELLI18NMANAGER \
  NS_METHOD GetUtil(const char16_t * language, mozISpellI18NUtil * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_MOZISPELLI18NMANAGER(_to) \
  NS_IMETHOD GetUtil(const char16_t * language, mozISpellI18NUtil * *_retval) override { return _to GetUtil(language, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_MOZISPELLI18NMANAGER(_to) \
  NS_IMETHOD GetUtil(const char16_t * language, mozISpellI18NUtil * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUtil(language, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(_MYCLASS_, mozISpellI18NManager)
...
/* mozISpellI18NUtil getUtil (in wstring language); */
NS_IMETHODIMP _MYCLASS_::GetUtil(const char16_t * language, mozISpellI18NUtil * *_retval)
{
