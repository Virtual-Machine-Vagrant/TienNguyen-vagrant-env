...
class NS_NO_VTABLE nsITreeColumn : public nsISupports {
 public:
  ...
  NS_IMETHOD GetIdConst(const char16_t * *idConst) = 0;
...
#define NS_DECL_NSITREECOLUMN \
  ...
  NS_IMETHOD GetIdConst(const char16_t * *idConst) override; \
  NS_IMETHOD GetAtom(nsIAtom * *aAtom) override; \
  NS_IMETHOD GetIndex(int32_t *aIndex) override; \
  NS_IMETHOD GetPrimary(bool *aPrimary) override; \
  NS_IMETHOD GetCycler(bool *aCycler) override; \
  NS_IMETHOD GetEditable(bool *aEditable) override; \
  NS_IMETHOD GetSelectable(bool *aSelectable) override; \
  NS_IMETHOD GetType(int16_t *aType) override; \
  NS_IMETHOD GetNext(nsITreeColumn * *_retval) override; \
  NS_IMETHOD GetPrevious(nsITreeColumn * *_retval) override; \
  NS_IMETHOD Invalidate(void) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSITREECOLUMN \
  NS_METHOD GetElement(nsIDOMElement * *aElement); \
  NS_METHOD GetColumns(nsITreeColumns * *aColumns); \
  NS_METHOD GetX(int32_t *aX); \
  NS_METHOD GetWidth(int32_t *aWidth); \
  NS_METHOD GetId(nsAString & aId); \
  NS_METHOD GetIdConst(const char16_t * *idConst); \
  NS_METHOD GetAtom(nsIAtom * *aAtom); \
  NS_METHOD GetIndex(int32_t *aIndex); \
  NS_METHOD GetPrimary(bool *aPrimary); \
  NS_METHOD GetCycler(bool *aCycler); \
  NS_METHOD GetEditable(bool *aEditable); \
  NS_METHOD GetSelectable(bool *aSelectable); \
  NS_METHOD GetType(int16_t *aType); \
  NS_METHOD GetNext(nsITreeColumn * *_retval); \
  NS_METHOD GetPrevious(nsITreeColumn * *_retval); \
...
#define NS_FORWARD_NSITREECOLUMN(_to) \
  ...
  NS_IMETHOD GetIdConst(const char16_t * *idConst) override { return _to GetIdConst(idConst); } \
  NS_IMETHOD GetAtom(nsIAtom * *aAtom) override { return _to GetAtom(aAtom); } \
  NS_IMETHOD GetIndex(int32_t *aIndex) override { return _to GetIndex(aIndex); } \
  NS_IMETHOD GetPrimary(bool *aPrimary) override { return _to GetPrimary(aPrimary); } \
  NS_IMETHOD GetCycler(bool *aCycler) override { return _to GetCycler(aCycler); } \
  NS_IMETHOD GetEditable(bool *aEditable) override { return _to GetEditable(aEditable); } \
  NS_IMETHOD GetSelectable(bool *aSelectable) override { return _to GetSelectable(aSelectable); } \
  NS_IMETHOD GetType(int16_t *aType) override { return _to GetType(aType); } \
  NS_IMETHOD GetNext(nsITreeColumn * *_retval) override { return _to GetNext(_retval); } \
  NS_IMETHOD GetPrevious(nsITreeColumn * *_retval) override { return _to GetPrevious(_retval); } \
...
#define NS_FORWARD_SAFE_NSITREECOLUMN(_to) \
  ...
  NS_IMETHOD GetIdConst(const char16_t * *idConst) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIdConst(idConst); } \
  NS_IMETHOD GetAtom(nsIAtom * *aAtom) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAtom(aAtom); } \
  NS_IMETHOD GetIndex(int32_t *aIndex) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIndex(aIndex); } \
  NS_IMETHOD GetPrimary(bool *aPrimary) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrimary(aPrimary); } \
  NS_IMETHOD GetCycler(bool *aCycler) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCycler(aCycler); } \
  NS_IMETHOD GetEditable(bool *aEditable) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEditable(aEditable); } \
  NS_IMETHOD GetSelectable(bool *aSelectable) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSelectable(aSelectable); } \
  NS_IMETHOD GetType(int16_t *aType) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetType(aType); } \
  NS_IMETHOD GetNext(nsITreeColumn * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNext(_retval); } \
  NS_IMETHOD GetPrevious(nsITreeColumn * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrevious(_retval); } \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsTreeColumn, nsITreeColumn)
...
/* [noscript] void getIdConst ([shared] out wstring idConst); */
NS_IMETHODIMP nsTreeColumn::GetIdConst(const char16_t * *idConst)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
#define NS_DECL_NSITREECOLUMNS \
  ...
  NS_IMETHOD GetFirstColumn(nsITreeColumn * *_retval) override; \
  NS_IMETHOD GetLastColumn(nsITreeColumn * *_retval) override; \
  NS_IMETHOD GetPrimaryColumn(nsITreeColumn * *_retval) override; \
  NS_IMETHOD GetSortedColumn(nsITreeColumn * *_retval) override; \
  NS_IMETHOD GetKeyColumn(nsITreeColumn * *_retval) override; \
  NS_IMETHOD GetColumnFor(nsIDOMElement *element, nsITreeColumn * *_retval) override; \
  NS_IMETHOD GetNamedColumn(const nsAString & id, nsITreeColumn * *_retval) override; \
  NS_IMETHOD GetColumnAt(int32_t index, nsITreeColumn * *_retval) override; \
  NS_IMETHOD InvalidateColumns(void) override; \
  NS_IMETHOD RestoreNaturalOrder(void) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSITREECOLUMNS \
  NS_METHOD GetTree(nsITreeBoxObject * *aTree); \
  NS_METHOD GetCount(int32_t *aCount); \
  NS_METHOD GetLength(int32_t *aLength); \
  NS_METHOD GetFirstColumn(nsITreeColumn * *_retval); \
  NS_METHOD GetLastColumn(nsITreeColumn * *_retval); \
  NS_METHOD GetPrimaryColumn(nsITreeColumn * *_retval); \
  NS_METHOD GetSortedColumn(nsITreeColumn * *_retval); \
  NS_METHOD GetKeyColumn(nsITreeColumn * *_retval); \
  NS_METHOD GetColumnFor(nsIDOMElement *element, nsITreeColumn * *_retval); \
  NS_METHOD GetNamedColumn(const nsAString & id, nsITreeColumn * *_retval); \
  NS_METHOD GetColumnAt(int32_t index, nsITreeColumn * *_retval); \
  NS_METHOD InvalidateColumns(void); \
  NS_METHOD RestoreNaturalOrder(void); 
...
#define NS_FORWARD_NSITREECOLUMNS(_to) \
  ...
  NS_IMETHOD GetFirstColumn(nsITreeColumn * *_retval) override { return _to GetFirstColumn(_retval); } \
  NS_IMETHOD GetLastColumn(nsITreeColumn * *_retval) override { return _to GetLastColumn(_retval); } \
  NS_IMETHOD GetPrimaryColumn(nsITreeColumn * *_retval) override { return _to GetPrimaryColumn(_retval); } \
  NS_IMETHOD GetSortedColumn(nsITreeColumn * *_retval) override { return _to GetSortedColumn(_retval); } \
  NS_IMETHOD GetKeyColumn(nsITreeColumn * *_retval) override { return _to GetKeyColumn(_retval); } \
  NS_IMETHOD GetColumnFor(nsIDOMElement *element, nsITreeColumn * *_retval) override { return _to GetColumnFor(element, _retval); } \
  NS_IMETHOD GetNamedColumn(const nsAString & id, nsITreeColumn * *_retval) override { return _to GetNamedColumn(id, _retval); } \
  NS_IMETHOD GetColumnAt(int32_t index, nsITreeColumn * *_retval) override { return _to GetColumnAt(index, _retval); } \
  NS_IMETHOD InvalidateColumns(void) override { return _to InvalidateColumns(); } \
  NS_IMETHOD RestoreNaturalOrder(void) override { return _to RestoreNaturalOrder(); } 
...
#define NS_FORWARD_SAFE_NSITREECOLUMNS(_to) \
  ...
  NS_IMETHOD GetFirstColumn(nsITreeColumn * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFirstColumn(_retval); } \
  NS_IMETHOD GetLastColumn(nsITreeColumn * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLastColumn(_retval); } \
  NS_IMETHOD GetPrimaryColumn(nsITreeColumn * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrimaryColumn(_retval); } \
  NS_IMETHOD GetSortedColumn(nsITreeColumn * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSortedColumn(_retval); } \
  NS_IMETHOD GetKeyColumn(nsITreeColumn * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetKeyColumn(_retval); } \
  NS_IMETHOD GetColumnFor(nsIDOMElement *element, nsITreeColumn * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetColumnFor(element, _retval); } \
  NS_IMETHOD GetNamedColumn(const nsAString & id, nsITreeColumn * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNamedColumn(id, _retval); } \
  NS_IMETHOD GetColumnAt(int32_t index, nsITreeColumn * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetColumnAt(index, _retval); } \
  NS_IMETHOD InvalidateColumns(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->InvalidateColumns(); } \
  NS_IMETHOD RestoreNaturalOrder(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->RestoreNaturalOrder(); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsTreeColumns, nsITreeColumns)
