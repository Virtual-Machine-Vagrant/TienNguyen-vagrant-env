...
#define NS_DECL_NON_VIRTUAL_NSICONTROLLER \
  ...
  NS_METHOD SupportsCommand(const char * command, bool *_retval); \
  NS_METHOD DoCommand(const char * command); \
  NS_METHOD OnEvent(const char * eventName); 
...
#define NS_DECL_NON_VIRTUAL_NSICOMMANDCONTROLLER \
  NS_METHOD GetCommandStateWithParams(const char * command, nsICommandParams *aCommandParams); \
  NS_METHOD DoCommandWithParams(const char * command, nsICommandParams *aCommandParams); \
...
#define NS_DECL_NON_VIRTUAL_NSICONTROLLERCOMMANDGROUP \
  NS_METHOD AddCommandToGroup(const char * aCommand, const char * aGroup); \
  NS_METHOD RemoveCommandFromGroup(const char * aCommand, const char * aGroup); \
  NS_METHOD IsCommandInGroup(const char * aCommand, const char * aGroup, bool *_retval); \
  NS_METHOD GetGroupsEnumerator(nsISimpleEnumerator * *_retval); \
  NS_METHOD GetEnumeratorForGroup(const char * aGroup, nsISimpleEnumerator * *_retval); 
