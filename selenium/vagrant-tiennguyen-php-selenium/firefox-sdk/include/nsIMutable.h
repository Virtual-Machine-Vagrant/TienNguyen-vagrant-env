...
#define NS_DECL_NSIMUTABLE \
  NS_IMETHOD GetMutable(bool *aMutable) override; \
  NS_IMETHOD SetMutable(bool aMutable) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIMUTABLE \
  NS_METHOD GetMutable(bool *aMutable); \
  NS_METHOD SetMutable(bool aMutable); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIMUTABLE(_to) \
  NS_IMETHOD GetMutable(bool *aMutable) override { return _to GetMutable(aMutable); } \
  NS_IMETHOD SetMutable(bool aMutable) override { return _to SetMutable(aMutable); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIMUTABLE(_to) \
  NS_IMETHOD GetMutable(bool *aMutable) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMutable(aMutable); } \
  NS_IMETHOD SetMutable(bool aMutable) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMutable(aMutable); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsMutable, nsIMutable)
