...
#define NS_DECL_NSISAXDTDHANDLER \
  NS_IMETHOD NotationDecl(const nsAString & name, const nsAString & publicId, const nsAString & systemId) override; \
  NS_IMETHOD UnparsedEntityDecl(const nsAString & name, const nsAString & publicId, const nsAString & systemId, const nsAString & notationName) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSISAXDTDHANDLER \
  NS_METHOD NotationDecl(const nsAString & name, const nsAString & publicId, const nsAString & systemId); \
  NS_METHOD UnparsedEntityDecl(const nsAString & name, const nsAString & publicId, const nsAString & systemId, const nsAString & notationName); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISAXDTDHANDLER(_to) \
  NS_IMETHOD NotationDecl(const nsAString & name, const nsAString & publicId, const nsAString & systemId) override { return _to NotationDecl(name, publicId, systemId); } \
  NS_IMETHOD UnparsedEntityDecl(const nsAString & name, const nsAString & publicId, const nsAString & systemId, const nsAString & notationName) override { return _to UnparsedEntityDecl(name, publicId, systemId, notationName); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISAXDTDHANDLER(_to) \
  NS_IMETHOD NotationDecl(const nsAString & name, const nsAString & publicId, const nsAString & systemId) override { return !_to ? NS_ERROR_NULL_POINTER : _to->NotationDecl(name, publicId, systemId); } \
  NS_IMETHOD UnparsedEntityDecl(const nsAString & name, const nsAString & publicId, const nsAString & systemId, const nsAString & notationName) override { return !_to ? NS_ERROR_NULL_POINTER : _to->UnparsedEntityDecl(name, publicId, systemId, notationName); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsSAXDTDHandler, nsISAXDTDHandler)
