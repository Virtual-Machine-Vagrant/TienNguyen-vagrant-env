...
#define NS_DECL_NON_VIRTUAL_NSISTREAMBUFFERACCESS \
  ...
  NS_METHOD DisableBuffering(void); \
  NS_METHOD EnableBuffering(void); \
  NS_METHOD GetUnbufferedStream(nsISupports * *aUnbufferedStream); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsStreamBufferAccess, nsIStreamBufferAccess)
