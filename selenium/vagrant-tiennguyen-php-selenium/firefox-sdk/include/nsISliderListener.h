...
#define NS_DECL_NSISLIDERLISTENER \
  NS_IMETHOD ValueChanged(const nsAString & which, int32_t newValue, bool userChanged) override; \
  NS_IMETHOD DragStateChanged(bool isDragging) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSISLIDERLISTENER \
  NS_METHOD ValueChanged(const nsAString & which, int32_t newValue, bool userChanged); \
  NS_METHOD DragStateChanged(bool isDragging); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISLIDERLISTENER(_to) \
  NS_IMETHOD ValueChanged(const nsAString & which, int32_t newValue, bool userChanged) override { return _to ValueChanged(which, newValue, userChanged); } \
  NS_IMETHOD DragStateChanged(bool isDragging) override { return _to DragStateChanged(isDragging); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISLIDERLISTENER(_to) \
  NS_IMETHOD ValueChanged(const nsAString & which, int32_t newValue, bool userChanged) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ValueChanged(which, newValue, userChanged); } \
  NS_IMETHOD DragStateChanged(bool isDragging) override { return !_to ? NS_ERROR_NULL_POINTER : _to->DragStateChanged(isDragging); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsSliderListener, nsISliderListener)
