...
#define NS_IDOMWINDOWUTILS_IID_STR "46b44e33-13c2-4eb3-bf80-76a4e0857ccc"

#define NS_IDOMWINDOWUTILS_IID \
  {0x46b44e33, 0x13c2, 0x4eb3, \
    { 0xbf, 0x80, 0x76, 0xa4, 0xe0, 0x85, 0x7c, 0xcc }}
...
class NS_NO_VTABLE nsIDOMWindowUtils : public nsISupports {
 public:
  ...
  NS_IMETHOD SendNativeMouseMove(int32_t aScreenX, int32_t aScreenY, nsIDOMElement *aElement, nsIObserver *aObserver) = 0;
  ...
  NS_IMETHOD GetSupportsHardwareH264Decoding(JS::MutableHandleValue aSupportsHardwareH264Decoding) = 0;
  ...
  NS_IMETHOD SetAsyncScrollOffset(nsIDOMNode *aNode, float aX, float aY) = 0;
  ...
  NS_IMETHOD ZoomToFocusedInput(void) = 0;
  ...
  NS_IMETHOD GetOMTAStyle(nsIDOMElement *aElement, const nsAString & aProperty, const nsAString & aPseudoElement, nsAString & _retval) = 0;
  ...
  NS_IMETHOD ForceUseCounterFlush(nsIDOMNode *aNode) = 0;

  /* void setNextPaintSyncId (in long aSyncId); */
  NS_IMETHOD SetNextPaintSyncId(int32_t aSyncId) = 0;
...
#define NS_DECL_NSIDOMWINDOWUTILS \
  ...
  NS_IMETHOD SendNativeMouseMove(int32_t aScreenX, int32_t aScreenY, nsIDOMElement *aElement, nsIObserver *aObserver) override; \
  ...
  NS_IMETHOD GetSupportsHardwareH264Decoding(JS::MutableHandleValue aSupportsHardwareH264Decoding) override; \
  ...
  NS_IMETHOD SetAsyncScrollOffset(nsIDOMNode *aNode, float aX, float aY) override; \
  NS_IMETHOD SetAsyncZoom(nsIDOMNode *aRootElement, float aValue) override; \
  NS_IMETHOD FlushApzRepaints(bool *_retval) override; \
  NS_IMETHOD ZoomToFocusedInput(void) override; \
  ...
  NS_IMETHOD GetOMTAStyle(nsIDOMElement *aElement, const nsAString & aProperty, const nsAString & aPseudoElement, nsAString & _retval) override; \
  ...
  NS_IMETHOD ForceUseCounterFlush(nsIDOMNode *aNode) override; \
  NS_IMETHOD SetNextPaintSyncId(int32_t aSyncId) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMWINDOWUTILS \
  NS_METHOD GetImageAnimationMode(uint16_t *aImageAnimationMode); \
  NS_METHOD SetImageAnimationMode(uint16_t aImageAnimationMode); \
  NS_METHOD GetDocCharsetIsForced(bool *aDocCharsetIsForced); \
  NS_METHOD GetCursorType(int16_t *_retval); \
  NS_METHOD GetDocumentMetadata(const nsAString & aName, nsAString & _retval); \
  NS_METHOD Redraw(uint32_t aCount, uint32_t *_retval); \
  NS_METHOD UpdateLayerTree(void); \
  NS_METHOD GetViewportInfo(uint32_t aDisplayWidth, uint32_t aDisplayHeight, double *aDefaultZoom, bool *aAllowZoom, double *aMinZoom, double *aMaxZoom, uint32_t *aWidth, uint32_t *aHeight, bool *aAutoSize); \
  NS_METHOD SetDisplayPortForElement(float aXPx, float aYPx, float aWidthPx, float aHeightPx, nsIDOMElement *aElement, uint32_t aPriority); \
  NS_METHOD SetDisplayPortMarginsForElement(float aLeftMargin, float aTopMargin, float aRightMargin, float aBottomMargin, nsIDOMElement *aElement, uint32_t aPriority); \
  NS_METHOD SetDisplayPortBaseForElement(int32_t aX, int32_t aY, int32_t aWidth, int32_t aHeight, nsIDOMElement *aElement); \
  NS_METHOD SetResolution(float aResolution); \
  NS_METHOD GetResolution(float *aResolution); \
  NS_METHOD SetResolutionAndScaleTo(float aResolution); \
  NS_METHOD GetIsResolutionSet(bool *aIsResolutionSet); \
  NS_METHOD GetIsFirstPaint(bool *aIsFirstPaint); \
  NS_METHOD SetIsFirstPaint(bool aIsFirstPaint); \
  NS_METHOD GetPresShellId(uint32_t *aPresShellId); \
  NS_METHOD SendMouseEvent(const nsAString & aType, float aX, float aY, int32_t aButton, int32_t aClickCount, int32_t aModifiers, bool aIgnoreRootScrollFrame, float aPressure, uint16_t aInputSourceArg, bool aIsSynthesized, uint8_t _argc, bool *_retval); \
  NS_METHOD SendPointerEvent(const nsAString & aType, float aX, float aY, int32_t aButton, int32_t aClickCount, int32_t aModifiers, bool aIgnoreRootScrollFrame, float aPressure, uint16_t aInputSourceArg, int32_t aPointerId, int32_t aWidth, int32_t aHeight, int32_t aTiltX, int32_t aTiltY, bool aIsPrimary, bool aIsSynthesized, uint8_t _argc, bool *_retval); \
  NS_METHOD SendTouchEvent(const nsAString & aType, uint32_t *aIdentifiers, int32_t *aXs, int32_t *aYs, uint32_t *aRxs, uint32_t *aRys, float *aRotationAngles, float *aForces, uint32_t count, int32_t aModifiers, bool aIgnoreRootScrollFrame, bool *_retval); \
  NS_METHOD SendMouseEventToWindow(const nsAString & aType, float aX, float aY, int32_t aButton, int32_t aClickCount, int32_t aModifiers, bool aIgnoreRootScrollFrame, float aPressure, uint16_t aInputSourceArg, bool aIsSynthesized, uint8_t _argc); \
  NS_METHOD SendPointerEventToWindow(const nsAString & aType, float aX, float aY, int32_t aButton, int32_t aClickCount, int32_t aModifiers, bool aIgnoreRootScrollFrame, float aPressure, uint16_t aInputSourceArg, int32_t aPointerId, int32_t aWidth, int32_t aHeight, int32_t aTiltX, int32_t aTiltY, bool aIsPrimary, bool aIsSynthesized, uint8_t _argc); \
  NS_METHOD SendTouchEventToWindow(const nsAString & aType, uint32_t *aIdentifiers, int32_t *aXs, int32_t *aYs, uint32_t *aRxs, uint32_t *aRys, float *aRotationAngles, float *aForces, uint32_t count, int32_t aModifiers, bool aIgnoreRootScrollFrame, bool *_retval); \
  NS_METHOD SendWheelEvent(float aX, float aY, double aDeltaX, double aDeltaY, double aDeltaZ, uint32_t aDeltaMode, int32_t aModifiers, int32_t aLineOrPageDeltaX, int32_t aLineOrPageDeltaY, uint32_t aOptions); \
  NS_METHOD SendKeyEvent(const nsAString & aType, int32_t aKeyCode, int32_t aCharCode, int32_t aModifiers, uint32_t aAdditionalFlags, bool *_retval); \
  NS_METHOD SendNativeKeyEvent(int32_t aNativeKeyboardLayout, int32_t aNativeKeyCode, int32_t aModifierFlags, const nsAString & aCharacters, const nsAString & aUnmodifiedCharacters, nsIObserver *aObserver); \
  NS_METHOD SendNativeMouseEvent(int32_t aScreenX, int32_t aScreenY, int32_t aNativeMessage, int32_t aModifierFlags, nsIDOMElement *aElement, nsIObserver *aObserver); \
  NS_METHOD SendNativeMouseMove(int32_t aScreenX, int32_t aScreenY, nsIDOMElement *aElement, nsIObserver *aObserver); \
  NS_METHOD SendNativeMouseScrollEvent(int32_t aScreenX, int32_t aScreenY, uint32_t aNativeMessage, double aDeltaX, double aDeltaY, double aDeltaZ, uint32_t aModifierFlags, uint32_t aAdditionalFlags, nsIDOMElement *aElement, nsIObserver *aObserver); \
  NS_METHOD SendNativeTouchPoint(uint32_t aPointerId, uint32_t aTouchState, int32_t aScreenX, int32_t aScreenY, double aPressure, uint32_t aOrientation, nsIObserver *aObserver); \
  NS_METHOD SendNativeTouchTap(int32_t aScreenX, int32_t aScreenY, bool aLongTap, nsIObserver *aObserver); \
  NS_METHOD ClearNativeTouchSequence(nsIObserver *aObserver); \
  NS_METHOD ActivateNativeMenuItemAt(const nsAString & indexString); \
  NS_METHOD ForceUpdateNativeMenuAt(const nsAString & indexString); \
  NS_METHOD Focus(nsIDOMElement *aElement); \
  NS_METHOD GarbageCollect(nsICycleCollectorListener *aListener, int32_t aExtraForgetSkippableCalls); \
  NS_METHOD CycleCollect(nsICycleCollectorListener *aListener, int32_t aExtraForgetSkippableCalls); \
  NS_METHOD RunNextCollectorTimer(void); \
  NS_METHOD SendSimpleGestureEvent(const nsAString & aType, float aX, float aY, uint32_t aDirection, double aDelta, int32_t aModifiers, uint32_t aClickCount); \
  NS_METHOD ElementFromPoint(float aX, float aY, bool aIgnoreRootScrollFrame, bool aFlushLayout, nsIDOMElement * *_retval); \
  NS_METHOD NodesFromRect(float aX, float aY, float aTopSize, float aRightSize, float aBottomSize, float aLeftSize, bool aIgnoreRootScrollFrame, bool aFlushLayout, nsIDOMNodeList * *_retval); \
  NS_METHOD GetTranslationNodes(nsIDOMNode *aRoot, nsITranslationNodeList * *_retval); \
  NS_METHOD CompareCanvases(nsIDOMHTMLCanvasElement *aCanvas1, nsIDOMHTMLCanvasElement *aCanvas2, uint32_t *aMaxDifference, uint32_t *_retval); \
  NS_METHOD GetIsMozAfterPaintPending(bool *aIsMozAfterPaintPending); \
  NS_METHOD SuppressEventHandling(bool aSuppress); \
  NS_METHOD ClearMozAfterPaintEvents(void); \
  NS_METHOD DisableNonTestMouseEvents(bool aDisable); \
  NS_METHOD GetScrollXY(bool aFlushLayout, int32_t *aScrollX, int32_t *aScrollY); \
  NS_METHOD GetScrollXYFloat(bool aFlushLayout, float *aScrollX, float *aScrollY); \
  NS_METHOD GetScrollbarSize(bool aFlushLayout, int32_t *aWidth, int32_t *aHeight); \
  NS_METHOD GetBoundsWithoutFlushing(nsIDOMElement *aElement, nsIDOMClientRect * *_retval); \
  NS_METHOD GetRootBounds(nsIDOMClientRect * *_retval); \
  NS_METHOD GetIMEIsOpen(bool *aIMEIsOpen); \
  NS_METHOD GetIMEStatus(uint32_t *aIMEStatus); \
  NS_METHOD GetScreenPixelsPerCSSPixel(float *aScreenPixelsPerCSSPixel); \
  NS_METHOD GetFullZoom(float *aFullZoom); \
  NS_METHOD DispatchDOMEventViaPresShell(nsIDOMNode *aTarget, nsIDOMEvent *aEvent, bool aTrusted, bool *_retval); \
  NS_METHOD DispatchEventToChromeOnly(nsIDOMEventTarget *aTarget, nsIDOMEvent *aEvent, bool *_retval); \
  NS_METHOD GetClassName(JS::HandleValue aObject, JSContext* cx, char * *_retval); \
  NS_METHOD SendContentCommandEvent(const nsAString & aType, nsITransferable *aTransferable); \
  NS_METHOD SendQueryContentEvent(uint32_t aType, uint32_t aOffset, uint32_t aLength, int32_t aX, int32_t aY, uint32_t aAdditionalFlags, nsIQueryContentEventResult * *_retval); \
  NS_METHOD RemoteFrameFullscreenChanged(nsIDOMElement *aFrameElement); \
  NS_METHOD RemoteFrameFullscreenReverted(void); \
  NS_METHOD HandleFullscreenRequests(bool *_retval); \
  NS_METHOD ExitFullscreen(void); \
  NS_METHOD SendSelectionSetEvent(uint32_t aOffset, uint32_t aLength, uint32_t aAdditionalFlags, bool *_retval); \
  NS_METHOD SelectAtPoint(float aX, float aY, uint32_t aSelectBehavior, bool *_retval); \
  NS_METHOD GetVisitedDependentComputedStyle(nsIDOMElement *aElement, const nsAString & aPseudoElement, const nsAString & aPropertyName, nsAString & _retval); \
  NS_METHOD GetOuterWindowID(uint64_t *aOuterWindowID); \
  NS_METHOD GetCurrentInnerWindowID(uint64_t *aCurrentInnerWindowID); \
  NS_METHOD EnterModalState(void); \
  NS_METHOD LeaveModalState(void); \
  NS_METHOD IsInModalState(bool *_retval); \
  NS_METHOD SetDesktopModeViewport(bool aDesktopModeViewport); \
  NS_METHOD SuspendTimeouts(void); \
  NS_METHOD ResumeTimeouts(void); \
  NS_METHOD GetLayerManagerType(nsAString & aLayerManagerType); \
  NS_METHOD GetLayerManagerRemote(bool *aLayerManagerRemote); \
  NS_METHOD GetSupportsHardwareH264Decoding(JS::MutableHandleValue aSupportsHardwareH264Decoding); \
  NS_METHOD StartFrameTimeRecording(uint32_t *startIndex); \
  NS_METHOD StopFrameTimeRecording(uint32_t startIndex, uint32_t *frameCount, float **frameIntervals); \
  NS_METHOD BeginTabSwitch(void); \
  NS_METHOD GetDisplayDPI(float *aDisplayDPI); \
  NS_METHOD GetOuterWindowWithId(uint64_t aOuterWindowID, nsIDOMWindow * *_retval); \
  NS_METHOD GetContainerElement(nsIDOMElement * *aContainerElement); \
  NS_METHOD RenderDocument(const nsRect & aRect, uint32_t aFlags, nscolor aBackgroundColor, gfxContext *aThebesContext); \
  NS_METHOD AdvanceTimeAndRefresh(int64_t aMilliseconds); \
  NS_METHOD RestoreNormalRefresh(void); \
  NS_METHOD GetIsTestControllingRefreshes(bool *aIsTestControllingRefreshes); \
  NS_METHOD GetAsyncPanZoomEnabled(bool *aAsyncPanZoomEnabled); \
  NS_METHOD SetAsyncScrollOffset(nsIDOMNode *aNode, float aX, float aY); \
  NS_METHOD SetAsyncZoom(nsIDOMNode *aRootElement, float aValue); \
  NS_METHOD FlushApzRepaints(bool *_retval); \
  NS_METHOD ZoomToFocusedInput(void); \
  NS_METHOD ComputeAnimationDistance(nsIDOMElement *element, const nsAString & property, const nsAString & value1, const nsAString & value2, double *_retval); \
  NS_METHOD WrapDOMFile(nsIFile *aFile, nsISupports * *_retval); \
  NS_METHOD GetFocusedInputType(char * *aFocusedInputType); \
  NS_METHOD GetViewId(nsIDOMElement *aElement, nsViewID *_retval); \
  NS_METHOD LeafLayersPartitionWindow(bool *_retval); \
  NS_METHOD CheckAndClearPaintedState(nsIDOMElement *aElement, bool *_retval); \
  NS_METHOD IsPartOfOpaqueLayer(nsIDOMElement *aElement, bool *_retval); \
  NS_METHOD NumberOfAssignedPaintedLayers(nsIDOMElement **aElements, uint32_t count, uint32_t *_retval); \
  NS_METHOD GetFileId(JS::HandleValue aFile, JSContext* cx, int64_t *_retval); \
  NS_METHOD GetFilePath(JS::HandleValue aFile, JSContext* cx, nsAString & _retval); \
  NS_METHOD GetFileReferences(const nsAString & aDatabaseName, int64_t aId, JS::HandleValue aOptions, int32_t *aRefCnt, int32_t *aDBRefCnt, int32_t *aSliceRefCnt, JSContext* cx, bool *_retval); \
  NS_METHOD FlushPendingFileDeletions(void); \
  NS_METHOD IsIncrementalGCEnabled(JSContext* cx, bool *_retval); \
  NS_METHOD StartPCCountProfiling(JSContext* cx); \
  NS_METHOD StopPCCountProfiling(JSContext* cx); \
  NS_METHOD PurgePCCounts(JSContext* cx); \
  NS_METHOD GetPCCountScriptCount(JSContext* cx, int32_t *_retval); \
  NS_METHOD GetPCCountScriptSummary(int32_t script, JSContext* cx, nsAString & _retval); \
  NS_METHOD GetPCCountScriptContents(int32_t script, JSContext* cx, nsAString & _retval); \
  NS_METHOD GetPaintingSuppressed(bool *aPaintingSuppressed); \
  NS_METHOD GetPlugins(JSContext* cx, JS::MutableHandleValue aPlugins); \
  NS_METHOD SetScrollPositionClampingScrollPortSize(float aWidth, float aHeight); \
  NS_METHOD DisableDialogs(void); \
  NS_METHOD EnableDialogs(void); \
  NS_METHOD AreDialogsEnabled(bool *_retval); \
  NS_METHOD LoadSheet(nsIURI *sheetURI, uint32_t type); \
  NS_METHOD LoadSheetUsingURIString(const nsACString & sheetURI, uint32_t type); \
  NS_METHOD AddSheet(nsIDOMStyleSheet *sheet, uint32_t type); \
  NS_METHOD RemoveSheet(nsIURI *sheetURI, uint32_t type); \
  NS_METHOD RemoveSheetUsingURIString(const nsACString & sheetURI, uint32_t type); \
  NS_METHOD GetIsHandlingUserInput(bool *aIsHandlingUserInput); \
  NS_METHOD AllowScriptsToClose(void); \
  NS_METHOD GetIsParentWindowMainWidgetVisible(bool *aIsParentWindowMainWidgetVisible); \
  NS_METHOD IsNodeDisabledForEvents(nsIDOMNode *aNode, bool *_retval); \
  NS_METHOD GetPaintFlashing(bool *aPaintFlashing); \
  NS_METHOD SetPaintFlashing(bool aPaintFlashing); \
  NS_METHOD GetOMTAStyle(nsIDOMElement *aElement, const nsAString & aProperty, const nsAString & aPseudoElement, nsAString & _retval); \
  NS_METHOD RequestCompositorProperty(const nsAString & aProperty, float *_retval); \
  NS_METHOD SetHandlingUserInput(bool aHandlingInput, nsIJSRAIIHelper * *_retval); \
  NS_METHOD GetContentAPZTestData(JSContext* cx, JS::MutableHandleValue _retval); \
  NS_METHOD GetCompositorAPZTestData(JSContext* cx, JS::MutableHandleValue _retval); \
  NS_METHOD PostRestyleSelfEvent(nsIDOMElement *aElement); \
  NS_METHOD GetAudioMuted(bool *aAudioMuted); \
  NS_METHOD SetAudioMuted(bool aAudioMuted); \
  NS_METHOD GetAudioVolume(float *aAudioVolume); \
  NS_METHOD SetAudioVolume(float aAudioVolume); \
  NS_METHOD XpconnectArgument(nsIDOMWindowUtils *aThis); \
  NS_METHOD AskPermission(nsIContentPermissionRequest *aRequest); \
  NS_METHOD GetFramesConstructed(uint64_t *aFramesConstructed); \
  NS_METHOD GetFramesReflowed(uint64_t *aFramesReflowed); \
  NS_METHOD SetChromeMargin(int32_t aTop, int32_t aRight, int32_t aBottom, int32_t aLeft); \
  NS_METHOD GetServiceWorkersTestingEnabled(bool *aServiceWorkersTestingEnabled); \
  NS_METHOD SetServiceWorkersTestingEnabled(bool aServiceWorkersTestingEnabled); \
  NS_METHOD GetFrameUniformityTestData(JSContext* cx, JS::MutableHandleValue _retval); \
  NS_METHOD EnterChaosMode(void); \
  NS_METHOD LeaveChaosMode(void); \
  NS_METHOD HasRuleProcessorUsedByMultipleStyleSets(uint32_t aSheetType, bool *_retval); \
  NS_METHOD ForceUseCounterFlush(nsIDOMNode *aNode); \
  NS_METHOD SetNextPaintSyncId(int32_t aSyncId); 
...
#define NS_FORWARD_NSIDOMWINDOWUTILS(_to) \
  ...
  NS_IMETHOD SendNativeMouseMove(int32_t aScreenX, int32_t aScreenY, nsIDOMElement *aElement, nsIObserver *aObserver) override { return _to SendNativeMouseMove(aScreenX, aScreenY, aElement, aObserver); } \
  ...
  NS_IMETHOD GetSupportsHardwareH264Decoding(JS::MutableHandleValue aSupportsHardwareH264Decoding) override { return _to GetSupportsHardwareH264Decoding(aSupportsHardwareH264Decoding); } \
  ...
  NS_IMETHOD SetAsyncScrollOffset(nsIDOMNode *aNode, float aX, float aY) override { return _to SetAsyncScrollOffset(aNode, aX, aY); } \
  ...
  NS_IMETHOD ZoomToFocusedInput(void) override { return _to ZoomToFocusedInput(); } \
  ...
  NS_IMETHOD GetOMTAStyle(nsIDOMElement *aElement, const nsAString & aProperty, const nsAString & aPseudoElement, nsAString & _retval) override { return _to GetOMTAStyle(aElement, aProperty, aPseudoElement, _retval); } \
  ...
  NS_IMETHOD ForceUseCounterFlush(nsIDOMNode *aNode) override { return _to ForceUseCounterFlush(aNode); } \
  NS_IMETHOD SetNextPaintSyncId(int32_t aSyncId) override { return _to SetNextPaintSyncId(aSyncId); } 
...
#define NS_FORWARD_SAFE_NSIDOMWINDOWUTILS(_to) \
  ...
  NS_IMETHOD SendNativeMouseMove(int32_t aScreenX, int32_t aScreenY, nsIDOMElement *aElement, nsIObserver *aObserver) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SendNativeMouseMove(aScreenX, aScreenY, aElement, aObserver); } \
  ...
  NS_IMETHOD GetSupportsHardwareH264Decoding(JS::MutableHandleValue aSupportsHardwareH264Decoding) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSupportsHardwareH264Decoding(aSupportsHardwareH264Decoding); } \
  ...
  NS_IMETHOD SetAsyncScrollOffset(nsIDOMNode *aNode, float aX, float aY) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAsyncScrollOffset(aNode, aX, aY); } \
  ...
  NS_IMETHOD ZoomToFocusedInput(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ZoomToFocusedInput(); } \
  ...
  NS_IMETHOD GetOMTAStyle(nsIDOMElement *aElement, const nsAString & aProperty, const nsAString & aPseudoElement, nsAString & _retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOMTAStyle(aElement, aProperty, aPseudoElement, _retval); } \
  ...
  NS_IMETHOD ForceUseCounterFlush(nsIDOMNode *aNode) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ForceUseCounterFlush(aNode); } \
  NS_IMETHOD SetNextPaintSyncId(int32_t aSyncId) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetNextPaintSyncId(aSyncId); } 
...
/* void sendNativeMouseMove (in long aScreenX, in long aScreenY, in nsIDOMElement aElement, [optional] in nsIObserver aObserver); */
NS_IMETHODIMP nsDOMWindowUtils::SendNativeMouseMove(int32_t aScreenX, int32_t aScreenY, nsIDOMElement *aElement, nsIObserver *aObserver)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* readonly attribute jsval supportsHardwareH264Decoding; */
NS_IMETHODIMP nsDOMWindowUtils::GetSupportsHardwareH264Decoding(JS::MutableHandleValue aSupportsHardwareH264Decoding)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* readonly attribute bool asyncPanZoomEnabled; */
NS_IMETHODIMP nsDOMWindowUtils::GetAsyncPanZoomEnabled(bool *aAsyncPanZoomEnabled)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void setAsyncScrollOffset (in nsIDOMNode aNode, in float aX, in float aY); */
NS_IMETHODIMP nsDOMWindowUtils::SetAsyncScrollOffset(nsIDOMNode *aNode, float aX, float aY)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void zoomToFocusedInput (); */
NS_IMETHODIMP nsDOMWindowUtils::ZoomToFocusedInput()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void flushPendingFileDeletions (); */
NS_IMETHODIMP nsDOMWindowUtils::FlushPendingFileDeletions()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* AString getOMTAStyle (in nsIDOMElement aElement, in AString aProperty, [optional] in AString aPseudoElement); */
NS_IMETHODIMP nsDOMWindowUtils::GetOMTAStyle(nsIDOMElement *aElement, const nsAString & aProperty, const nsAString & aPseudoElement, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* bool hasRuleProcessorUsedByMultipleStyleSets (in unsigned long aSheetType); */
NS_IMETHODIMP nsDOMWindowUtils::HasRuleProcessorUsedByMultipleStyleSets(uint32_t aSheetType, bool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void forceUseCounterFlush (in nsIDOMNode aNode); */
NS_IMETHODIMP nsDOMWindowUtils::ForceUseCounterFlush(nsIDOMNode *aNode)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void setNextPaintSyncId (in long aSyncId); */
NS_IMETHODIMP nsDOMWindowUtils::SetNextPaintSyncId(int32_t aSyncId)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
#define NS_DECL_NON_VIRTUAL_NSITRANSLATIONNODELIST \
  ...
  NS_METHOD IsTranslationRootAtIndex(uint32_t index, bool *_retval); 
