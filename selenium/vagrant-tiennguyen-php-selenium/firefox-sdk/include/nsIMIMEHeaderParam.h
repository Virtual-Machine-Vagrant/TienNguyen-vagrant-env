...
#define NS_DECL_NON_VIRTUAL_NSIMIMEHEADERPARAM \
  NS_METHOD GetParameter(const nsACString & aHeaderVal, const char * aParamName, const nsACString & aFallbackCharset, bool aTryLocaleCharset, char * *aLang, nsAString & _retval); \
  NS_METHOD GetParameterHTTP(const nsACString & aHeaderVal, const char * aParamName, const nsACString & aFallbackCharset, bool aTryLocaleCharset, char * *aLang, nsAString & _retval); \
  NS_METHOD DecodeRFC5987Param(const nsACString & aParamVal, nsACString & aLang, nsAString & _retval); \
  NS_METHOD GetParameterInternal(const char * aHeaderVal, const char * aParamName, char * *aCharset, char * *aLang, char * *_retval); \
  NS_METHOD DecodeRFC2047Header(const char * aHeaderVal, const char * aDefaultCharset, bool aOverrideCharset, bool aEatContinuation, nsACString & _retval); \
  NS_METHOD DecodeParameter(const nsACString & aParamValue, const char * aCharset, const char * aDefaultCharset, bool aOverrideCharset, nsACString & _retval); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsMIMEHeaderParam, nsIMIMEHeaderParam)
