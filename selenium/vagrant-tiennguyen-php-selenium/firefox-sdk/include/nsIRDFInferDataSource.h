...
#define NS_DECL_NON_VIRTUAL_NSIRDFINFERDATASOURCE \
  NS_METHOD GetBaseDataSource(nsIRDFDataSource * *aBaseDataSource); \
  NS_METHOD SetBaseDataSource(nsIRDFDataSource *aBaseDataSource); 
