...
#define NS_DECL_NSIDOMPAINTREQUEST \
  NS_IMETHOD GetClientRect(nsIDOMClientRect * *aClientRect) override; \
  NS_IMETHOD GetXPCOMReason(nsAString & aReason) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMPAINTREQUEST \
  NS_METHOD GetClientRect(nsIDOMClientRect * *aClientRect); \
  NS_METHOD GetXPCOMReason(nsAString & aReason); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMPAINTREQUEST(_to) \
  NS_IMETHOD GetClientRect(nsIDOMClientRect * *aClientRect) override { return _to GetClientRect(aClientRect); } \
  NS_IMETHOD GetXPCOMReason(nsAString & aReason) override { return _to GetXPCOMReason(aReason); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMPAINTREQUEST(_to) \
  NS_IMETHOD GetClientRect(nsIDOMClientRect * *aClientRect) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetClientRect(aClientRect); } \
  NS_IMETHOD GetXPCOMReason(nsAString & aReason) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetXPCOMReason(aReason); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMPaintRequest, nsIDOMPaintRequest)
