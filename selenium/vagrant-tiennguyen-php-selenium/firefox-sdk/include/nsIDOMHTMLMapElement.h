...
#define NS_DECL_NSIDOMHTMLMAPELEMENT \
  NS_IMETHOD GetAreas(nsIDOMHTMLCollection * *aAreas) override; \
  NS_IMETHOD GetName(nsAString & aName) override; \
  NS_IMETHOD SetName(const nsAString & aName) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMHTMLMAPELEMENT \
  NS_METHOD GetAreas(nsIDOMHTMLCollection * *aAreas); \
...
#define NS_FORWARD_NSIDOMHTMLMAPELEMENT(_to) \
  NS_IMETHOD GetAreas(nsIDOMHTMLCollection * *aAreas) override { return _to GetAreas(aAreas); } \
...
#define NS_FORWARD_SAFE_NSIDOMHTMLMAPELEMENT(_to) \
  NS_IMETHOD GetAreas(nsIDOMHTMLCollection * *aAreas) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAreas(aAreas); } \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMHTMLMapElement, nsIDOMHTMLMapElement)
