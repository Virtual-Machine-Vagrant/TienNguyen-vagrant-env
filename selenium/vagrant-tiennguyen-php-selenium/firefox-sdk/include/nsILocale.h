...
#define NS_DECL_NSILOCALE \
  NS_IMETHOD GetCategory(const nsAString & category, nsAString & _retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSILOCALE \
  NS_METHOD GetCategory(const nsAString & category, nsAString & _retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSILOCALE(_to) \
  NS_IMETHOD GetCategory(const nsAString & category, nsAString & _retval) override { return _to GetCategory(category, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSILOCALE(_to) \
  NS_IMETHOD GetCategory(const nsAString & category, nsAString & _retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCategory(category, _retval); } 
