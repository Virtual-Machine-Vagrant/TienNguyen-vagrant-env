...
#define NS_DECL_NSICRYPTOHMAC \
  NS_IMETHOD Init(uint32_t aAlgorithm, nsIKeyObject *aKeyObject) override; \
...
#define NS_DECL_NON_VIRTUAL_NSICRYPTOHMAC \
  NS_METHOD Init(uint32_t aAlgorithm, nsIKeyObject *aKeyObject); \
...
#define NS_FORWARD_NSICRYPTOHMAC(_to) \
  NS_IMETHOD Init(uint32_t aAlgorithm, nsIKeyObject *aKeyObject) override { return _to Init(aAlgorithm, aKeyObject); } \
...
#define NS_FORWARD_SAFE_NSICRYPTOHMAC(_to) \
  NS_IMETHOD Init(uint32_t aAlgorithm, nsIKeyObject *aKeyObject) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(aAlgorithm, aKeyObject); } \
