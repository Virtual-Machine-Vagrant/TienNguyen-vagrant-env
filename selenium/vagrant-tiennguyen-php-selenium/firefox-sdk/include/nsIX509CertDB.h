...
#define NS_DECL_NON_VIRTUAL_NSIOPENSIGNEDAPPFILECALLBACK \
  NS_METHOD OpenSignedAppFileFinished(nsresult rv, nsIZipReader *aZipReader, nsIX509Cert *aSignerCert); 
...
/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIVERIFYSIGNEDDIRECTORYCALLBACK \
  NS_METHOD VerifySignedDirectoryFinished(nsresult rv, nsIX509Cert *aSignerCert); 
...
/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIVERIFYSIGNEDMANIFESTCALLBACK \
  NS_METHOD VerifySignedManifestFinished(nsresult rv, nsIX509Cert *aSignerCert); 
...
class NS_NO_VTABLE nsIX509CertDB : public nsISupports {
 public:
  ...
  NS_IMETHOD FindCertByNickname(const nsAString & aNickname, nsIX509Cert * *_retval) = 0;

  /* nsIX509Cert findCertByDBKey (in string aDBkey); */
  NS_IMETHOD FindCertByDBKey(const char * aDBkey, nsIX509Cert * *_retval) = 0;
  ...
  NS_IMETHOD FindCertByEmailAddress(const char * aEmailAddress, nsIX509Cert * *_retval) = 0;
  ...
  NS_IMETHOD ImportCertsFromFile(nsIFile *aFile, uint32_t aType) = 0;
  ...
  enum {
    ...
    AddonsPublicRoot = 7U,
    AddonsStageRoot = 8U,
    PrivilegedPackageRoot = 9U,
    DeveloperImportedRoot = 10U
  };
  ...
  /* int32_t verifyCertAtTime (in nsIX509Cert aCert, in int64_t aUsage, in uint32_t aFlags, in string aHostname, in uint64_t aTime, out nsIX509CertList aVerifiedChain, out bool aHasEVPolicy); */
  NS_IMETHOD VerifyCertAtTime(nsIX509Cert *aCert, int64_t aUsage, uint32_t aFlags, const char * aHostname, uint64_t aTime, nsIX509CertList * *aVerifiedChain, bool *aHasEVPolicy, int32_t *_retval) = 0;
...
#define NS_DECL_NSIX509CERTDB \
  NS_IMETHOD FindCertByNickname(const nsAString & aNickname, nsIX509Cert * *_retval) override; \
  NS_IMETHOD FindCertByDBKey(const char * aDBkey, nsIX509Cert * *_retval) override; \
  ...
  NS_IMETHOD FindCertByEmailAddress(const char * aEmailAddress, nsIX509Cert * *_retval) override; \
  ...
  NS_IMETHOD ImportCertsFromFile(nsIFile *aFile, uint32_t aType) override; \
  ...
  NS_IMETHOD VerifyCertAtTime(nsIX509Cert *aCert, int64_t aUsage, uint32_t aFlags, const char * aHostname, uint64_t aTime, nsIX509CertList * *aVerifiedChain, bool *aHasEVPolicy, int32_t *_retval) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIX509CERTDB \
  NS_METHOD FindCertByNickname(const nsAString & aNickname, nsIX509Cert * *_retval); \
  NS_METHOD FindCertByDBKey(const char * aDBkey, nsIX509Cert * *_retval); \
  NS_METHOD FindEmailEncryptionCert(const nsAString & aNickname, nsIX509Cert * *_retval); \
  NS_METHOD FindEmailSigningCert(const nsAString & aNickname, nsIX509Cert * *_retval); \
  NS_METHOD FindCertByEmailAddress(const char * aEmailAddress, nsIX509Cert * *_retval); \
  NS_METHOD ImportCertificates(uint8_t *data, uint32_t length, uint32_t type, nsIInterfaceRequestor *ctx); \
  NS_METHOD ImportEmailCertificate(uint8_t *data, uint32_t length, nsIInterfaceRequestor *ctx); \
  NS_METHOD ImportUserCertificate(uint8_t *data, uint32_t length, nsIInterfaceRequestor *ctx); \
  NS_METHOD DeleteCertificate(nsIX509Cert *aCert); \
  NS_METHOD SetCertTrust(nsIX509Cert *cert, uint32_t type, uint32_t trust); \
  NS_METHOD SetCertTrustFromString(nsIX509Cert *cert, const char * trustString); \
  NS_METHOD IsCertTrusted(nsIX509Cert *cert, uint32_t certType, uint32_t trustType, bool *_retval); \
  NS_METHOD ImportCertsFromFile(nsIFile *aFile, uint32_t aType); \
  NS_METHOD ImportPKCS12File(nsISupports *aToken, nsIFile *aFile); \
  NS_METHOD ExportPKCS12File(nsISupports *aToken, nsIFile *aFile, uint32_t count, nsIX509Cert **aCerts); \
  NS_METHOD ConstructX509FromBase64(const char * base64, nsIX509Cert * *_retval); \
  NS_METHOD ConstructX509(const char * certDER, uint32_t length, nsIX509Cert * *_retval); \
  NS_METHOD OpenSignedAppFileAsync(AppTrustedRoot trustedRoot, nsIFile *aJarFile, nsIOpenSignedAppFileCallback *callback); \
  NS_METHOD VerifySignedDirectoryAsync(AppTrustedRoot trustedRoot, nsIFile *aUnpackedDir, nsIVerifySignedDirectoryCallback *callback); \
  NS_METHOD VerifySignedManifestAsync(AppTrustedRoot trustedRoot, nsIInputStream *aManifestStream, nsIInputStream *aSignatureStream, nsIVerifySignedManifestCallback *callback); \
  NS_METHOD AddCert(const nsACString & certDER, const char * aTrust, const char * aName); \
  NS_METHOD VerifyCertAtTime(nsIX509Cert *aCert, int64_t aUsage, uint32_t aFlags, const char * aHostname, uint64_t aTime, nsIX509CertList * *aVerifiedChain, bool *aHasEVPolicy, int32_t *_retval); \
  NS_METHOD VerifyCertNow(nsIX509Cert *aCert, int64_t aUsage, uint32_t aFlags, const char * aHostname, nsIX509CertList * *aVerifiedChain, bool *aHasEVPolicy, int32_t *_retval); \
  NS_METHOD ClearOCSPCache(void); \
  NS_METHOD AddCertFromBase64(const char * base64, const char * aTrust, const char * aName); \
  NS_METHOD GetCerts(nsIX509CertList * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIX509CERTDB(_to) \
  NS_IMETHOD FindCertByNickname(const nsAString & aNickname, nsIX509Cert * *_retval) override { return _to FindCertByNickname(aNickname, _retval); } \
  NS_IMETHOD FindCertByDBKey(const char * aDBkey, nsIX509Cert * *_retval) override { return _to FindCertByDBKey(aDBkey, _retval); } \
  ...
  NS_IMETHOD FindCertByEmailAddress(const char * aEmailAddress, nsIX509Cert * *_retval) override { return _to FindCertByEmailAddress(aEmailAddress, _retval); } \
  ...
  NS_IMETHOD ImportCertsFromFile(nsIFile *aFile, uint32_t aType) override { return _to ImportCertsFromFile(aFile, aType); } \
  ...
  NS_IMETHOD VerifyCertAtTime(nsIX509Cert *aCert, int64_t aUsage, uint32_t aFlags, const char * aHostname, uint64_t aTime, nsIX509CertList * *aVerifiedChain, bool *aHasEVPolicy, int32_t *_retval) override { return _to VerifyCertAtTime(aCert, aUsage, aFlags, aHostname, aTime, aVerifiedChain, aHasEVPolicy, _retval); } \
...
#define NS_FORWARD_SAFE_NSIX509CERTDB(_to) \
  NS_IMETHOD FindCertByNickname(const nsAString & aNickname, nsIX509Cert * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->FindCertByNickname(aNickname, _retval); } \
  NS_IMETHOD FindCertByDBKey(const char * aDBkey, nsIX509Cert * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->FindCertByDBKey(aDBkey, _retval); } \
  ...
  NS_IMETHOD FindCertByEmailAddress(const char * aEmailAddress, nsIX509Cert * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->FindCertByEmailAddress(aEmailAddress, _retval); } \
  ...
  NS_IMETHOD ImportCertsFromFile(nsIFile *aFile, uint32_t aType) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ImportCertsFromFile(aFile, aType); } \
...
/* nsIX509Cert findCertByNickname (in AString aNickname); */
NS_IMETHODIMP nsX509CertDB::FindCertByNickname(const nsAString & aNickname, nsIX509Cert * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIX509Cert findCertByDBKey (in string aDBkey); */
NS_IMETHODIMP nsX509CertDB::FindCertByDBKey(const char * aDBkey, nsIX509Cert * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsIX509Cert findCertByEmailAddress (in string aEmailAddress); */
NS_IMETHODIMP nsX509CertDB::FindCertByEmailAddress(const char * aEmailAddress, nsIX509Cert * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void importCertsFromFile (in nsIFile aFile, in unsigned long aType); */
NS_IMETHODIMP nsX509CertDB::ImportCertsFromFile(nsIFile *aFile, uint32_t aType)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* int32_t verifyCertAtTime (in nsIX509Cert aCert, in int64_t aUsage, in uint32_t aFlags, in string aHostname, in uint64_t aTime, out nsIX509CertList aVerifiedChain, out bool aHasEVPolicy); */
NS_IMETHODIMP nsX509CertDB::VerifyCertAtTime(nsIX509Cert *aCert, int64_t aUsage, uint32_t aFlags, const char * aHostname, uint64_t aTime, nsIX509CertList * *aVerifiedChain, bool *aHasEVPolicy, int32_t *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
