...
#define NS_DECL_NSIHTTPEVENTSINK \
  NS_IMETHOD OnRedirect(nsIHttpChannel *httpChannel, nsIChannel *newChannel) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIHTTPEVENTSINK \
  NS_METHOD OnRedirect(nsIHttpChannel *httpChannel, nsIChannel *newChannel); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIHTTPEVENTSINK(_to) \
  NS_IMETHOD OnRedirect(nsIHttpChannel *httpChannel, nsIChannel *newChannel) override { return _to OnRedirect(httpChannel, newChannel); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIHTTPEVENTSINK(_to) \
  NS_IMETHOD OnRedirect(nsIHttpChannel *httpChannel, nsIChannel *newChannel) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OnRedirect(httpChannel, newChannel); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsHttpEventSink, nsIHttpEventSink)
