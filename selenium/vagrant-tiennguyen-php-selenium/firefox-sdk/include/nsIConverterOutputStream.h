...
#define NS_DECL_NSICONVERTEROUTPUTSTREAM \
  NS_IMETHOD Init(nsIOutputStream *aOutStream, const char * aCharset, uint32_t aBufferSize, char16_t aReplacementCharacter) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSICONVERTEROUTPUTSTREAM \
  NS_METHOD Init(nsIOutputStream *aOutStream, const char * aCharset, uint32_t aBufferSize, char16_t aReplacementCharacter); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICONVERTEROUTPUTSTREAM(_to) \
  NS_IMETHOD Init(nsIOutputStream *aOutStream, const char * aCharset, uint32_t aBufferSize, char16_t aReplacementCharacter) override { return _to Init(aOutStream, aCharset, aBufferSize, aReplacementCharacter); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICONVERTEROUTPUTSTREAM(_to) \
  NS_IMETHOD Init(nsIOutputStream *aOutStream, const char * aCharset, uint32_t aBufferSize, char16_t aReplacementCharacter) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(aOutStream, aCharset, aBufferSize, aReplacementCharacter); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsConverterOutputStream, nsIConverterOutputStream)
