/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM ../../../dist/idl/nsIEntropyCollector.idl
 */
...
#define NS_DECL_NSIENTROPYCOLLECTOR \
  NS_IMETHOD RandomUpdate(void *entropy, int32_t bufLen) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIENTROPYCOLLECTOR \
  NS_METHOD RandomUpdate(void *entropy, int32_t bufLen); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIENTROPYCOLLECTOR(_to) \
  NS_IMETHOD RandomUpdate(void *entropy, int32_t bufLen) override { return _to RandomUpdate(entropy, bufLen); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIENTROPYCOLLECTOR(_to) \
  NS_IMETHOD RandomUpdate(void *entropy, int32_t bufLen) override { return !_to ? NS_ERROR_NULL_POINTER : _to->RandomUpdate(entropy, bufLen); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsEntropyCollector, nsIEntropyCollector)
