...
@section('heading')
<i class="fa fa-file-text-o"></i> {!! trans('contact::contact.name') !!} <small> {!! trans('cms.manage') !!} {!! trans('contact::contact.names') !!}</small>
@stop
...
@section('entry')
<div class="box box-warning" id='contact-contact-entry'>
</div>
@stop
...
@section('content')
<table id="contact-contact-list" class="table table-striped table-bordered data-table">
