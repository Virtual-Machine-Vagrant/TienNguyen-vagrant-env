...
use Litecms\Block\Http\Requests\BlockUserApiRequest;
 ...
 */
class BlockUserApiController extends BaseController
{
    ...
    public function index(BlockUserApiRequest $request)
    {
        $blocks = $this->repository
            ->pushCriteria(new \Litecms\Block\Repositories\Criteria\BlockUserCriteria())
