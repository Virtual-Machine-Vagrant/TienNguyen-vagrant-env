...
use Form;
use Litecms\Block\Http\Requests\BlockUserRequest;
...
class BlockUserController extends BasicController
{
     ...
     * @return Response
     */
    public function index(BlockUserRequest $request)
    {
        $this->repository->pushCriteria(new \Litecms\Block\Repositories\Criteria\BlockUserCriteria());
     ...
     * @return Response
     */
    public function show(BlockUserRequest $request, Block $block)
    {
        Form::populate($block);
     ...
     * @return Response
     */
    public function create(BlockUserRequest $request)
    {
     ...
     * @return Response
     */
    public function edit(BlockUserRequest $request, Block $block)
    {
     ...
     * @return Response
     */
    public function update(BlockUserRequest $request, Block $block)
    {
        try {
            $attributes = $request->all();
