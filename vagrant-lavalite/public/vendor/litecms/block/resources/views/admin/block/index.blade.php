...
@section('heading')
<i class="fa fa-file-text-o"></i> {!! trans('block::block.name') !!} <small> {!! trans('cms.manage') !!} {!! trans('block::block.names') !!}</small>
@stop
...
@section('entry')
<div class="box box-warning" id='block-block-entry'>
</div>
@stop
...
@section('content')
<table id="block-block-list" class="table table-striped table-bordered data-table">
