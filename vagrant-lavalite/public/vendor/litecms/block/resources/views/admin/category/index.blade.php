...
@section('heading')
<i class="fa fa-file-text-o"></i> {!! trans('block::category.name') !!} <small> {!! trans('cms.manage') !!} {!! trans('block::category.names') !!}</small>
@stop
...
@section('entry')
<div class="box box-warning" id='block-category-entry'>
</div>
@stop
...
@section('content')
<table id="block-category-list" class="table table-striped table-bordered data-table">
