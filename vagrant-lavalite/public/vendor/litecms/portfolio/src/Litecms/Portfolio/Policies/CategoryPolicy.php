...
class CategoryPolicy
{
    ...
    {
        if ($user->canDo('portfolio.category.view') && $user->is('admin')) {
            return true;
        }
    ...
    {
        return  $user->canDo('portfolio.category.create');
    }
    ...
    {
        if ($user->canDo('portfolio.category.update') && $user->is('admin')) {
            return true;
        }
    ...
    {
        if ($user->canDo('portfolio.category.delete') && $user->is('admin')) {
            return true;
        }
